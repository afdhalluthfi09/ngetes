...
/**
 * Table class for umkm_aspekdigimark_lm
 */
class UmkmAspekdigimarkLm extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'umkm_aspekdigimark_lm';
        $this->TableName = 'umkm_aspekdigimark_lm';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`umkm_aspekdigimark_lm`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // NIK
        $this->NIK = new DbField('umkm_aspekdigimark_lm', 'umkm_aspekdigimark_lm', 'x_NIK', 'NIK', '`NIK`', '`NIK`', 200, 16, -1, false, '`NIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DM_CHATTING
        $this->DM_CHATTING = new DbField('umkm_aspekdigimark_lm', 'umkm_aspekdigimark_lm', 'x_DM_CHATTING', 'DM_CHATTING', '`DM_CHATTING`', '`DM_CHATTING`', 200, 50, -1, false, '`DM_CHATTING`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DM_MEDSOS
        $this->DM_MEDSOS = new DbField('umkm_aspekdigimark_lm', 'umkm_aspekdigimark_lm', 'x_DM_MEDSOS', 'DM_MEDSOS', '`DM_MEDSOS`', '`DM_MEDSOS`', 200, 50, -1, false, '`DM_MEDSOS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DM_MP
        $this->DM_MP = new DbField('umkm_aspekdigimark_lm', 'umkm_aspekdigimark_lm', 'x_DM_MP', 'DM_MP', '`DM_MP`', '`DM_MP`', 200, 50, -1, false, '`DM_MP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DM_GMB
        $this->DM_GMB = new DbField('umkm_aspekdigimark_lm', 'umkm_aspekdigimark_lm', 'x_DM_GMB', 'DM_GMB', '`DM_GMB`', '`DM_GMB`', 200, 50, -1, false, '`DM_GMB`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DM_WEB
        $this->DM_WEB = new DbField('umkm_aspekdigimark_lm', 'umkm_aspekdigimark_lm', 'x_DM_WEB', 'DM_WEB', '`DM_WEB`', '`DM_WEB`', 200, 50, -1, false, '`DM_WEB`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DM_UPDATEMEDSOS
        $this->DM_UPDATEMEDSOS = new DbField('umkm_aspekdigimark_lm', 'umkm_aspekdigimark_lm', 'x_DM_UPDATEMEDSOS', 'DM_UPDATEMEDSOS', '`DM_UPDATEMEDSOS`', '`DM_UPDATEMEDSOS`', 200, 50, -1, false, '`DM_UPDATEMEDSOS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DM_UPDATEWEBSITE
        $this->DM_UPDATEWEBSITE = new DbField('umkm_aspekdigimark_lm', 'umkm_aspekdigimark_lm', 'x_DM_UPDATEWEBSITE', 'DM_UPDATEWEBSITE', '`DM_UPDATEWEBSITE`', '`DM_UPDATEWEBSITE`', 200, 50, -1, false, '`DM_UPDATEWEBSITE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DM_GOOGLEINDEX
        $this->DM_GOOGLEINDEX = new DbField('umkm_aspekdigimark_lm', 'umkm_aspekdigimark_lm', 'x_DM_GOOGLEINDEX', 'DM_GOOGLEINDEX', '`DM_GOOGLEINDEX`', '`DM_GOOGLEINDEX`', 200, 50, -1, false, '`DM_GOOGLEINDEX`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DM_IKLANBERBAYAR
        $this->DM_IKLANBERBAYAR = new DbField('umkm_aspekdigimark_lm', 'umkm_aspekdigimark_lm', 'x_DM_IKLANBERBAYAR', 'DM_IKLANBERBAYAR', '`DM_IKLANBERBAYAR`', '`DM_IKLANBERBAYAR`', 200, 50, -1, false, '`DM_IKLANBERBAYAR`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`umkm_aspekdigimark_lm`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("umkmaspekdigimarklmlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "umkmaspekdigimarklmview") {
            return $Language->phrase("View");
        } elseif ($pageName == "umkmaspekdigimarklmedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "umkmaspekdigimarklmadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "UmkmAspekdigimarkLmView";
            case Config("API_ADD_ACTION"):
                return "UmkmAspekdigimarkLmAdd";
            case Config("API_EDIT_ACTION"):
                return "UmkmAspekdigimarkLmEdit";
            case Config("API_DELETE_ACTION"):
                return "UmkmAspekdigimarkLmDelete";
            case Config("API_LIST_ACTION"):
                return "UmkmAspekdigimarkLmList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("umkmaspekdigimarklmview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("umkmaspekdigimarklmview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "umkmaspekdigimarklmadd?" . $this->getUrlParm($parm);
        } else {
            $url = "umkmaspekdigimarklmadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmaspekdigimarklmedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmaspekdigimarklmadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("umkmaspekdigimarklmdelete", $this->getUrlParm());
    }
