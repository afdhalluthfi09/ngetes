 ...
 * Page class
 */
class TempSkorKelasEdit extends TempSkorKelas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TempSkorKelasEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // skor_kelas
            $this->skor_kelas->setDbValueDef($rsnew, $this->skor_kelas->CurrentValue, null, $this->skor_kelas->ReadOnly);

            // maxskor_kelas
            $this->maxskor_kelas->setDbValueDef($rsnew, $this->maxskor_kelas->CurrentValue, null, $this->maxskor_kelas->ReadOnly);

            // kelas_umkm
            $this->kelas_umkm->setDbValueDef($rsnew, $this->kelas_umkm->CurrentValue, "", $this->kelas_umkm->ReadOnly);
