...
/**
 * Table class for php_kurasi_lolos
 */
class PhpKurasiLolos extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'php_kurasi_lolos';
        $this->TableName = 'php_kurasi_lolos';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`php_kurasi_lolos`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // nik_ukm
        $this->nik_ukm = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_nik_ukm', 'nik_ukm', '`nik_ukm`', '`nik_ukm`', 200, 16, -1, false, '`nik_ukm`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_nama
        $this->produk_nama = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_produk_nama', 'produk_nama', '`produk_nama`', '`produk_nama`', 200, 50, -1, false, '`produk_nama`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_jenis
        $this->produk_jenis = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_produk_jenis', 'produk_jenis', '`produk_jenis`', '`produk_jenis`', 200, 50, -1, false, '`produk_jenis`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_desc
        $this->produk_desc = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_produk_desc', 'produk_desc', '`produk_desc`', '`produk_desc`', 201, 65535, -1, false, '`produk_desc`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // produk_harga
        $this->produk_harga = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_produk_harga', 'produk_harga', '`produk_harga`', '`produk_harga`', 5, 22, -1, false, '`produk_harga`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_foto
        $this->produk_foto = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_produk_foto', 'produk_foto', '`produk_foto`', '`produk_foto`', 200, 50, -1, true, '`produk_foto`', false, false, false, 'IMAGE', 'FILE');
        ...
        // produk_berat
        $this->produk_berat = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_produk_berat', 'produk_berat', '`produk_berat`', '`produk_berat`', 4, 12, -1, false, '`produk_berat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_legal
        $this->produk_legal = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_produk_legal', 'produk_legal', '`produk_legal`', '`produk_legal`', 2, 1, -1, false, '`produk_legal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // judul_sesuai
        $this->judul_sesuai = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_judul_sesuai', 'judul_sesuai', '`judul_sesuai`', '`judul_sesuai`', 2, 1, -1, false, '`judul_sesuai`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // foto_bagus
        $this->foto_bagus = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_foto_bagus', 'foto_bagus', '`foto_bagus`', '`foto_bagus`', 2, 1, -1, false, '`foto_bagus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // deskripsi_jelas
        $this->deskripsi_jelas = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_deskripsi_jelas', 'deskripsi_jelas', '`deskripsi_jelas`', '`deskripsi_jelas`', 2, 1, -1, false, '`deskripsi_jelas`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // harga_tidak_kosong
        $this->harga_tidak_kosong = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_harga_tidak_kosong', 'harga_tidak_kosong', '`harga_tidak_kosong`', '`harga_tidak_kosong`', 2, 1, -1, false, '`harga_tidak_kosong`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // berat_tidak_kosong
        $this->berat_tidak_kosong = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_berat_tidak_kosong', 'berat_tidak_kosong', '`berat_tidak_kosong`', '`berat_tidak_kosong`', 2, 1, -1, false, '`berat_tidak_kosong`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kurasi
        $this->kurasi = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_kurasi', 'kurasi', '`kurasi`', '`kurasi`', 200, 50, -1, false, '`kurasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // waktu_entry
        $this->waktu_entry = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_waktu_entry', 'waktu_entry', '`waktu_entry`', CastDateFieldForLike("`waktu_entry`", 0, "DB"), 135, 19, 0, false, '`waktu_entry`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // waktu_kurasi
        $this->waktu_kurasi = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_waktu_kurasi', 'waktu_kurasi', '`waktu_kurasi`', CastDateFieldForLike("`waktu_kurasi`", 0, "DB"), 135, 19, 0, false, '`waktu_kurasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // waktu_update
        $this->waktu_update = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_waktu_update', 'waktu_update', '`waktu_update`', CastDateFieldForLike("`waktu_update`", 0, "DB"), 135, 19, 0, false, '`waktu_update`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // editor
        $this->editor = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_editor', 'editor', '`editor`', '`editor`', 200, 20, -1, false, '`editor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kurator
        $this->kurator = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_kurator', 'kurator', '`kurator`', '`kurator`', 200, 50, -1, false, '`kurator`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_panjang
        $this->produk_panjang = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_produk_panjang', 'produk_panjang', '`produk_panjang`', '`produk_panjang`', 4, 12, -1, false, '`produk_panjang`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_lebar
        $this->produk_lebar = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_produk_lebar', 'produk_lebar', '`produk_lebar`', '`produk_lebar`', 4, 12, -1, false, '`produk_lebar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_tinggi
        $this->produk_tinggi = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_produk_tinggi', 'produk_tinggi', '`produk_tinggi`', '`produk_tinggi`', 4, 12, -1, false, '`produk_tinggi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_foto_1
        $this->produk_foto_1 = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_produk_foto_1', 'produk_foto_1', '`produk_foto_1`', '`produk_foto_1`', 200, 50, -1, true, '`produk_foto_1`', false, false, false, 'IMAGE', 'FILE');
        ...
        // produk_foto_2
        $this->produk_foto_2 = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_produk_foto_2', 'produk_foto_2', '`produk_foto_2`', '`produk_foto_2`', 200, 50, -1, true, '`produk_foto_2`', false, false, false, 'IMAGE', 'FILE');
        ...
        // produk_foto_3
        $this->produk_foto_3 = new DbField('php_kurasi_lolos', 'php_kurasi_lolos', 'x_produk_foto_3', 'produk_foto_3', '`produk_foto_3`', '`produk_foto_3`', 200, 50, -1, true, '`produk_foto_3`', false, false, false, 'IMAGE', 'FILE');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`php_kurasi_lolos`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("phpkurasiloloslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "phpkurasilolosview") {
            return $Language->phrase("View");
        } elseif ($pageName == "phpkurasilolosedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "phpkurasilolosadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PhpKurasiLolosView";
            case Config("API_ADD_ACTION"):
                return "PhpKurasiLolosAdd";
            case Config("API_EDIT_ACTION"):
                return "PhpKurasiLolosEdit";
            case Config("API_DELETE_ACTION"):
                return "PhpKurasiLolosDelete";
            case Config("API_LIST_ACTION"):
                return "PhpKurasiLolosList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("phpkurasilolosview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("phpkurasilolosview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "phpkurasilolosadd?" . $this->getUrlParm($parm);
        } else {
            $url = "phpkurasilolosadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("phpkurasilolosedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("phpkurasilolosadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("phpkurasilolosdelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        if ($this->produk_foto->UseColorbox) {
            ...
            $this->produk_foto->LinkAttrs["data-rel"] = "php_kurasi_lolos_x_produk_foto";
        ...
        if ($this->produk_foto_1->UseColorbox) {
            ...
            $this->produk_foto_1->LinkAttrs["data-rel"] = "php_kurasi_lolos_x_produk_foto_1";
        ...
        if ($this->produk_foto_2->UseColorbox) {
            ...
            $this->produk_foto_2->LinkAttrs["data-rel"] = "php_kurasi_lolos_x_produk_foto_2";
        ...
        if ($this->produk_foto_3->UseColorbox) {
            ...
            $this->produk_foto_3->LinkAttrs["data-rel"] = "php_kurasi_lolos_x_produk_foto_3";
