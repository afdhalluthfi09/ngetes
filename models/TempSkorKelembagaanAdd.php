 ...
 * Page class
 */
class TempSkorKelembagaanAdd extends TempSkorKelembagaan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TempSkorKelembagaanAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "tempskorkelembagaanview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->skor_badanhukum->CurrentValue = null;
        $this->skor_badanhukum->OldValue = $this->skor_badanhukum->CurrentValue;
        $this->max_badanhukum->CurrentValue = null;
        $this->max_badanhukum->OldValue = $this->max_badanhukum->CurrentValue;
        $this->skor_izin->CurrentValue = null;
        $this->skor_izin->OldValue = $this->skor_izin->CurrentValue;
        $this->max_izin->CurrentValue = null;
        $this->max_izin->OldValue = $this->max_izin->CurrentValue;
        $this->skor_npwp->CurrentValue = null;
        $this->skor_npwp->OldValue = $this->skor_npwp->CurrentValue;
        $this->max_npwp->CurrentValue = null;
        $this->max_npwp->OldValue = $this->max_npwp->CurrentValue;
        $this->skor_struktur->CurrentValue = null;
        $this->skor_struktur->OldValue = $this->skor_struktur->CurrentValue;
        $this->max_struktur->CurrentValue = null;
        $this->max_struktur->OldValue = $this->max_struktur->CurrentValue;
        $this->skor_jobdesk->CurrentValue = null;
        $this->skor_jobdesk->OldValue = $this->skor_jobdesk->CurrentValue;
        $this->max_jobdesk->CurrentValue = null;
        $this->max_jobdesk->OldValue = $this->max_jobdesk->CurrentValue;
        $this->skor_iso->CurrentValue = null;
        $this->skor_iso->OldValue = $this->skor_iso->CurrentValue;
        $this->max_iso->CurrentValue = null;
        $this->max_iso->OldValue = $this->max_iso->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['skor_badanhukum'] = $this->skor_badanhukum->CurrentValue;
        $row['max_badanhukum'] = $this->max_badanhukum->CurrentValue;
        $row['skor_izin'] = $this->skor_izin->CurrentValue;
        $row['max_izin'] = $this->max_izin->CurrentValue;
        $row['skor_npwp'] = $this->skor_npwp->CurrentValue;
        $row['max_npwp'] = $this->max_npwp->CurrentValue;
        $row['skor_struktur'] = $this->skor_struktur->CurrentValue;
        $row['max_struktur'] = $this->max_struktur->CurrentValue;
        $row['skor_jobdesk'] = $this->skor_jobdesk->CurrentValue;
        $row['max_jobdesk'] = $this->max_jobdesk->CurrentValue;
        $row['skor_iso'] = $this->skor_iso->CurrentValue;
        $row['max_iso'] = $this->max_iso->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // skor_badanhukum
        $this->skor_badanhukum->setDbValueDef($rsnew, $this->skor_badanhukum->CurrentValue, null, false);

        // max_badanhukum
        $this->max_badanhukum->setDbValueDef($rsnew, $this->max_badanhukum->CurrentValue, null, false);

        // skor_izin
        $this->skor_izin->setDbValueDef($rsnew, $this->skor_izin->CurrentValue, null, false);

        // max_izin
        $this->max_izin->setDbValueDef($rsnew, $this->max_izin->CurrentValue, null, false);

        // skor_npwp
        $this->skor_npwp->setDbValueDef($rsnew, $this->skor_npwp->CurrentValue, null, false);

        // max_npwp
        $this->max_npwp->setDbValueDef($rsnew, $this->max_npwp->CurrentValue, null, false);

        // skor_struktur
        $this->skor_struktur->setDbValueDef($rsnew, $this->skor_struktur->CurrentValue, null, false);

        // max_struktur
        $this->max_struktur->setDbValueDef($rsnew, $this->max_struktur->CurrentValue, null, false);

        // skor_jobdesk
        $this->skor_jobdesk->setDbValueDef($rsnew, $this->skor_jobdesk->CurrentValue, null, false);

        // max_jobdesk
        $this->max_jobdesk->setDbValueDef($rsnew, $this->max_jobdesk->CurrentValue, null, false);

        // skor_iso
        $this->skor_iso->setDbValueDef($rsnew, $this->skor_iso->CurrentValue, null, false);

        // max_iso
        $this->max_iso->setDbValueDef($rsnew, $this->max_iso->CurrentValue, null, false);
