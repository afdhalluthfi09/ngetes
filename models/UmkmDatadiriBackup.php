...
/**
 * Table class for umkm_datadiri_backup
 */
class UmkmDatadiriBackup extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'umkm_datadiri_backup';
        $this->TableName = 'umkm_datadiri_backup';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`umkm_datadiri_backup`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // NIK
        $this->NIK = new DbField('umkm_datadiri_backup', 'umkm_datadiri_backup', 'x_NIK', 'NIK', '`NIK`', '`NIK`', 200, 16, -1, false, '`NIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA_PEMILIK
        $this->NAMA_PEMILIK = new DbField('umkm_datadiri_backup', 'umkm_datadiri_backup', 'x_NAMA_PEMILIK', 'NAMA_PEMILIK', '`NAMA_PEMILIK`', '`NAMA_PEMILIK`', 200, 100, -1, false, '`NAMA_PEMILIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // JENIS_KELAMIN
        $this->JENIS_KELAMIN = new DbField('umkm_datadiri_backup', 'umkm_datadiri_backup', 'x_JENIS_KELAMIN', 'JENIS_KELAMIN', '`JENIS_KELAMIN`', '`JENIS_KELAMIN`', 200, 10, -1, false, '`JENIS_KELAMIN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ALAMAT
        $this->ALAMAT = new DbField('umkm_datadiri_backup', 'umkm_datadiri_backup', 'x_ALAMAT', 'ALAMAT', '`ALAMAT`', '`ALAMAT`', 200, 100, -1, false, '`ALAMAT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ALAMAT->Sortable = true; // Allow sort
        $this->ALAMAT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ALAMAT->Param, "CustomMsg");
        $this->Fields['ALAMAT'] = &$this->ALAMAT;

        // DUSUN
        $this->DUSUN = new DbField('umkm_datadiri_backup', 'umkm_datadiri_backup', 'x_DUSUN', 'DUSUN', '`DUSUN`', '`DUSUN`', 200, 50, -1, false, '`DUSUN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KALURAHAN
        $this->KALURAHAN = new DbField('umkm_datadiri_backup', 'umkm_datadiri_backup', 'x_KALURAHAN', 'KALURAHAN', '`KALURAHAN`', '`KALURAHAN`', 200, 50, -1, false, '`KALURAHAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KAPANEWON
        $this->KAPANEWON = new DbField('umkm_datadiri_backup', 'umkm_datadiri_backup', 'x_KAPANEWON', 'KAPANEWON', '`KAPANEWON`', '`KAPANEWON`', 200, 50, -1, false, '`KAPANEWON`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_HP
        $this->NO_HP = new DbField('umkm_datadiri_backup', 'umkm_datadiri_backup', 'x_NO_HP', 'NO_HP', '`NO_HP`', '`NO_HP`', 200, 20, -1, false, '`NO_HP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`umkm_datadiri_backup`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("umkmdatadiribackuplist");
    }
    ...
    {
        global $Language;
        if ($pageName == "umkmdatadiribackupview") {
            return $Language->phrase("View");
        } elseif ($pageName == "umkmdatadiribackupedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "umkmdatadiribackupadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "UmkmDatadiriBackupView";
            case Config("API_ADD_ACTION"):
                return "UmkmDatadiriBackupAdd";
            case Config("API_EDIT_ACTION"):
                return "UmkmDatadiriBackupEdit";
            case Config("API_DELETE_ACTION"):
                return "UmkmDatadiriBackupDelete";
            case Config("API_LIST_ACTION"):
                return "UmkmDatadiriBackupList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("umkmdatadiribackupview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("umkmdatadiribackupview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "umkmdatadiribackupadd?" . $this->getUrlParm($parm);
        } else {
            $url = "umkmdatadiribackupadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmdatadiribackupedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmdatadiribackupadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("umkmdatadiribackupdelete", $this->getUrlParm());
    }
