 ...
 * Page class
 */
class ProdukLolosKurasiList extends ProdukLolosKurasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProdukLolosKurasiList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fProduk_Lolos_Kurasilist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "produkloloskurasiadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "produkloloskurasidelete";
        $this->MultiUpdateUrl = "produkloloskurasiupdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fProduk_Lolos_Kurasilistsrch";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fProduk_Lolos_Kurasilistsrch");
        }
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fProduk_Lolos_Kurasilistsrch", $filters);
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fProduk_Lolos_Kurasilistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fProduk_Lolos_Kurasilistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fProduk_Lolos_Kurasilist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->produk_foto_1->UseColorbox) {
                ...
                $this->produk_foto_1->LinkAttrs["data-rel"] = "Produk_Lolos_Kurasi_x" . $this->RowCount . "_produk_foto_1";
            ...
            if ($this->produk_foto_2->UseColorbox) {
                ...
                $this->produk_foto_2->LinkAttrs["data-rel"] = "Produk_Lolos_Kurasi_x" . $this->RowCount . "_produk_foto_2";
            ...
            if ($this->produk_foto_3->UseColorbox) {
                ...
                $this->produk_foto_3->LinkAttrs["data-rel"] = "Produk_Lolos_Kurasi_x" . $this->RowCount . "_produk_foto_3";
    ...
    protected function setupSearchSortOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fProduk_Lolos_Kurasilistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
