 ...
 * Page class
 */
class TempSkorSdmAdd extends TempSkorSdm
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TempSkorSdmAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "tempskorsdmview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->skor_oms->CurrentValue = null;
        $this->skor_oms->OldValue = $this->skor_oms->CurrentValue;
        $this->max_oms->CurrentValue = null;
        $this->max_oms->OldValue = $this->max_oms->CurrentValue;
        $this->skor_fokus->CurrentValue = null;
        $this->skor_fokus->OldValue = $this->skor_fokus->CurrentValue;
        $this->max_fokus->CurrentValue = null;
        $this->max_fokus->OldValue = $this->max_fokus->CurrentValue;
        ...
        $this->skor_karyawan->CurrentValue = null;
        $this->skor_karyawan->OldValue = $this->skor_karyawan->CurrentValue;
        $this->max_karyawan->CurrentValue = null;
        $this->max_karyawan->OldValue = $this->max_karyawan->CurrentValue;
        $this->skor_outsource->CurrentValue = null;
        $this->skor_outsource->OldValue = $this->skor_outsource->CurrentValue;
        $this->max_outsource->CurrentValue = null;
        $this->max_outsource->OldValue = $this->max_outsource->CurrentValue;
        $this->skor_besarangaji->CurrentValue = null;
        $this->skor_besarangaji->OldValue = $this->skor_besarangaji->CurrentValue;
        $this->max_besarangaji->CurrentValue = null;
        $this->max_besarangaji->OldValue = $this->max_besarangaji->CurrentValue;
        $this->skor_asuransi->CurrentValue = null;
        $this->skor_asuransi->OldValue = $this->skor_asuransi->CurrentValue;
        $this->max_asuransi->CurrentValue = null;
        $this->max_asuransi->OldValue = $this->max_asuransi->CurrentValue;
        $this->skor_bonus->CurrentValue = null;
        $this->skor_bonus->OldValue = $this->skor_bonus->CurrentValue;
        $this->max_bonus->CurrentValue = null;
        $this->max_bonus->OldValue = $this->max_bonus->CurrentValue;
        $this->skor_training->CurrentValue = null;
        $this->skor_training->OldValue = $this->skor_training->CurrentValue;
        $this->max_training->CurrentValue = null;
        $this->max_training->OldValue = $this->max_training->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['skor_oms'] = $this->skor_oms->CurrentValue;
        $row['max_oms'] = $this->max_oms->CurrentValue;
        $row['skor_fokus'] = $this->skor_fokus->CurrentValue;
        $row['max_fokus'] = $this->max_fokus->CurrentValue;
        $row['skor_target'] = $this->skor_target->CurrentValue;
        $row['max_target'] = $this->max_target->CurrentValue;
        $row['skor_karyawan'] = $this->skor_karyawan->CurrentValue;
        $row['max_karyawan'] = $this->max_karyawan->CurrentValue;
        $row['skor_outsource'] = $this->skor_outsource->CurrentValue;
        $row['max_outsource'] = $this->max_outsource->CurrentValue;
        $row['skor_besarangaji'] = $this->skor_besarangaji->CurrentValue;
        $row['max_besarangaji'] = $this->max_besarangaji->CurrentValue;
        $row['skor_asuransi'] = $this->skor_asuransi->CurrentValue;
        $row['max_asuransi'] = $this->max_asuransi->CurrentValue;
        $row['skor_bonus'] = $this->skor_bonus->CurrentValue;
        $row['max_bonus'] = $this->max_bonus->CurrentValue;
        $row['skor_training'] = $this->skor_training->CurrentValue;
        $row['max_training'] = $this->max_training->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // skor_oms
        $this->skor_oms->setDbValueDef($rsnew, $this->skor_oms->CurrentValue, null, false);

        // max_oms
        $this->max_oms->setDbValueDef($rsnew, $this->max_oms->CurrentValue, null, false);

        // skor_fokus
        $this->skor_fokus->setDbValueDef($rsnew, $this->skor_fokus->CurrentValue, null, false);

        // max_fokus
        $this->max_fokus->setDbValueDef($rsnew, $this->max_fokus->CurrentValue, null, false);
        ...
        // skor_karyawan
        $this->skor_karyawan->setDbValueDef($rsnew, $this->skor_karyawan->CurrentValue, null, false);

        // max_karyawan
        $this->max_karyawan->setDbValueDef($rsnew, $this->max_karyawan->CurrentValue, null, false);

        // skor_outsource
        $this->skor_outsource->setDbValueDef($rsnew, $this->skor_outsource->CurrentValue, null, false);

        // max_outsource
        $this->max_outsource->setDbValueDef($rsnew, $this->max_outsource->CurrentValue, null, false);

        // skor_besarangaji
        $this->skor_besarangaji->setDbValueDef($rsnew, $this->skor_besarangaji->CurrentValue, null, false);

        // max_besarangaji
        $this->max_besarangaji->setDbValueDef($rsnew, $this->max_besarangaji->CurrentValue, null, false);

        // skor_asuransi
        $this->skor_asuransi->setDbValueDef($rsnew, $this->skor_asuransi->CurrentValue, null, false);

        // max_asuransi
        $this->max_asuransi->setDbValueDef($rsnew, $this->max_asuransi->CurrentValue, null, false);

        // skor_bonus
        $this->skor_bonus->setDbValueDef($rsnew, $this->skor_bonus->CurrentValue, null, false);

        // max_bonus
        $this->max_bonus->setDbValueDef($rsnew, $this->max_bonus->CurrentValue, null, false);

        // skor_training
        $this->skor_training->setDbValueDef($rsnew, $this->skor_training->CurrentValue, null, false);

        // max_training
        $this->max_training->setDbValueDef($rsnew, $this->max_training->CurrentValue, null, false);
