 ...
 * Page class
 */
class IndonesiaCitiesAdd extends IndonesiaCities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IndonesiaCitiesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("indonesiacitieslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "indonesiacitieslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "indonesiacitiesview") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->province_id->EditValue = HtmlEncode($this->province_id->CurrentValue);
