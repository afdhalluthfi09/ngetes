...
/**
 * Table class for temp_skor_sdm
 */
class TempSkorSdm extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'temp_skor_sdm';
        $this->TableName = 'temp_skor_sdm';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`temp_skor_sdm`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // nik
        $this->nik = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_nik', 'nik', '`nik`', '`nik`', 200, 16, -1, false, '`nik`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_oms
        $this->skor_oms = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_skor_oms', 'skor_oms', '`skor_oms`', '`skor_oms`', 5, 23, -1, false, '`skor_oms`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_oms
        $this->max_oms = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_max_oms', 'max_oms', '`max_oms`', '`max_oms`', 5, 23, -1, false, '`max_oms`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_fokus
        $this->skor_fokus = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_skor_fokus', 'skor_fokus', '`skor_fokus`', '`skor_fokus`', 5, 23, -1, false, '`skor_fokus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_fokus
        $this->max_fokus = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_max_fokus', 'max_fokus', '`max_fokus`', '`max_fokus`', 5, 23, -1, false, '`max_fokus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_target
        $this->skor_target = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_skor_target', 'skor_target', '`skor_target`', '`skor_target`', 5, 23, -1, false, '`skor_target`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_target
        $this->max_target = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_max_target', 'max_target', '`max_target`', '`max_target`', 5, 23, -1, false, '`max_target`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_karyawan
        $this->skor_karyawan = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_skor_karyawan', 'skor_karyawan', '`skor_karyawan`', '`skor_karyawan`', 5, 23, -1, false, '`skor_karyawan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_karyawan
        $this->max_karyawan = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_max_karyawan', 'max_karyawan', '`max_karyawan`', '`max_karyawan`', 5, 23, -1, false, '`max_karyawan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_outsource
        $this->skor_outsource = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_skor_outsource', 'skor_outsource', '`skor_outsource`', '`skor_outsource`', 5, 23, -1, false, '`skor_outsource`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_outsource
        $this->max_outsource = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_max_outsource', 'max_outsource', '`max_outsource`', '`max_outsource`', 5, 23, -1, false, '`max_outsource`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_besarangaji
        $this->skor_besarangaji = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_skor_besarangaji', 'skor_besarangaji', '`skor_besarangaji`', '`skor_besarangaji`', 5, 23, -1, false, '`skor_besarangaji`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_besarangaji
        $this->max_besarangaji = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_max_besarangaji', 'max_besarangaji', '`max_besarangaji`', '`max_besarangaji`', 5, 23, -1, false, '`max_besarangaji`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_asuransi
        $this->skor_asuransi = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_skor_asuransi', 'skor_asuransi', '`skor_asuransi`', '`skor_asuransi`', 5, 23, -1, false, '`skor_asuransi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_asuransi
        $this->max_asuransi = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_max_asuransi', 'max_asuransi', '`max_asuransi`', '`max_asuransi`', 5, 23, -1, false, '`max_asuransi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_bonus
        $this->skor_bonus = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_skor_bonus', 'skor_bonus', '`skor_bonus`', '`skor_bonus`', 5, 23, -1, false, '`skor_bonus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_bonus
        $this->max_bonus = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_max_bonus', 'max_bonus', '`max_bonus`', '`max_bonus`', 5, 23, -1, false, '`max_bonus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_training
        $this->skor_training = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_skor_training', 'skor_training', '`skor_training`', '`skor_training`', 5, 23, -1, false, '`skor_training`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_training
        $this->max_training = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_max_training', 'max_training', '`max_training`', '`max_training`', 5, 23, -1, false, '`max_training`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_sdm
        $this->skor_sdm = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_skor_sdm', 'skor_sdm', '`skor_sdm`', '`skor_sdm`', 5, 23, -1, false, '`skor_sdm`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // maxskor_sdm
        $this->maxskor_sdm = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_maxskor_sdm', 'maxskor_sdm', '`maxskor_sdm`', '`maxskor_sdm`', 5, 23, -1, false, '`maxskor_sdm`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // bobot_sdm
        $this->bobot_sdm = new DbField('temp_skor_sdm', 'temp_skor_sdm', 'x_bobot_sdm', 'bobot_sdm', '`bobot_sdm`', '`bobot_sdm`', 3, 2, -1, false, '`bobot_sdm`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`temp_skor_sdm`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("tempskorsdmlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "tempskorsdmedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "tempskorsdmadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TempSkorSdmView";
            case Config("API_ADD_ACTION"):
                return "TempSkorSdmAdd";
            case Config("API_EDIT_ACTION"):
                return "TempSkorSdmEdit";
            case Config("API_DELETE_ACTION"):
                return "TempSkorSdmDelete";
            case Config("API_LIST_ACTION"):
                return "TempSkorSdmList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("tempskorsdmview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("tempskorsdmview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "tempskorsdmadd?" . $this->getUrlParm($parm);
        } else {
            $url = "tempskorsdmadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("tempskorsdmedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("tempskorsdmadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("tempskorsdmdelete", $this->getUrlParm());
    }
