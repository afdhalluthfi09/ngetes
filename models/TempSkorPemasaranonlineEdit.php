 ...
 * Page class
 */
class TempSkorPemasaranonlineEdit extends TempSkorPemasaranonline
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TempSkorPemasaranonlineEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // chatting
            $this->chatting->setDbValueDef($rsnew, $this->chatting->CurrentValue, null, $this->chatting->ReadOnly);

            // skor_chatting
            $this->skor_chatting->setDbValueDef($rsnew, $this->skor_chatting->CurrentValue, null, $this->skor_chatting->ReadOnly);

            // max_chatting
            $this->max_chatting->setDbValueDef($rsnew, $this->max_chatting->CurrentValue, null, $this->max_chatting->ReadOnly);

            // medsos
            $this->medsos->setDbValueDef($rsnew, $this->medsos->CurrentValue, null, $this->medsos->ReadOnly);

            // skor_medsos
            $this->skor_medsos->setDbValueDef($rsnew, $this->skor_medsos->CurrentValue, null, $this->skor_medsos->ReadOnly);

            // max_medsos
            $this->max_medsos->setDbValueDef($rsnew, $this->max_medsos->CurrentValue, null, $this->max_medsos->ReadOnly);

            // marketplace
            $this->marketplace->setDbValueDef($rsnew, $this->marketplace->CurrentValue, null, $this->marketplace->ReadOnly);

            // skor_mp
            $this->skor_mp->setDbValueDef($rsnew, $this->skor_mp->CurrentValue, null, $this->skor_mp->ReadOnly);

            // max_mp
            $this->max_mp->setDbValueDef($rsnew, $this->max_mp->CurrentValue, null, $this->max_mp->ReadOnly);

            // gmb
            $this->gmb->setDbValueDef($rsnew, $this->gmb->CurrentValue, null, $this->gmb->ReadOnly);

            // skor_gmb
            $this->skor_gmb->setDbValueDef($rsnew, $this->skor_gmb->CurrentValue, null, $this->skor_gmb->ReadOnly);

            // max_gmb
            $this->max_gmb->setDbValueDef($rsnew, $this->max_gmb->CurrentValue, null, $this->max_gmb->ReadOnly);

            // web
            $this->web->setDbValueDef($rsnew, $this->web->CurrentValue, null, $this->web->ReadOnly);

            // skor_web
            $this->skor_web->setDbValueDef($rsnew, $this->skor_web->CurrentValue, null, $this->skor_web->ReadOnly);

            // max_web
            $this->max_web->setDbValueDef($rsnew, $this->max_web->CurrentValue, null, $this->max_web->ReadOnly);

            // updatemedsos
            $this->updatemedsos->setDbValueDef($rsnew, $this->updatemedsos->CurrentValue, null, $this->updatemedsos->ReadOnly);

            // skor_updatemedsos
            $this->skor_updatemedsos->setDbValueDef($rsnew, $this->skor_updatemedsos->CurrentValue, null, $this->skor_updatemedsos->ReadOnly);

            // max_updatemedsos
            $this->max_updatemedsos->setDbValueDef($rsnew, $this->max_updatemedsos->CurrentValue, null, $this->max_updatemedsos->ReadOnly);

            // updateweb
            $this->updateweb->setDbValueDef($rsnew, $this->updateweb->CurrentValue, null, $this->updateweb->ReadOnly);

            // skor_updateweb
            $this->skor_updateweb->setDbValueDef($rsnew, $this->skor_updateweb->CurrentValue, null, $this->skor_updateweb->ReadOnly);

            // max_updateweb
            $this->max_updateweb->setDbValueDef($rsnew, $this->max_updateweb->CurrentValue, null, $this->max_updateweb->ReadOnly);

            // seo
            $this->seo->setDbValueDef($rsnew, $this->seo->CurrentValue, null, $this->seo->ReadOnly);

            // skor_seo
            $this->skor_seo->setDbValueDef($rsnew, $this->skor_seo->CurrentValue, null, $this->skor_seo->ReadOnly);

            // max_seo
            $this->max_seo->setDbValueDef($rsnew, $this->max_seo->CurrentValue, null, $this->max_seo->ReadOnly);

            // iklan
            $this->iklan->setDbValueDef($rsnew, $this->iklan->CurrentValue, null, $this->iklan->ReadOnly);

            // skor_iklan
            $this->skor_iklan->setDbValueDef($rsnew, $this->skor_iklan->CurrentValue, null, $this->skor_iklan->ReadOnly);

            // max_iklan
            $this->max_iklan->setDbValueDef($rsnew, $this->max_iklan->CurrentValue, null, $this->max_iklan->ReadOnly);

            // skor_pemasaranonline
            $this->skor_pemasaranonline->setDbValueDef($rsnew, $this->skor_pemasaranonline->CurrentValue, null, $this->skor_pemasaranonline->ReadOnly);

            // maxskor_pemasaranonline
            $this->maxskor_pemasaranonline->setDbValueDef($rsnew, $this->maxskor_pemasaranonline->CurrentValue, null, $this->maxskor_pemasaranonline->ReadOnly);

            // bobot_pemasaranonline
            $this->bobot_pemasaranonline->setDbValueDef($rsnew, $this->bobot_pemasaranonline->CurrentValue, 0, $this->bobot_pemasaranonline->ReadOnly);
