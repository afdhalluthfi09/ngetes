...
/**
 * Table class for koperasi_profil
 */
class KoperasiProfil extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'koperasi_profil';
        $this->TableName = 'koperasi_profil';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`koperasi_profil`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('koperasi_profil', 'koperasi_profil', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // binaan
        $this->binaan = new DbField('koperasi_profil', 'koperasi_profil', 'x_binaan', 'binaan', '`binaan`', '`binaan`', 200, 30, -1, false, '`binaan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nama_koperasi
        $this->nama_koperasi = new DbField('koperasi_profil', 'koperasi_profil', 'x_nama_koperasi', 'nama_koperasi', '`nama_koperasi`', '`nama_koperasi`', 200, 100, -1, false, '`nama_koperasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // akte
        $this->akte = new DbField('koperasi_profil', 'koperasi_profil', 'x_akte', 'akte', '`akte`', '`akte`', 200, 50, -1, false, '`akte`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_pendirian
        $this->tanggal_pendirian = new DbField('koperasi_profil', 'koperasi_profil', 'x_tanggal_pendirian', 'tanggal_pendirian', '`tanggal_pendirian`', CastDateFieldForLike("`tanggal_pendirian`", 0, "DB"), 133, 10, 0, false, '`tanggal_pendirian`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('koperasi_profil', 'koperasi_profil', 'x_status', 'status', '`status`', '`status`', 200, 30, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // jns_koperasi
        $this->jns_koperasi = new DbField('koperasi_profil', 'koperasi_profil', 'x_jns_koperasi', 'jns_koperasi', '`jns_koperasi`', '`jns_koperasi`', 200, 50, -1, false, '`jns_koperasi`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // bentuk_koperasi
        $this->bentuk_koperasi = new DbField('koperasi_profil', 'koperasi_profil', 'x_bentuk_koperasi', 'bentuk_koperasi', '`bentuk_koperasi`', '`bentuk_koperasi`', 200, 30, -1, false, '`bentuk_koperasi`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // bentuk_ekonomi
        $this->bentuk_ekonomi = new DbField('koperasi_profil', 'koperasi_profil', 'x_bentuk_ekonomi', 'bentuk_ekonomi', '`bentuk_ekonomi`', '`bentuk_ekonomi`', 200, 30, -1, false, '`bentuk_ekonomi`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // kelompok_koperasi
        $this->kelompok_koperasi = new DbField('koperasi_profil', 'koperasi_profil', 'x_kelompok_koperasi', 'kelompok_koperasi', '`kelompok_koperasi`', '`kelompok_koperasi`', 200, 50, -1, false, '`kelompok_koperasi`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // alamat_jalan
        $this->alamat_jalan = new DbField('koperasi_profil', 'koperasi_profil', 'x_alamat_jalan', 'alamat_jalan', '`alamat_jalan`', '`alamat_jalan`', 200, 100, -1, false, '`alamat_jalan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kapanewon
        $this->kapanewon = new DbField('koperasi_profil', 'koperasi_profil', 'x_kapanewon', 'kapanewon', '`kapanewon`', '`kapanewon`', 200, 30, -1, false, '`kapanewon`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // kalurahan
        $this->kalurahan = new DbField('koperasi_profil', 'koperasi_profil', 'x_kalurahan', 'kalurahan', '`kalurahan`', '`kalurahan`', 200, 30, -1, false, '`kalurahan`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // alamat_kodepos
        $this->alamat_kodepos = new DbField('koperasi_profil', 'koperasi_profil', 'x_alamat_kodepos', 'alamat_kodepos', '`alamat_kodepos`', '`alamat_kodepos`', 200, 10, -1, false, '`alamat_kodepos`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // telp
        $this->telp = new DbField('koperasi_profil', 'koperasi_profil', 'x_telp', 'telp', '`telp`', '`telp`', 200, 20, -1, false, '`telp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fax
        $this->fax = new DbField('koperasi_profil', 'koperasi_profil', 'x_fax', 'fax', '`fax`', '`fax`', 200, 20, -1, false, '`fax`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // email
        $this->_email = new DbField('koperasi_profil', 'koperasi_profil', 'x__email', 'email', '`email`', '`email`', 200, 50, -1, false, '`email`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->_email->Sortable = true; // Allow sort
        $this->_email->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->_email->Param, "CustomMsg");
        $this->Fields['email'] = &$this->_email;

        // website
        $this->website = new DbField('koperasi_profil', 'koperasi_profil', 'x_website', 'website', '`website`', '`website`', 200, 50, -1, false, '`website`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pengurus_ketua
        $this->pengurus_ketua = new DbField('koperasi_profil', 'koperasi_profil', 'x_pengurus_ketua', 'pengurus_ketua', '`pengurus_ketua`', '`pengurus_ketua`', 200, 100, -1, false, '`pengurus_ketua`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->pengurus_sekertartaris = new DbField('koperasi_profil', 'koperasi_profil', 'x_pengurus_sekertartaris', 'pengurus_sekertartaris', '`pengurus_sekertartaris`', '`pengurus_sekertartaris`', 200, 100, -1, false, '`pengurus_sekertartaris`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pengurus_bendahara
        $this->pengurus_bendahara = new DbField('koperasi_profil', 'koperasi_profil', 'x_pengurus_bendahara', 'pengurus_bendahara', '`pengurus_bendahara`', '`pengurus_bendahara`', 200, 100, -1, false, '`pengurus_bendahara`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->pengurus_masa_jabatan = new DbField('koperasi_profil', 'koperasi_profil', 'x_pengurus_masa_jabatan', 'pengurus_masa_jabatan', '`pengurus_masa_jabatan`', '`pengurus_masa_jabatan`', 200, 20, -1, false, '`pengurus_masa_jabatan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pengawas_ketua
        $this->pengawas_ketua = new DbField('koperasi_profil', 'koperasi_profil', 'x_pengawas_ketua', 'pengawas_ketua', '`pengawas_ketua`', '`pengawas_ketua`', 200, 100, -1, false, '`pengawas_ketua`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pengawas_anggota_1
        $this->pengawas_anggota_1 = new DbField('koperasi_profil', 'koperasi_profil', 'x_pengawas_anggota_1', 'pengawas_anggota_1', '`pengawas_anggota_1`', '`pengawas_anggota_1`', 200, 100, -1, false, '`pengawas_anggota_1`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pengawas_anggota_2
        $this->pengawas_anggota_2 = new DbField('koperasi_profil', 'koperasi_profil', 'x_pengawas_anggota_2', 'pengawas_anggota_2', '`pengawas_anggota_2`', '`pengawas_anggota_2`', 200, 100, -1, false, '`pengawas_anggota_2`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->pengawas_masa_jabatan = new DbField('koperasi_profil', 'koperasi_profil', 'x_pengawas_masa_jabatan', 'pengawas_masa_jabatan', '`pengawas_masa_jabatan`', '`pengawas_masa_jabatan`', 200, 20, -1, false, '`pengawas_masa_jabatan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // manajer
        $this->manajer = new DbField('koperasi_profil', 'koperasi_profil', 'x_manajer', 'manajer', '`manajer`', '`manajer`', 200, 100, -1, false, '`manajer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // anggota_l
        $this->anggota_l = new DbField('koperasi_profil', 'koperasi_profil', 'x_anggota_l', 'anggota_l', '`anggota_l`', '`anggota_l`', 3, 11, -1, false, '`anggota_l`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // anggota_p
        $this->anggota_p = new DbField('koperasi_profil', 'koperasi_profil', 'x_anggota_p', 'anggota_p', '`anggota_p`', '`anggota_p`', 3, 11, -1, false, '`anggota_p`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // anggota_jml
        $this->anggota_jml = new DbField('koperasi_profil', 'koperasi_profil', 'x_anggota_jml', 'anggota_jml', '`anggota_jml`', '`anggota_jml`', 3, 11, -1, false, '`anggota_jml`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // anggota_calon
        $this->anggota_calon = new DbField('koperasi_profil', 'koperasi_profil', 'x_anggota_calon', 'anggota_calon', '`anggota_calon`', '`anggota_calon`', 3, 11, -1, false, '`anggota_calon`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pengurus_l
        $this->pengurus_l = new DbField('koperasi_profil', 'koperasi_profil', 'x_pengurus_l', 'pengurus_l', '`pengurus_l`', '`pengurus_l`', 3, 11, -1, false, '`pengurus_l`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pengurus_p
        $this->pengurus_p = new DbField('koperasi_profil', 'koperasi_profil', 'x_pengurus_p', 'pengurus_p', '`pengurus_p`', '`pengurus_p`', 3, 11, -1, false, '`pengurus_p`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pengurus_jml
        $this->pengurus_jml = new DbField('koperasi_profil', 'koperasi_profil', 'x_pengurus_jml', 'pengurus_jml', '`pengurus_jml`', '`pengurus_jml`', 3, 11, -1, false, '`pengurus_jml`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pengawas_l
        $this->pengawas_l = new DbField('koperasi_profil', 'koperasi_profil', 'x_pengawas_l', 'pengawas_l', '`pengawas_l`', '`pengawas_l`', 3, 11, -1, false, '`pengawas_l`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pengawas_p
        $this->pengawas_p = new DbField('koperasi_profil', 'koperasi_profil', 'x_pengawas_p', 'pengawas_p', '`pengawas_p`', '`pengawas_p`', 3, 11, -1, false, '`pengawas_p`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pengawas_jml
        $this->pengawas_jml = new DbField('koperasi_profil', 'koperasi_profil', 'x_pengawas_jml', 'pengawas_jml', '`pengawas_jml`', '`pengawas_jml`', 3, 11, -1, false, '`pengawas_jml`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // karyawan_l
        $this->karyawan_l = new DbField('koperasi_profil', 'koperasi_profil', 'x_karyawan_l', 'karyawan_l', '`karyawan_l`', '`karyawan_l`', 3, 11, -1, false, '`karyawan_l`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // karyawan_p
        $this->karyawan_p = new DbField('koperasi_profil', 'koperasi_profil', 'x_karyawan_p', 'karyawan_p', '`karyawan_p`', '`karyawan_p`', 3, 11, -1, false, '`karyawan_p`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // karyawan_jml
        $this->karyawan_jml = new DbField('koperasi_profil', 'koperasi_profil', 'x_karyawan_jml', 'karyawan_jml', '`karyawan_jml`', '`karyawan_jml`', 3, 11, -1, false, '`karyawan_jml`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // manajer_l
        $this->manajer_l = new DbField('koperasi_profil', 'koperasi_profil', 'x_manajer_l', 'manajer_l', '`manajer_l`', '`manajer_l`', 3, 11, -1, false, '`manajer_l`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // manajer_p
        $this->manajer_p = new DbField('koperasi_profil', 'koperasi_profil', 'x_manajer_p', 'manajer_p', '`manajer_p`', '`manajer_p`', 3, 11, -1, false, '`manajer_p`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // manajer_jml
        $this->manajer_jml = new DbField('koperasi_profil', 'koperasi_profil', 'x_manajer_jml', 'manajer_jml', '`manajer_jml`', '`manajer_jml`', 3, 11, -1, false, '`manajer_jml`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->pemeringkatan_klasifikasi = new DbField('koperasi_profil', 'koperasi_profil', 'x_pemeringkatan_klasifikasi', 'pemeringkatan_klasifikasi', '`pemeringkatan_klasifikasi`', '`pemeringkatan_klasifikasi`', 200, 50, -1, false, '`pemeringkatan_klasifikasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->kesehatan_koperasi_status = new DbField('koperasi_profil', 'koperasi_profil', 'x_kesehatan_koperasi_status', 'kesehatan_koperasi_status', '`kesehatan_koperasi_status`', '`kesehatan_koperasi_status`', 200, 50, -1, false, '`kesehatan_koperasi_status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->kesehatan_koperasi_angka = new DbField('koperasi_profil', 'koperasi_profil', 'x_kesehatan_koperasi_angka', 'kesehatan_koperasi_angka', '`kesehatan_koperasi_angka`', '`kesehatan_koperasi_angka`', 5, 22, -1, false, '`kesehatan_koperasi_angka`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // rat_buku
        $this->rat_buku = new DbField('koperasi_profil', 'koperasi_profil', 'x_rat_buku', 'rat_buku', '`rat_buku`', '`rat_buku`', 200, 20, -1, false, '`rat_buku`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // rat_tanggal
        $this->rat_tanggal = new DbField('koperasi_profil', 'koperasi_profil', 'x_rat_tanggal', 'rat_tanggal', '`rat_tanggal`', '`rat_tanggal`', 200, 20, -1, false, '`rat_tanggal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // indikator_usaha
        $this->indikator_usaha = new DbField('koperasi_profil', 'koperasi_profil', 'x_indikator_usaha', 'indikator_usaha', '`indikator_usaha`', '`indikator_usaha`', 200, 50, -1, false, '`indikator_usaha`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modal_luar
        $this->modal_luar = new DbField('koperasi_profil', 'koperasi_profil', 'x_modal_luar', 'modal_luar', '`modal_luar`', '`modal_luar`', 5, 22, -1, false, '`modal_luar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // aset
        $this->aset = new DbField('koperasi_profil', 'koperasi_profil', 'x_aset', 'aset', '`aset`', '`aset`', 5, 22, -1, false, '`aset`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // vol_usaha
        $this->vol_usaha = new DbField('koperasi_profil', 'koperasi_profil', 'x_vol_usaha', 'vol_usaha', '`vol_usaha`', '`vol_usaha`', 5, 22, -1, false, '`vol_usaha`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // vol_usaha_lainya
        $this->vol_usaha_lainya = new DbField('koperasi_profil', 'koperasi_profil', 'x_vol_usaha_lainya', 'vol_usaha_lainya', '`vol_usaha_lainya`', '`vol_usaha_lainya`', 5, 22, -1, false, '`vol_usaha_lainya`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // vol_usaha_jml
        $this->vol_usaha_jml = new DbField('koperasi_profil', 'koperasi_profil', 'x_vol_usaha_jml', 'vol_usaha_jml', '`vol_usaha_jml`', '`vol_usaha_jml`', 5, 22, -1, false, '`vol_usaha_jml`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // vol_usaha_tahunlalu
        $this->vol_usaha_tahunlalu = new DbField('koperasi_profil', 'koperasi_profil', 'x_vol_usaha_tahunlalu', 'vol_usaha_tahunlalu', '`vol_usaha_tahunlalu`', '`vol_usaha_tahunlalu`', 5, 22, -1, false, '`vol_usaha_tahunlalu`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // shu
        $this->shu = new DbField('koperasi_profil', 'koperasi_profil', 'x_shu', 'shu', '`shu`', '`shu`', 5, 22, -1, false, '`shu`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pedpt
        $this->pedpt = new DbField('koperasi_profil', 'koperasi_profil', 'x_pedpt', 'pedpt', '`pedpt`', '`pedpt`', 5, 22, -1, false, '`pedpt`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // biaya
        $this->biaya = new DbField('koperasi_profil', 'koperasi_profil', 'x_biaya', 'biaya', '`biaya`', '`biaya`', 5, 22, -1, false, '`biaya`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ms_sp
        $this->ms_sp = new DbField('koperasi_profil', 'koperasi_profil', 'x_ms_sp', 'ms_sp', '`ms_sp`', '`ms_sp`', 5, 22, -1, false, '`ms_sp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ms_sw
        $this->ms_sw = new DbField('koperasi_profil', 'koperasi_profil', 'x_ms_sw', 'ms_sw', '`ms_sw`', '`ms_sw`', 5, 22, -1, false, '`ms_sw`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ms_khusus
        $this->ms_khusus = new DbField('koperasi_profil', 'koperasi_profil', 'x_ms_khusus', 'ms_khusus', '`ms_khusus`', '`ms_khusus`', 5, 22, -1, false, '`ms_khusus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ms_cad
        $this->ms_cad = new DbField('koperasi_profil', 'koperasi_profil', 'x_ms_cad', 'ms_cad', '`ms_cad`', '`ms_cad`', 5, 22, -1, false, '`ms_cad`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ms_hibah
        $this->ms_hibah = new DbField('koperasi_profil', 'koperasi_profil', 'x_ms_hibah', 'ms_hibah', '`ms_hibah`', '`ms_hibah`', 5, 22, -1, false, '`ms_hibah`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ms_shu_belumdibagi
        $this->ms_shu_belumdibagi = new DbField('koperasi_profil', 'koperasi_profil', 'x_ms_shu_belumdibagi', 'ms_shu_belumdibagi', '`ms_shu_belumdibagi`', '`ms_shu_belumdibagi`', 5, 22, -1, false, '`ms_shu_belumdibagi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ms_dana_cadlain
        $this->ms_dana_cadlain = new DbField('koperasi_profil', 'koperasi_profil', 'x_ms_dana_cadlain', 'ms_dana_cadlain', '`ms_dana_cadlain`', '`ms_dana_cadlain`', 5, 22, -1, false, '`ms_dana_cadlain`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ms_modal_penyerta
        $this->ms_modal_penyerta = new DbField('koperasi_profil', 'koperasi_profil', 'x_ms_modal_penyerta', 'ms_modal_penyerta', '`ms_modal_penyerta`', '`ms_modal_penyerta`', 5, 22, -1, false, '`ms_modal_penyerta`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ms_jumlah
        $this->ms_jumlah = new DbField('koperasi_profil', 'koperasi_profil', 'x_ms_jumlah', 'ms_jumlah', '`ms_jumlah`', '`ms_jumlah`', 5, 22, -1, false, '`ms_jumlah`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pinjaman_sp
        $this->pinjaman_sp = new DbField('koperasi_profil', 'koperasi_profil', 'x_pinjaman_sp', 'pinjaman_sp', '`pinjaman_sp`', '`pinjaman_sp`', 5, 22, -1, false, '`pinjaman_sp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pinjaman_lainya
        $this->pinjaman_lainya = new DbField('koperasi_profil', 'koperasi_profil', 'x_pinjaman_lainya', 'pinjaman_lainya', '`pinjaman_lainya`', '`pinjaman_lainya`', 5, 22, -1, false, '`pinjaman_lainya`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pinjaman_jumlah
        $this->pinjaman_jumlah = new DbField('koperasi_profil', 'koperasi_profil', 'x_pinjaman_jumlah', 'pinjaman_jumlah', '`pinjaman_jumlah`', '`pinjaman_jumlah`', 5, 22, -1, false, '`pinjaman_jumlah`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jml_dana
        $this->jml_dana = new DbField('koperasi_profil', 'koperasi_profil', 'x_jml_dana', 'jml_dana', '`jml_dana`', '`jml_dana`', 5, 22, -1, false, '`jml_dana`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->investasi_jangka_panjang = new DbField('koperasi_profil', 'koperasi_profil', 'x_investasi_jangka_panjang', 'investasi_jangka_panjang', '`investasi_jangka_panjang`', '`investasi_jangka_panjang`', 5, 22, -1, false, '`investasi_jangka_panjang`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // simpanan_lainya
        $this->simpanan_lainya = new DbField('koperasi_profil', 'koperasi_profil', 'x_simpanan_lainya', 'simpanan_lainya', '`simpanan_lainya`', '`simpanan_lainya`', 5, 22, -1, false, '`simpanan_lainya`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // simpanan_sukarela
        $this->simpanan_sukarela = new DbField('koperasi_profil', 'koperasi_profil', 'x_simpanan_sukarela', 'simpanan_sukarela', '`simpanan_sukarela`', '`simpanan_sukarela`', 5, 22, -1, false, '`simpanan_sukarela`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // simpanan_jumlah
        $this->simpanan_jumlah = new DbField('koperasi_profil', 'koperasi_profil', 'x_simpanan_jumlah', 'simpanan_jumlah', '`simpanan_jumlah`', '`simpanan_jumlah`', 5, 22, -1, false, '`simpanan_jumlah`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // thn_periode
        $this->thn_periode = new DbField('koperasi_profil', 'koperasi_profil', 'x_thn_periode', 'thn_periode', '`thn_periode`', '`thn_periode`', 3, 4, -1, false, '`thn_periode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // periode
        $this->periode = new DbField('koperasi_profil', 'koperasi_profil', 'x_periode', 'periode', '`periode`', '`periode`', 3, 1, -1, false, '`periode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`koperasi_profil`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("koperasiprofillist");
    }
    ...
    {
        global $Language;
        if ($pageName == "koperasiprofilview") {
            return $Language->phrase("View");
        } elseif ($pageName == "koperasiprofiledit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "koperasiprofiladd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "KoperasiProfilView";
            case Config("API_ADD_ACTION"):
                return "KoperasiProfilAdd";
            case Config("API_EDIT_ACTION"):
                return "KoperasiProfilEdit";
            case Config("API_DELETE_ACTION"):
                return "KoperasiProfilDelete";
            case Config("API_LIST_ACTION"):
                return "KoperasiProfilList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("koperasiprofilview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("koperasiprofilview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "koperasiprofiladd?" . $this->getUrlParm($parm);
        } else {
            $url = "koperasiprofiladd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("koperasiprofiledit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("koperasiprofiladd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("koperasiprofildelete", $this->getUrlParm());
    }
