 ...
 * Page class
 */
class UmkmAspeklembagaLmAdd extends UmkmAspeklembagaLm
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UmkmAspeklembagaLmAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("umkmaspeklembagalmlist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "umkmaspeklembagalmlist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "umkmaspeklembagalmview") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->LB_BADANHUKUM->EditValue = HtmlEncode($this->LB_BADANHUKUM->CurrentValue);
            ...
            $this->LB_IZINUSAHA->EditValue = HtmlEncode($this->LB_IZINUSAHA->CurrentValue);
            ...
            $this->LB_NPWP->EditValue = HtmlEncode($this->LB_NPWP->CurrentValue);
            ...
            $this->LB_SO->EditValue = HtmlEncode($this->LB_SO->CurrentValue);
            ...
            $this->LB_JD->EditValue = HtmlEncode($this->LB_JD->CurrentValue);
            ...
            $this->LB_ISO->EditValue = HtmlEncode($this->LB_ISO->CurrentValue);
