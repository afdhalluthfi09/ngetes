 ...
 * Page class
 */
class IndonesiaCitiesEdit extends IndonesiaCities
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IndonesiaCitiesEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // province_id
            $this->province_id->setDbValueDef($rsnew, $this->province_id->CurrentValue, "", $this->province_id->ReadOnly);
