...
/**
 * Table class for binadatalengkap
 */
class Binadatalengkap extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'binadatalengkap';
        $this->TableName = 'binadatalengkap';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`binadatalengkap`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('binadatalengkap', 'binadatalengkap', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // idperiode
        $this->idperiode = new DbField('binadatalengkap', 'binadatalengkap', 'x_idperiode', 'idperiode', '`idperiode`', '`idperiode`', 2, 6, -1, false, '`idperiode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // periode_tahun
        $this->periode_tahun = new DbField('binadatalengkap', 'binadatalengkap', 'x_periode_tahun', 'periode_tahun', '`periode_tahun`', '`periode_tahun`', 3, 4, -1, false, '`periode_tahun`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // periode_bulan
        $this->periode_bulan = new DbField('binadatalengkap', 'binadatalengkap', 'x_periode_bulan', 'periode_bulan', '`periode_bulan`', '`periode_bulan`', 200, 30, -1, false, '`periode_bulan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // idkelompok
        $this->idkelompok = new DbField('binadatalengkap', 'binadatalengkap', 'x_idkelompok', 'idkelompok', '`idkelompok`', '`idkelompok`', 2, 6, -1, false, '`idkelompok`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kelompok_pembinaan
        $this->kelompok_pembinaan = new DbField('binadatalengkap', 'binadatalengkap', 'x_kelompok_pembinaan', 'kelompok_pembinaan', '`kelompok_pembinaan`', '`kelompok_pembinaan`', 200, 255, -1, false, '`kelompok_pembinaan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // namakegiatan
        $this->namakegiatan = new DbField('binadatalengkap', 'binadatalengkap', 'x_namakegiatan', 'namakegiatan', '`namakegiatan`', '`namakegiatan`', 200, 200, -1, false, '`namakegiatan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // uraian
        $this->uraian = new DbField('binadatalengkap', 'binadatalengkap', 'x_uraian', 'uraian', '`uraian`', '`uraian`', 200, 255, -1, false, '`uraian`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tglmulai
        $this->tglmulai = new DbField('binadatalengkap', 'binadatalengkap', 'x_tglmulai', 'tglmulai', '`tglmulai`', CastDateFieldForLike("`tglmulai`", 0, "DB"), 133, 10, 0, false, '`tglmulai`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tglakhir
        $this->tglakhir = new DbField('binadatalengkap', 'binadatalengkap', 'x_tglakhir', 'tglakhir', '`tglakhir`', CastDateFieldForLike("`tglakhir`", 0, "DB"), 133, 10, 0, false, '`tglakhir`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // narasumber
        $this->narasumber = new DbField('binadatalengkap', 'binadatalengkap', 'x_narasumber', 'narasumber', '`narasumber`', '`narasumber`', 200, 100, -1, false, '`narasumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kontak_nama
        $this->kontak_nama = new DbField('binadatalengkap', 'binadatalengkap', 'x_kontak_nama', 'kontak_nama', '`kontak_nama`', '`kontak_nama`', 200, 50, -1, false, '`kontak_nama`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kontak_hp
        $this->kontak_hp = new DbField('binadatalengkap', 'binadatalengkap', 'x_kontak_hp', 'kontak_hp', '`kontak_hp`', '`kontak_hp`', 200, 50, -1, false, '`kontak_hp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // poster
        $this->poster = new DbField('binadatalengkap', 'binadatalengkap', 'x_poster', 'poster', '`poster`', '`poster`', 200, 50, -1, false, '`poster`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // postertipe
        $this->postertipe = new DbField('binadatalengkap', 'binadatalengkap', 'x_postertipe', 'postertipe', '`postertipe`', '`postertipe`', 200, 200, -1, false, '`postertipe`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // posterukuran
        $this->posterukuran = new DbField('binadatalengkap', 'binadatalengkap', 'x_posterukuran', 'posterukuran', '`posterukuran`', '`posterukuran`', 3, 11, -1, false, '`posterukuran`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // posterlebar
        $this->posterlebar = new DbField('binadatalengkap', 'binadatalengkap', 'x_posterlebar', 'posterlebar', '`posterlebar`', '`posterlebar`', 3, 11, -1, false, '`posterlebar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // postertinggi
        $this->postertinggi = new DbField('binadatalengkap', 'binadatalengkap', 'x_postertinggi', 'postertinggi', '`postertinggi`', '`postertinggi`', 3, 11, -1, false, '`postertinggi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // linkinfo
        $this->linkinfo = new DbField('binadatalengkap', 'binadatalengkap', 'x_linkinfo', 'linkinfo', '`linkinfo`', '`linkinfo`', 200, 100, -1, false, '`linkinfo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // peserta_kelas
        $this->peserta_kelas = new DbField('binadatalengkap', 'binadatalengkap', 'x_peserta_kelas', 'peserta_kelas', '`peserta_kelas`', '`peserta_kelas`', 200, 50, -1, false, '`peserta_kelas`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // waktu
        $this->waktu = new DbField('binadatalengkap', 'binadatalengkap', 'x_waktu', 'waktu', '`waktu`', CastDateFieldForLike("`waktu`", 0, "DB"), 135, 19, 0, false, '`waktu`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`binadatalengkap`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("binadatalengkaplist");
    }
    ...
    {
        global $Language;
        if ($pageName == "binadatalengkapview") {
            return $Language->phrase("View");
        } elseif ($pageName == "binadatalengkapedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "binadatalengkapadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "BinadatalengkapView";
            case Config("API_ADD_ACTION"):
                return "BinadatalengkapAdd";
            case Config("API_EDIT_ACTION"):
                return "BinadatalengkapEdit";
            case Config("API_DELETE_ACTION"):
                return "BinadatalengkapDelete";
            case Config("API_LIST_ACTION"):
                return "BinadatalengkapList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("binadatalengkapview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("binadatalengkapview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "binadatalengkapadd?" . $this->getUrlParm($parm);
        } else {
            $url = "binadatalengkapadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("binadatalengkapedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("binadatalengkapadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("binadatalengkapdelete", $this->getUrlParm());
    }
