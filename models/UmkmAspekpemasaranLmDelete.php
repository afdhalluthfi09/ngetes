 ...
 * Page class
 */
class UmkmAspekpemasaranLmDelete extends UmkmAspekpemasaranLm
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UmkmAspekpemasaranLmDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("umkmaspekpemasaranlmlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("umkmaspekpemasaranlmlist"); // Return to list
                return;
            }
        }
