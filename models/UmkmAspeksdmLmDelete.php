 ...
 * Page class
 */
class UmkmAspeksdmLmDelete extends UmkmAspeksdmLm
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UmkmAspeksdmLmDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("umkmaspeksdmlmlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("umkmaspeksdmlmlist"); // Return to list
                return;
            }
        }
