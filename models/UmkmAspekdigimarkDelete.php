 ...
 * Page class
 */
class UmkmAspekdigimarkDelete extends UmkmAspekdigimark
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UmkmAspekdigimarkDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("umkmaspekdigimarklist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("umkmaspekdigimarklist"); // Return to list
                return;
            }
        }
