 ...
 * Page class
 */
class KumkmMarketAdd extends KumkmMarket
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KumkmMarketAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "kumkmmarketview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->produk_foto->Upload->DbValue = null;
        $this->produk_foto->OldValue = $this->produk_foto->Upload->DbValue;
        $this->produk_foto->CurrentValue = null; // Clear file related field
        ...
        $this->kurasi->CurrentValue = "N";
        $this->waktu_entry->CurrentValue = null;
        $this->waktu_entry->OldValue = $this->waktu_entry->CurrentValue;
        $this->waktu_kurasi->CurrentValue = null;
        $this->waktu_kurasi->OldValue = $this->waktu_kurasi->CurrentValue;
        $this->waktu_update->CurrentValue = null;
        $this->waktu_update->OldValue = $this->waktu_update->CurrentValue;
        ...
        $this->produk_harga_dasar->CurrentValue = 0;
        ...
        $this->market->CurrentValue = null;
        $this->market->OldValue = $this->market->CurrentValue;
        $this->yia_sku->CurrentValue = null;
        $this->yia_sku->OldValue = $this->yia_sku->CurrentValue;
        $this->yia_idproduk->CurrentValue = null;
        $this->yia_idproduk->OldValue = $this->yia_idproduk->CurrentValue;
        $this->yia_stok_alert->CurrentValue = 0;
        $this->produk_foto_4->Upload->DbValue = null;
        $this->produk_foto_4->OldValue = $this->produk_foto_4->Upload->DbValue;
        $this->produk_foto_4->CurrentValue = null; // Clear file related field
    }
    ...
    protected function newRow()
    {
        ...
        $row['produk_foto'] = $this->produk_foto->Upload->DbValue;
        ...
        $row['kurasi'] = $this->kurasi->CurrentValue;
        $row['waktu_entry'] = $this->waktu_entry->CurrentValue;
        $row['waktu_kurasi'] = $this->waktu_kurasi->CurrentValue;
        $row['waktu_update'] = $this->waktu_update->CurrentValue;
        ...
        $row['produk_harga_dasar'] = $this->produk_harga_dasar->CurrentValue;
        ...
        $row['market'] = $this->market->CurrentValue;
        $row['yia_sku'] = $this->yia_sku->CurrentValue;
        $row['yia_idproduk'] = $this->yia_idproduk->CurrentValue;
        $row['yia_stok_alert'] = $this->yia_stok_alert->CurrentValue;
        $row['produk_foto_4'] = $this->produk_foto_4->Upload->DbValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->produk_foto->Visible && !$this->produk_foto->Upload->KeepFile) {
            $this->produk_foto->Upload->DbValue = ""; // No need to delete old file
        ...
        // kurasi
        $this->kurasi->CurrentValue = 'N';
        $this->kurasi->setDbValueDef($rsnew, $this->kurasi->CurrentValue, null);
        ...
        // produk_harga_dasar
        $this->produk_harga_dasar->setDbValueDef($rsnew, $this->produk_harga_dasar->CurrentValue, null, strval($this->produk_harga_dasar->CurrentValue) == "");
        ...
        // market
        $this->market->setDbValueDef($rsnew, $this->market->CurrentValue, null, false);
        if ($this->produk_foto->Visible && !$this->produk_foto->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->produk_foto->Upload->FileName)) {
                ...
                $this->produk_foto->setDbValueDef($rsnew, $this->produk_foto->Upload->FileName, null, false);
            }
        }
        if ($this->produk_foto_1->Visible && !$this->produk_foto_1->Upload->KeepFile) {
