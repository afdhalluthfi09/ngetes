 ...
 * Page class
 */
class KumkmLiterasiEdit extends KumkmLiterasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KumkmLiterasiEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // idjenis
            $this->idjenis->setDbValueDef($rsnew, $this->idjenis->CurrentValue, null, $this->idjenis->ReadOnly);

            // judul_artikel
            $this->judul_artikel->setDbValueDef($rsnew, $this->judul_artikel->CurrentValue, null, $this->judul_artikel->ReadOnly);

            // kelas
            $this->kelas->setDbValueDef($rsnew, $this->kelas->CurrentValue, null, $this->kelas->ReadOnly);

            // isi_artikel
            $this->isi_artikel->setDbValueDef($rsnew, $this->isi_artikel->CurrentValue, null, $this->isi_artikel->ReadOnly);
