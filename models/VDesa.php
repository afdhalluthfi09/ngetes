...
/**
 * Table class for v_desa
 */
class VDesa extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_desa';
        $this->TableName = 'v_desa';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_desa`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('v_desa', 'v_desa', 'x_id', 'id', '`id`', '`id`', 200, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // district_id
        $this->district_id = new DbField('v_desa', 'v_desa', 'x_district_id', 'district_id', '`district_id`', '`district_id`', 200, 7, -1, false, '`district_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // name
        $this->name = new DbField('v_desa', 'v_desa', 'x_name', 'name', '`name`', '`name`', 200, 255, -1, false, '`name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // city_id
        $this->city_id = new DbField('v_desa', 'v_desa', 'x_city_id', 'city_id', '`city_id`', '`city_id`', 200, 4, -1, false, '`city_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_desa`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("vdesalist");
    }
    ...
    {
        global $Language;
        if ($pageName == "vdesaview") {
            return $Language->phrase("View");
        } elseif ($pageName == "vdesaedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "vdesaadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("vdesaview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("vdesaview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "vdesaadd?" . $this->getUrlParm($parm);
        } else {
            $url = "vdesaadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("vdesaedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vdesaadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("vdesadelete", $this->getUrlParm());
    }
