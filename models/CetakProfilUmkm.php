...
/**
 * Table class for cetak_profil_umkm
 */
class CetakProfilUmkm extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'cetak_profil_umkm';
        $this->TableName = 'cetak_profil_umkm';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`cetak_profil_umkm`";
        $this->Dbid = 'DB';
        ...
        // NIK
        $this->NIK = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_NIK', 'NIK', '`NIK`', '`NIK`', 200, 16, -1, false, '`NIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA_USAHA
        $this->NAMA_USAHA = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_NAMA_USAHA', 'NAMA_USAHA', '`NAMA_USAHA`', '`NAMA_USAHA`', 200, 100, -1, false, '`NAMA_USAHA`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAHUN_MULAI_USAHA
        $this->TAHUN_MULAI_USAHA = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_TAHUN_MULAI_USAHA', 'TAHUN_MULAI_USAHA', '`TAHUN_MULAI_USAHA`', '`TAHUN_MULAI_USAHA`', 200, 10, -1, false, '`TAHUN_MULAI_USAHA`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ALAMAT
        $this->ALAMAT = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_ALAMAT', 'ALAMAT', '`ALAMAT`', '`ALAMAT`', 200, 255, -1, false, '`ALAMAT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ALAMAT->Sortable = true; // Allow sort
        $this->ALAMAT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ALAMAT->Param, "CustomMsg");
        $this->Fields['ALAMAT'] = &$this->ALAMAT;

        // DUSUN
        $this->DUSUN = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_DUSUN', 'DUSUN', '`DUSUN`', '`DUSUN`', 200, 50, -1, false, '`DUSUN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KALURAHAN
        $this->KALURAHAN = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_KALURAHAN', 'KALURAHAN', '`KALURAHAN`', '`KALURAHAN`', 200, 50, -1, false, '`KALURAHAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KAPANEWON
        $this->KAPANEWON = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_KAPANEWON', 'KAPANEWON', '`KAPANEWON`', '`KAPANEWON`', 200, 50, -1, false, '`KAPANEWON`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_USAHA
        $this->STATUS_USAHA = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_STATUS_USAHA', 'STATUS_USAHA', '`STATUS_USAHA`', '`STATUS_USAHA`', 200, 50, -1, false, '`STATUS_USAHA`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_IZIN_USAHA
        $this->NO_IZIN_USAHA = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_NO_IZIN_USAHA', 'NO_IZIN_USAHA', '`NO_IZIN_USAHA`', '`NO_IZIN_USAHA`', 200, 100, -1, false, '`NO_IZIN_USAHA`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SEKTOR_EKRAF
        $this->SEKTOR_EKRAF = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_SEKTOR_EKRAF', 'SEKTOR_EKRAF', '`SEKTOR_EKRAF`', '`SEKTOR_EKRAF`', 2, 6, -1, false, '`SEKTOR_EKRAF`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SEKTOR_KBLI
        $this->SEKTOR_KBLI = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_SEKTOR_KBLI', 'SEKTOR_KBLI', '`SEKTOR_KBLI`', '`SEKTOR_KBLI`', 2, 6, -1, false, '`SEKTOR_KBLI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SEKTOR_PERGUB
        $this->SEKTOR_PERGUB = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_SEKTOR_PERGUB', 'SEKTOR_PERGUB', '`SEKTOR_PERGUB`', '`SEKTOR_PERGUB`', 2, 6, -1, false, '`SEKTOR_PERGUB`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SEKTOR
        $this->SEKTOR = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_SEKTOR', 'SEKTOR', '`SEKTOR`', '`SEKTOR`', 200, 50, -1, false, '`SEKTOR`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODAL_KERJA
        $this->MODAL_KERJA = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_MODAL_KERJA', 'MODAL_KERJA', '`MODAL_KERJA`', '`MODAL_KERJA`', 5, 22, -1, false, '`MODAL_KERJA`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->TENAGA_KERJA_LAKILAKI = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_TENAGA_KERJA_LAKILAKI', 'TENAGA_KERJA_LAKI-LAKI', '`TENAGA_KERJA_LAKI-LAKI`', '`TENAGA_KERJA_LAKI-LAKI`', 16, 4, -1, false, '`TENAGA_KERJA_LAKI-LAKI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->TENAGA_KERJA_PEREMPUAN = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_TENAGA_KERJA_PEREMPUAN', 'TENAGA_KERJA_PEREMPUAN', '`TENAGA_KERJA_PEREMPUAN`', '`TENAGA_KERJA_PEREMPUAN`', 16, 4, -1, false, '`TENAGA_KERJA_PEREMPUAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->OMZET_RATARATA_PERTAHUN = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_OMZET_RATARATA_PERTAHUN', 'OMZET_RATA-RATA_PERTAHUN', '`OMZET_RATA-RATA_PERTAHUN`', '`OMZET_RATA-RATA_PERTAHUN`', 5, 22, -1, false, '`OMZET_RATA-RATA_PERTAHUN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA_PEMILIK
        $this->NAMA_PEMILIK = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_NAMA_PEMILIK', 'NAMA_PEMILIK', '`NAMA_PEMILIK`', '`NAMA_PEMILIK`', 200, 100, -1, false, '`NAMA_PEMILIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_HP
        $this->NO_HP = new DbField('cetak_profil_umkm', 'cetak_profil_umkm', 'x_NO_HP', 'NO_HP', '`NO_HP`', '`NO_HP`', 200, 20, -1, false, '`NO_HP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`cetak_profil_umkm`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("cetakprofilumkmlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "cetakprofilumkmview") {
            return $Language->phrase("View");
        } elseif ($pageName == "cetakprofilumkmedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "cetakprofilumkmadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "CetakProfilUmkmView";
            case Config("API_ADD_ACTION"):
                return "CetakProfilUmkmAdd";
            case Config("API_EDIT_ACTION"):
                return "CetakProfilUmkmEdit";
            case Config("API_DELETE_ACTION"):
                return "CetakProfilUmkmDelete";
            case Config("API_LIST_ACTION"):
                return "CetakProfilUmkmList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("cetakprofilumkmview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("cetakprofilumkmview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "cetakprofilumkmadd?" . $this->getUrlParm($parm);
        } else {
            $url = "cetakprofilumkmadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("cetakprofilumkmedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("cetakprofilumkmadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("cetakprofilumkmdelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        $this->SEKTOR_EKRAF->ViewValue = FormatNumber($this->SEKTOR_EKRAF->ViewValue, 0, -2, -2, -2);
        $this->SEKTOR_EKRAF->ViewCustomAttributes = "";

        // SEKTOR_KBLI
        $this->SEKTOR_KBLI->ViewValue = $this->SEKTOR_KBLI->CurrentValue;
        $this->SEKTOR_KBLI->ViewValue = FormatNumber($this->SEKTOR_KBLI->ViewValue, 0, -2, -2, -2);
        $this->SEKTOR_KBLI->ViewCustomAttributes = "";

        // SEKTOR_PERGUB
        $this->SEKTOR_PERGUB->ViewValue = $this->SEKTOR_PERGUB->CurrentValue;
        $this->SEKTOR_PERGUB->ViewValue = FormatNumber($this->SEKTOR_PERGUB->ViewValue, 0, -2, -2, -2);
