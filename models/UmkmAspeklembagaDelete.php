 ...
 * Page class
 */
class UmkmAspeklembagaDelete extends UmkmAspeklembaga
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UmkmAspeklembagaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("umkmaspeklembagalist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("umkmaspeklembagalist"); // Return to list
                return;
            }
        }
