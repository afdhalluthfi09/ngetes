...
/**
 * Table class for bina_data
 */
class BinaData extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'bina_data';
        $this->TableName = 'bina_data';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`bina_data`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('bina_data', 'bina_data', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // idperiode
        $this->idperiode = new DbField('bina_data', 'bina_data', 'x_idperiode', 'idperiode', '`idperiode`', '`idperiode`', 2, 6, -1, false, '`idperiode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // idkelompok
        $this->idkelompok = new DbField('bina_data', 'bina_data', 'x_idkelompok', 'idkelompok', '`idkelompok`', '`idkelompok`', 2, 6, -1, false, '`idkelompok`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // namakegiatan
        $this->namakegiatan = new DbField('bina_data', 'bina_data', 'x_namakegiatan', 'namakegiatan', '`namakegiatan`', '`namakegiatan`', 200, 200, -1, false, '`namakegiatan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // uraian
        $this->uraian = new DbField('bina_data', 'bina_data', 'x_uraian', 'uraian', '`uraian`', '`uraian`', 200, 255, -1, false, '`uraian`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tglmulai
        $this->tglmulai = new DbField('bina_data', 'bina_data', 'x_tglmulai', 'tglmulai', '`tglmulai`', CastDateFieldForLike("`tglmulai`", 0, "DB"), 133, 10, 0, false, '`tglmulai`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tglakhir
        $this->tglakhir = new DbField('bina_data', 'bina_data', 'x_tglakhir', 'tglakhir', '`tglakhir`', CastDateFieldForLike("`tglakhir`", 0, "DB"), 133, 10, 0, false, '`tglakhir`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // narasumber
        $this->narasumber = new DbField('bina_data', 'bina_data', 'x_narasumber', 'narasumber', '`narasumber`', '`narasumber`', 200, 100, -1, false, '`narasumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kontak_nama
        $this->kontak_nama = new DbField('bina_data', 'bina_data', 'x_kontak_nama', 'kontak_nama', '`kontak_nama`', '`kontak_nama`', 200, 50, -1, false, '`kontak_nama`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kontak_hp
        $this->kontak_hp = new DbField('bina_data', 'bina_data', 'x_kontak_hp', 'kontak_hp', '`kontak_hp`', '`kontak_hp`', 200, 50, -1, false, '`kontak_hp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // poster
        $this->poster = new DbField('bina_data', 'bina_data', 'x_poster', 'poster', '`poster`', '`poster`', 200, 50, -1, false, '`poster`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // postertipe
        $this->postertipe = new DbField('bina_data', 'bina_data', 'x_postertipe', 'postertipe', '`postertipe`', '`postertipe`', 200, 200, -1, false, '`postertipe`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // posterukuran
        $this->posterukuran = new DbField('bina_data', 'bina_data', 'x_posterukuran', 'posterukuran', '`posterukuran`', '`posterukuran`', 3, 11, -1, false, '`posterukuran`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // posterlebar
        $this->posterlebar = new DbField('bina_data', 'bina_data', 'x_posterlebar', 'posterlebar', '`posterlebar`', '`posterlebar`', 3, 11, -1, false, '`posterlebar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // postertinggi
        $this->postertinggi = new DbField('bina_data', 'bina_data', 'x_postertinggi', 'postertinggi', '`postertinggi`', '`postertinggi`', 3, 11, -1, false, '`postertinggi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // linkinfo
        $this->linkinfo = new DbField('bina_data', 'bina_data', 'x_linkinfo', 'linkinfo', '`linkinfo`', '`linkinfo`', 200, 100, -1, false, '`linkinfo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // peserta_kelas
        $this->peserta_kelas = new DbField('bina_data', 'bina_data', 'x_peserta_kelas', 'peserta_kelas', '`peserta_kelas`', '`peserta_kelas`', 200, 50, -1, false, '`peserta_kelas`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // waktu
        $this->waktu = new DbField('bina_data', 'bina_data', 'x_waktu', 'waktu', '`waktu`', CastDateFieldForLike("`waktu`", 0, "DB"), 135, 19, 0, false, '`waktu`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`bina_data`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("binadatalist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "binadataedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "binadataadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("binadataview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("binadataview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "binadataadd?" . $this->getUrlParm($parm);
        } else {
            $url = "binadataadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("binadataedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("binadataadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("binadatadelete", $this->getUrlParm());
    }
