...
/**
 * Table class for umkm_aspekkeuangan_lm
 */
class UmkmAspekkeuanganLm extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'umkm_aspekkeuangan_lm';
        $this->TableName = 'umkm_aspekkeuangan_lm';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`umkm_aspekkeuangan_lm`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // NIK
        $this->NIK = new DbField('umkm_aspekkeuangan_lm', 'umkm_aspekkeuangan_lm', 'x_NIK', 'NIK', '`NIK`', '`NIK`', 200, 16, -1, false, '`NIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KEU_USAHAUTAMA
        $this->KEU_USAHAUTAMA = new DbField('umkm_aspekkeuangan_lm', 'umkm_aspekkeuangan_lm', 'x_KEU_USAHAUTAMA', 'KEU_USAHAUTAMA', '`KEU_USAHAUTAMA`', '`KEU_USAHAUTAMA`', 200, 50, -1, false, '`KEU_USAHAUTAMA`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KEU_PENGELOLAAN
        $this->KEU_PENGELOLAAN = new DbField('umkm_aspekkeuangan_lm', 'umkm_aspekkeuangan_lm', 'x_KEU_PENGELOLAAN', 'KEU_PENGELOLAAN', '`KEU_PENGELOLAAN`', '`KEU_PENGELOLAAN`', 200, 50, -1, false, '`KEU_PENGELOLAAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KEU_NOTA
        $this->KEU_NOTA = new DbField('umkm_aspekkeuangan_lm', 'umkm_aspekkeuangan_lm', 'x_KEU_NOTA', 'KEU_NOTA', '`KEU_NOTA`', '`KEU_NOTA`', 200, 50, -1, false, '`KEU_NOTA`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KEU_PENCATATAN
        $this->KEU_PENCATATAN = new DbField('umkm_aspekkeuangan_lm', 'umkm_aspekkeuangan_lm', 'x_KEU_PENCATATAN', 'KEU_PENCATATAN', '`KEU_PENCATATAN`', '`KEU_PENCATATAN`', 200, 50, -1, false, '`KEU_PENCATATAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KEU_LAPORAN
        $this->KEU_LAPORAN = new DbField('umkm_aspekkeuangan_lm', 'umkm_aspekkeuangan_lm', 'x_KEU_LAPORAN', 'KEU_LAPORAN', '`KEU_LAPORAN`', '`KEU_LAPORAN`', 200, 50, -1, false, '`KEU_LAPORAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KEU_UTANGMODAL
        $this->KEU_UTANGMODAL = new DbField('umkm_aspekkeuangan_lm', 'umkm_aspekkeuangan_lm', 'x_KEU_UTANGMODAL', 'KEU_UTANGMODAL', '`KEU_UTANGMODAL`', '`KEU_UTANGMODAL`', 200, 50, -1, false, '`KEU_UTANGMODAL`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KEU_CATATNASET
        $this->KEU_CATATNASET = new DbField('umkm_aspekkeuangan_lm', 'umkm_aspekkeuangan_lm', 'x_KEU_CATATNASET', 'KEU_CATATNASET', '`KEU_CATATNASET`', '`KEU_CATATNASET`', 200, 50, -1, false, '`KEU_CATATNASET`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KEU_NONTUNAI
        $this->KEU_NONTUNAI = new DbField('umkm_aspekkeuangan_lm', 'umkm_aspekkeuangan_lm', 'x_KEU_NONTUNAI', 'KEU_NONTUNAI', '`KEU_NONTUNAI`', '`KEU_NONTUNAI`', 200, 50, -1, false, '`KEU_NONTUNAI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`umkm_aspekkeuangan_lm`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("umkmaspekkeuanganlmlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "umkmaspekkeuanganlmview") {
            return $Language->phrase("View");
        } elseif ($pageName == "umkmaspekkeuanganlmedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "umkmaspekkeuanganlmadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "UmkmAspekkeuanganLmView";
            case Config("API_ADD_ACTION"):
                return "UmkmAspekkeuanganLmAdd";
            case Config("API_EDIT_ACTION"):
                return "UmkmAspekkeuanganLmEdit";
            case Config("API_DELETE_ACTION"):
                return "UmkmAspekkeuanganLmDelete";
            case Config("API_LIST_ACTION"):
                return "UmkmAspekkeuanganLmList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("umkmaspekkeuanganlmview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("umkmaspekkeuanganlmview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "umkmaspekkeuanganlmadd?" . $this->getUrlParm($parm);
        } else {
            $url = "umkmaspekkeuanganlmadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmaspekkeuanganlmedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmaspekkeuanganlmadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("umkmaspekkeuanganlmdelete", $this->getUrlParm());
    }
