...
class Admin extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('admin', 'admin', 'x_id', 'id', '`id`', '`id`', 2, 6, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // username
        $this->_username = new DbField('admin', 'admin', 'x__username', 'username', '`username`', '`username`', 200, 100, -1, false, '`username`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pwd
        $this->pwd = new DbField('admin', 'admin', 'x_pwd', 'pwd', '`pwd`', '`pwd`', 200, 255, -1, false, '`pwd`', false, false, false, 'FORMATTED TEXT', 'PASSWORD');
        $this->pwd->Nullable = false; // NOT NULL field
        $this->pwd->Required = true; // Required field
        $this->pwd->Sortable = true; // Allow sort
        $this->pwd->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->pwd->Param, "CustomMsg");
        $this->Fields['pwd'] = &$this->pwd;

        // unit
        $this->unit = new DbField('admin', 'admin', 'x_unit', 'unit', '`unit`', '`unit`', 200, 50, -1, false, '`unit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fullname
        $this->fullname = new DbField('admin', 'admin', 'x_fullname', 'fullname', '`fullname`', '`fullname`', 200, 100, -1, false, '`fullname`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // no_wa
        $this->no_wa = new DbField('admin', 'admin', 'x_no_wa', 'no_wa', '`no_wa`', '`no_wa`', 200, 20, -1, false, '`no_wa`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // organisasi
        $this->organisasi = new DbField('admin', 'admin', 'x_organisasi', 'organisasi', '`organisasi`', '`organisasi`', 200, 50, -1, false, '`organisasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // email
        $this->_email = new DbField('admin', 'admin', 'x__email', 'email', '`email`', '`email`', 200, 50, -1, false, '`email`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->_email->Sortable = true; // Allow sort
        $this->_email->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->_email->Param, "CustomMsg");
        $this->Fields['email'] = &$this->_email;

        // userlevel
        $this->_userlevel = new DbField('admin', 'admin', 'x__userlevel', 'userlevel', '`userlevel`', '`userlevel`', 3, 11, -1, false, '`userlevel`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("adminlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "adminedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "adminadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("adminview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("adminview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "adminadd?" . $this->getUrlParm($parm);
        } else {
            $url = "adminadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("adminedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("adminadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("admindelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        // pwd
        $this->pwd->CellCssStyle = "white-space: nowrap;";
        ...
        // pwd
        $this->pwd->ViewValue = $Language->phrase("PasswordMask");
    ...
    public function renderEditRow()
    {
        ...
        // pwd
        $this->pwd->EditAttrs["class"] = "form-control ew-password-strength";
        $this->pwd->EditCustomAttributes = "";
        $this->pwd->EditValue = $Language->phrase("PasswordMask"); // Show as masked password
        ...
        $this->organisasi->PlaceHolder = RemoveHtml($this->organisasi->caption());
