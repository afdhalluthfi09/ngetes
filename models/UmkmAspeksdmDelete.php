 ...
 * Page class
 */
class UmkmAspeksdmDelete extends UmkmAspeksdm
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UmkmAspeksdmDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("umkmaspeksdmlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("umkmaspeksdmlist"); // Return to list
                return;
            }
        }
