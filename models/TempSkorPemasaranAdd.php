 ...
 * Page class
 */
class TempSkorPemasaranAdd extends TempSkorPemasaran
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TempSkorPemasaranAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "tempskorpemasaranview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->skor_unggul->CurrentValue = null;
        $this->skor_unggul->OldValue = $this->skor_unggul->CurrentValue;
        $this->max_unggul->CurrentValue = null;
        $this->max_unggul->OldValue = $this->max_unggul->CurrentValue;
        $this->skor_target->CurrentValue = null;
        $this->skor_target->OldValue = $this->skor_target->CurrentValue;
        $this->max_target->CurrentValue = null;
        $this->max_target->OldValue = $this->max_target->CurrentValue;
        $this->skor_available->CurrentValue = null;
        $this->skor_available->OldValue = $this->skor_available->CurrentValue;
        $this->max_available->CurrentValue = null;
        $this->max_available->OldValue = $this->max_available->CurrentValue;
        $this->skor_merk->CurrentValue = null;
        $this->skor_merk->OldValue = $this->skor_merk->CurrentValue;
        $this->max_merk->CurrentValue = null;
        $this->max_merk->OldValue = $this->max_merk->CurrentValue;
        $this->skor_merkhaki->CurrentValue = null;
        $this->skor_merkhaki->OldValue = $this->skor_merkhaki->CurrentValue;
        $this->max_merkhaki->CurrentValue = null;
        $this->max_merkhaki->OldValue = $this->max_merkhaki->CurrentValue;
        $this->skor_merkkonsep->CurrentValue = null;
        $this->skor_merkkonsep->OldValue = $this->skor_merkkonsep->CurrentValue;
        $this->max_merkkonsep->CurrentValue = null;
        $this->max_merkkonsep->OldValue = $this->max_merkkonsep->CurrentValue;
        $this->skor_merklisensi->CurrentValue = null;
        $this->skor_merklisensi->OldValue = $this->skor_merklisensi->CurrentValue;
        $this->max_merklisensi->CurrentValue = null;
        $this->max_merklisensi->OldValue = $this->max_merklisensi->CurrentValue;
        $this->skor_mitra->CurrentValue = null;
        $this->skor_mitra->OldValue = $this->skor_mitra->CurrentValue;
        $this->max_mitra->CurrentValue = null;
        $this->max_mitra->OldValue = $this->max_mitra->CurrentValue;
        $this->skor_market->CurrentValue = null;
        $this->skor_market->OldValue = $this->skor_market->CurrentValue;
        $this->max_market->CurrentValue = null;
        $this->max_market->OldValue = $this->max_market->CurrentValue;
        $this->skor_pelangganloyal->CurrentValue = null;
        $this->skor_pelangganloyal->OldValue = $this->skor_pelangganloyal->CurrentValue;
        $this->max_pelangganloyal->CurrentValue = null;
        $this->max_pelangganloyal->OldValue = $this->max_pelangganloyal->CurrentValue;
        $this->skor_pameranmandiri->CurrentValue = null;
        $this->skor_pameranmandiri->OldValue = $this->skor_pameranmandiri->CurrentValue;
        $this->max_pameranmandiri->CurrentValue = null;
        $this->max_pameranmandiri->OldValue = $this->max_pameranmandiri->CurrentValue;
        $this->skor_mediaoffline->CurrentValue = null;
        $this->skor_mediaoffline->OldValue = $this->skor_mediaoffline->CurrentValue;
        $this->max_mediaoffline->CurrentValue = null;
        $this->max_mediaoffline->OldValue = $this->max_mediaoffline->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['skor_unggul'] = $this->skor_unggul->CurrentValue;
        $row['max_unggul'] = $this->max_unggul->CurrentValue;
        $row['skor_target'] = $this->skor_target->CurrentValue;
        $row['max_target'] = $this->max_target->CurrentValue;
        $row['skor_available'] = $this->skor_available->CurrentValue;
        $row['max_available'] = $this->max_available->CurrentValue;
        $row['skor_merk'] = $this->skor_merk->CurrentValue;
        $row['max_merk'] = $this->max_merk->CurrentValue;
        $row['skor_merkhaki'] = $this->skor_merkhaki->CurrentValue;
        $row['max_merkhaki'] = $this->max_merkhaki->CurrentValue;
        $row['skor_merkkonsep'] = $this->skor_merkkonsep->CurrentValue;
        $row['max_merkkonsep'] = $this->max_merkkonsep->CurrentValue;
        $row['skor_merklisensi'] = $this->skor_merklisensi->CurrentValue;
        $row['max_merklisensi'] = $this->max_merklisensi->CurrentValue;
        $row['skor_mitra'] = $this->skor_mitra->CurrentValue;
        $row['max_mitra'] = $this->max_mitra->CurrentValue;
        $row['skor_market'] = $this->skor_market->CurrentValue;
        $row['max_market'] = $this->max_market->CurrentValue;
        $row['skor_pelangganloyal'] = $this->skor_pelangganloyal->CurrentValue;
        $row['max_pelangganloyal'] = $this->max_pelangganloyal->CurrentValue;
        $row['skor_pameranmandiri'] = $this->skor_pameranmandiri->CurrentValue;
        $row['max_pameranmandiri'] = $this->max_pameranmandiri->CurrentValue;
        $row['skor_mediaoffline'] = $this->skor_mediaoffline->CurrentValue;
        $row['max_mediaoffline'] = $this->max_mediaoffline->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // skor_unggul
        $this->skor_unggul->setDbValueDef($rsnew, $this->skor_unggul->CurrentValue, null, false);

        // max_unggul
        $this->max_unggul->setDbValueDef($rsnew, $this->max_unggul->CurrentValue, null, false);

        // skor_target
        $this->skor_target->setDbValueDef($rsnew, $this->skor_target->CurrentValue, null, false);

        // max_target
        $this->max_target->setDbValueDef($rsnew, $this->max_target->CurrentValue, null, false);

        // skor_available
        $this->skor_available->setDbValueDef($rsnew, $this->skor_available->CurrentValue, null, false);

        // max_available
        $this->max_available->setDbValueDef($rsnew, $this->max_available->CurrentValue, null, false);

        // skor_merk
        $this->skor_merk->setDbValueDef($rsnew, $this->skor_merk->CurrentValue, null, false);

        // max_merk
        $this->max_merk->setDbValueDef($rsnew, $this->max_merk->CurrentValue, null, false);

        // skor_merkhaki
        $this->skor_merkhaki->setDbValueDef($rsnew, $this->skor_merkhaki->CurrentValue, null, false);

        // max_merkhaki
        $this->max_merkhaki->setDbValueDef($rsnew, $this->max_merkhaki->CurrentValue, null, false);

        // skor_merkkonsep
        $this->skor_merkkonsep->setDbValueDef($rsnew, $this->skor_merkkonsep->CurrentValue, null, false);

        // max_merkkonsep
        $this->max_merkkonsep->setDbValueDef($rsnew, $this->max_merkkonsep->CurrentValue, null, false);

        // skor_merklisensi
        $this->skor_merklisensi->setDbValueDef($rsnew, $this->skor_merklisensi->CurrentValue, null, false);

        // max_merklisensi
        $this->max_merklisensi->setDbValueDef($rsnew, $this->max_merklisensi->CurrentValue, null, false);

        // skor_mitra
        $this->skor_mitra->setDbValueDef($rsnew, $this->skor_mitra->CurrentValue, null, false);

        // max_mitra
        $this->max_mitra->setDbValueDef($rsnew, $this->max_mitra->CurrentValue, null, false);

        // skor_market
        $this->skor_market->setDbValueDef($rsnew, $this->skor_market->CurrentValue, null, false);

        // max_market
        $this->max_market->setDbValueDef($rsnew, $this->max_market->CurrentValue, null, false);

        // skor_pelangganloyal
        $this->skor_pelangganloyal->setDbValueDef($rsnew, $this->skor_pelangganloyal->CurrentValue, null, false);

        // max_pelangganloyal
        $this->max_pelangganloyal->setDbValueDef($rsnew, $this->max_pelangganloyal->CurrentValue, null, false);

        // skor_pameranmandiri
        $this->skor_pameranmandiri->setDbValueDef($rsnew, $this->skor_pameranmandiri->CurrentValue, null, false);

        // max_pameranmandiri
        $this->max_pameranmandiri->setDbValueDef($rsnew, $this->max_pameranmandiri->CurrentValue, null, false);

        // skor_mediaoffline
        $this->skor_mediaoffline->setDbValueDef($rsnew, $this->skor_mediaoffline->CurrentValue, null, false);

        // max_mediaoffline
        $this->max_mediaoffline->setDbValueDef($rsnew, $this->max_mediaoffline->CurrentValue, null, false);
