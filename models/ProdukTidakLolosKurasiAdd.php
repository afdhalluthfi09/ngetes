 ...
 * Page class
 */
class ProdukTidakLolosKurasiAdd extends ProdukTidakLolosKurasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProdukTidakLolosKurasiAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("produktidakloloskurasilist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "produktidakloloskurasilist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "produktidakloloskurasiview") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("produktidakloloskurasilist"), "", $this->TableVar, true);
