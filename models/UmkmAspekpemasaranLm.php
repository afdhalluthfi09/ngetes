...
/**
 * Table class for umkm_aspekpemasaran_lm
 */
class UmkmAspekpemasaranLm extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'umkm_aspekpemasaran_lm';
        $this->TableName = 'umkm_aspekpemasaran_lm';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`umkm_aspekpemasaran_lm`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // NIK
        $this->NIK = new DbField('umkm_aspekpemasaran_lm', 'umkm_aspekpemasaran_lm', 'x_NIK', 'NIK', '`NIK`', '`NIK`', 200, 16, -1, false, '`NIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MK_KEUNGGULANPRODUK
        $this->MK_KEUNGGULANPRODUK = new DbField('umkm_aspekpemasaran_lm', 'umkm_aspekpemasaran_lm', 'x_MK_KEUNGGULANPRODUK', 'MK_KEUNGGULANPRODUK', '`MK_KEUNGGULANPRODUK`', '`MK_KEUNGGULANPRODUK`', 200, 50, -1, false, '`MK_KEUNGGULANPRODUK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MK_TARGETPASAR
        $this->MK_TARGETPASAR = new DbField('umkm_aspekpemasaran_lm', 'umkm_aspekpemasaran_lm', 'x_MK_TARGETPASAR', 'MK_TARGETPASAR', '`MK_TARGETPASAR`', '`MK_TARGETPASAR`', 200, 50, -1, false, '`MK_TARGETPASAR`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MK_KETERSEDIAAN
        $this->MK_KETERSEDIAAN = new DbField('umkm_aspekpemasaran_lm', 'umkm_aspekpemasaran_lm', 'x_MK_KETERSEDIAAN', 'MK_KETERSEDIAAN', '`MK_KETERSEDIAAN`', '`MK_KETERSEDIAAN`', 200, 50, -1, false, '`MK_KETERSEDIAAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MK_LOGO
        $this->MK_LOGO = new DbField('umkm_aspekpemasaran_lm', 'umkm_aspekpemasaran_lm', 'x_MK_LOGO', 'MK_LOGO', '`MK_LOGO`', '`MK_LOGO`', 200, 50, -1, false, '`MK_LOGO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MK_HKI
        $this->MK_HKI = new DbField('umkm_aspekpemasaran_lm', 'umkm_aspekpemasaran_lm', 'x_MK_HKI', 'MK_HKI', '`MK_HKI`', '`MK_HKI`', 200, 50, -1, false, '`MK_HKI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MK_BRANDING
        $this->MK_BRANDING = new DbField('umkm_aspekpemasaran_lm', 'umkm_aspekpemasaran_lm', 'x_MK_BRANDING', 'MK_BRANDING', '`MK_BRANDING`', '`MK_BRANDING`', 200, 50, -1, false, '`MK_BRANDING`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MK_COBRANDING
        $this->MK_COBRANDING = new DbField('umkm_aspekpemasaran_lm', 'umkm_aspekpemasaran_lm', 'x_MK_COBRANDING', 'MK_COBRANDING', '`MK_COBRANDING`', '`MK_COBRANDING`', 200, 50, -1, false, '`MK_COBRANDING`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MK_MEDIAOFFLINE
        $this->MK_MEDIAOFFLINE = new DbField('umkm_aspekpemasaran_lm', 'umkm_aspekpemasaran_lm', 'x_MK_MEDIAOFFLINE', 'MK_MEDIAOFFLINE', '`MK_MEDIAOFFLINE`', '`MK_MEDIAOFFLINE`', 200, 50, -1, false, '`MK_MEDIAOFFLINE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MK_RESELLER
        $this->MK_RESELLER = new DbField('umkm_aspekpemasaran_lm', 'umkm_aspekpemasaran_lm', 'x_MK_RESELLER', 'MK_RESELLER', '`MK_RESELLER`', '`MK_RESELLER`', 200, 50, -1, false, '`MK_RESELLER`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MK_PASAR
        $this->MK_PASAR = new DbField('umkm_aspekpemasaran_lm', 'umkm_aspekpemasaran_lm', 'x_MK_PASAR', 'MK_PASAR', '`MK_PASAR`', '`MK_PASAR`', 200, 50, -1, false, '`MK_PASAR`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MK_PELANGGAN
        $this->MK_PELANGGAN = new DbField('umkm_aspekpemasaran_lm', 'umkm_aspekpemasaran_lm', 'x_MK_PELANGGAN', 'MK_PELANGGAN', '`MK_PELANGGAN`', '`MK_PELANGGAN`', 200, 50, -1, false, '`MK_PELANGGAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MK_PAMERANMANDIRI
        $this->MK_PAMERANMANDIRI = new DbField('umkm_aspekpemasaran_lm', 'umkm_aspekpemasaran_lm', 'x_MK_PAMERANMANDIRI', 'MK_PAMERANMANDIRI', '`MK_PAMERANMANDIRI`', '`MK_PAMERANMANDIRI`', 200, 50, -1, false, '`MK_PAMERANMANDIRI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`umkm_aspekpemasaran_lm`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("umkmaspekpemasaranlmlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "umkmaspekpemasaranlmedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "umkmaspekpemasaranlmadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "UmkmAspekpemasaranLmView";
            case Config("API_ADD_ACTION"):
                return "UmkmAspekpemasaranLmAdd";
            case Config("API_EDIT_ACTION"):
                return "UmkmAspekpemasaranLmEdit";
            case Config("API_DELETE_ACTION"):
                return "UmkmAspekpemasaranLmDelete";
            case Config("API_LIST_ACTION"):
                return "UmkmAspekpemasaranLmList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("umkmaspekpemasaranlmview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("umkmaspekpemasaranlmview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "umkmaspekpemasaranlmadd?" . $this->getUrlParm($parm);
        } else {
            $url = "umkmaspekpemasaranlmadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmaspekpemasaranlmedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmaspekpemasaranlmadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("umkmaspekpemasaranlmdelete", $this->getUrlParm());
    }
