...
/**
 * Table class for cetak_aspek_produksi
 */
class CetakAspekProduksi extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'cetak_aspek_produksi';
        $this->TableName = 'cetak_aspek_produksi';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`cetak_aspek_produksi`";
        $this->Dbid = 'DB';
        ...
        // NIK
        $this->NIK = new DbField('cetak_aspek_produksi', 'cetak_aspek_produksi', 'x_NIK', 'NIK', '`NIK`', '`NIK`', 200, 16, -1, false, '`NIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->PROD_FREKUENSIPRODUKSI = new DbField('cetak_aspek_produksi', 'cetak_aspek_produksi', 'x_PROD_FREKUENSIPRODUKSI', 'PROD_FREKUENSIPRODUKSI', '`PROD_FREKUENSIPRODUKSI`', '`PROD_FREKUENSIPRODUKSI`', 200, 50, -1, false, '`PROD_FREKUENSIPRODUKSI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PROD_KAPASITAS
        $this->PROD_KAPASITAS = new DbField('cetak_aspek_produksi', 'cetak_aspek_produksi', 'x_PROD_KAPASITAS', 'PROD_KAPASITAS', '`PROD_KAPASITAS`', '`PROD_KAPASITAS`', 200, 50, -1, false, '`PROD_KAPASITAS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PROD_KEAMANANPANGAN
        $this->PROD_KEAMANANPANGAN = new DbField('cetak_aspek_produksi', 'cetak_aspek_produksi', 'x_PROD_KEAMANANPANGAN', 'PROD_KEAMANANPANGAN', '`PROD_KEAMANANPANGAN`', '`PROD_KEAMANANPANGAN`', 200, 50, -1, false, '`PROD_KEAMANANPANGAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PROD_SNI
        $this->PROD_SNI = new DbField('cetak_aspek_produksi', 'cetak_aspek_produksi', 'x_PROD_SNI', 'PROD_SNI', '`PROD_SNI`', '`PROD_SNI`', 200, 50, -1, false, '`PROD_SNI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PROD_KEMASAN
        $this->PROD_KEMASAN = new DbField('cetak_aspek_produksi', 'cetak_aspek_produksi', 'x_PROD_KEMASAN', 'PROD_KEMASAN', '`PROD_KEMASAN`', '`PROD_KEMASAN`', 200, 50, -1, false, '`PROD_KEMASAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->PROD_KETERSEDIAANBAHANBAKU = new DbField('cetak_aspek_produksi', 'cetak_aspek_produksi', 'x_PROD_KETERSEDIAANBAHANBAKU', 'PROD_KETERSEDIAANBAHANBAKU', '`PROD_KETERSEDIAANBAHANBAKU`', '`PROD_KETERSEDIAANBAHANBAKU`', 200, 50, -1, false, '`PROD_KETERSEDIAANBAHANBAKU`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PROD_ALATPRODUKSI
        $this->PROD_ALATPRODUKSI = new DbField('cetak_aspek_produksi', 'cetak_aspek_produksi', 'x_PROD_ALATPRODUKSI', 'PROD_ALATPRODUKSI', '`PROD_ALATPRODUKSI`', '`PROD_ALATPRODUKSI`', 200, 50, -1, false, '`PROD_ALATPRODUKSI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->PROD_GUDANGPENYIMPAN = new DbField('cetak_aspek_produksi', 'cetak_aspek_produksi', 'x_PROD_GUDANGPENYIMPAN', 'PROD_GUDANGPENYIMPAN', '`PROD_GUDANGPENYIMPAN`', '`PROD_GUDANGPENYIMPAN`', 200, 50, -1, false, '`PROD_GUDANGPENYIMPAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PROD_LAYOUTPRODUKSI
        $this->PROD_LAYOUTPRODUKSI = new DbField('cetak_aspek_produksi', 'cetak_aspek_produksi', 'x_PROD_LAYOUTPRODUKSI', 'PROD_LAYOUTPRODUKSI', '`PROD_LAYOUTPRODUKSI`', '`PROD_LAYOUTPRODUKSI`', 200, 50, -1, false, '`PROD_LAYOUTPRODUKSI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PROD_SOP
        $this->PROD_SOP = new DbField('cetak_aspek_produksi', 'cetak_aspek_produksi', 'x_PROD_SOP', 'PROD_SOP', '`PROD_SOP`', '`PROD_SOP`', 200, 50, -1, false, '`PROD_SOP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA_PEMILIK
        $this->NAMA_PEMILIK = new DbField('cetak_aspek_produksi', 'cetak_aspek_produksi', 'x_NAMA_PEMILIK', 'NAMA_PEMILIK', '`NAMA_PEMILIK`', '`NAMA_PEMILIK`', 200, 100, -1, false, '`NAMA_PEMILIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA_USAHA
        $this->NAMA_USAHA = new DbField('cetak_aspek_produksi', 'cetak_aspek_produksi', 'x_NAMA_USAHA', 'NAMA_USAHA', '`NAMA_USAHA`', '`NAMA_USAHA`', 200, 100, -1, false, '`NAMA_USAHA`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`cetak_aspek_produksi`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("cetakaspekproduksilist");
    }
    ...
    {
        global $Language;
        if ($pageName == "cetakaspekproduksiview") {
            return $Language->phrase("View");
        } elseif ($pageName == "cetakaspekproduksiedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "cetakaspekproduksiadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "CetakAspekProduksiView";
            case Config("API_ADD_ACTION"):
                return "CetakAspekProduksiAdd";
            case Config("API_EDIT_ACTION"):
                return "CetakAspekProduksiEdit";
            case Config("API_DELETE_ACTION"):
                return "CetakAspekProduksiDelete";
            case Config("API_LIST_ACTION"):
                return "CetakAspekProduksiList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("cetakaspekproduksiview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("cetakaspekproduksiview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "cetakaspekproduksiadd?" . $this->getUrlParm($parm);
        } else {
            $url = "cetakaspekproduksiadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("cetakaspekproduksiedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("cetakaspekproduksiadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("cetakaspekproduksidelete", $this->getUrlParm());
    }
