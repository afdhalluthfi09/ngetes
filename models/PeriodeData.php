...
/**
 * Table class for periode_data
 */
class PeriodeData extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'periode_data';
        $this->TableName = 'periode_data';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`periode_data`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('periode_data', 'periode_data', 'x_id', 'id', '`id`', '`id`', 2, 6, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // periode_tahun
        $this->periode_tahun = new DbField('periode_data', 'periode_data', 'x_periode_tahun', 'periode_tahun', '`periode_tahun`', '`periode_tahun`', 3, 4, -1, false, '`periode_tahun`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // periode_bulan
        $this->periode_bulan = new DbField('periode_data', 'periode_data', 'x_periode_bulan', 'periode_bulan', '`periode_bulan`', '`periode_bulan`', 200, 30, -1, false, '`periode_bulan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`periode_data`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("periodedatalist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "periodedataedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "periodedataadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PeriodeDataView";
            case Config("API_ADD_ACTION"):
                return "PeriodeDataAdd";
            case Config("API_EDIT_ACTION"):
                return "PeriodeDataEdit";
            case Config("API_DELETE_ACTION"):
                return "PeriodeDataDelete";
            case Config("API_LIST_ACTION"):
                return "PeriodeDataList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("periodedataview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("periodedataview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "periodedataadd?" . $this->getUrlParm($parm);
        } else {
            $url = "periodedataadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("periodedataedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("periodedataadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("periodedatadelete", $this->getUrlParm());
    }
