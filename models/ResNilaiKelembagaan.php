...
/**
 * Table class for res_nilai_kelembagaan
 */
class ResNilaiKelembagaan extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'res_nilai_kelembagaan';
        $this->TableName = 'res_nilai_kelembagaan';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`res_nilai_kelembagaan`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // nik
        $this->nik = new DbField('res_nilai_kelembagaan', 'res_nilai_kelembagaan', 'x_nik', 'nik', '`nik`', '`nik`', 200, 16, -1, false, '`nik`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_badanhukum
        $this->skor_badanhukum = new DbField('res_nilai_kelembagaan', 'res_nilai_kelembagaan', 'x_skor_badanhukum', 'skor_badanhukum', '`skor_badanhukum`', '`skor_badanhukum`', 5, 23, -1, false, '`skor_badanhukum`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_badanhukum
        $this->max_badanhukum = new DbField('res_nilai_kelembagaan', 'res_nilai_kelembagaan', 'x_max_badanhukum', 'max_badanhukum', '`max_badanhukum`', '`max_badanhukum`', 5, 23, -1, false, '`max_badanhukum`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_izin
        $this->skor_izin = new DbField('res_nilai_kelembagaan', 'res_nilai_kelembagaan', 'x_skor_izin', 'skor_izin', '`skor_izin`', '`skor_izin`', 5, 23, -1, false, '`skor_izin`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_izin
        $this->max_izin = new DbField('res_nilai_kelembagaan', 'res_nilai_kelembagaan', 'x_max_izin', 'max_izin', '`max_izin`', '`max_izin`', 5, 23, -1, false, '`max_izin`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_npwp
        $this->skor_npwp = new DbField('res_nilai_kelembagaan', 'res_nilai_kelembagaan', 'x_skor_npwp', 'skor_npwp', '`skor_npwp`', '`skor_npwp`', 5, 23, -1, false, '`skor_npwp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_npwp
        $this->max_npwp = new DbField('res_nilai_kelembagaan', 'res_nilai_kelembagaan', 'x_max_npwp', 'max_npwp', '`max_npwp`', '`max_npwp`', 5, 23, -1, false, '`max_npwp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_struktur
        $this->skor_struktur = new DbField('res_nilai_kelembagaan', 'res_nilai_kelembagaan', 'x_skor_struktur', 'skor_struktur', '`skor_struktur`', '`skor_struktur`', 5, 23, -1, false, '`skor_struktur`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_struktur
        $this->max_struktur = new DbField('res_nilai_kelembagaan', 'res_nilai_kelembagaan', 'x_max_struktur', 'max_struktur', '`max_struktur`', '`max_struktur`', 5, 23, -1, false, '`max_struktur`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_jobdesk
        $this->skor_jobdesk = new DbField('res_nilai_kelembagaan', 'res_nilai_kelembagaan', 'x_skor_jobdesk', 'skor_jobdesk', '`skor_jobdesk`', '`skor_jobdesk`', 5, 23, -1, false, '`skor_jobdesk`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_jobdesk
        $this->max_jobdesk = new DbField('res_nilai_kelembagaan', 'res_nilai_kelembagaan', 'x_max_jobdesk', 'max_jobdesk', '`max_jobdesk`', '`max_jobdesk`', 5, 23, -1, false, '`max_jobdesk`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_iso
        $this->skor_iso = new DbField('res_nilai_kelembagaan', 'res_nilai_kelembagaan', 'x_skor_iso', 'skor_iso', '`skor_iso`', '`skor_iso`', 5, 23, -1, false, '`skor_iso`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_iso
        $this->max_iso = new DbField('res_nilai_kelembagaan', 'res_nilai_kelembagaan', 'x_max_iso', 'max_iso', '`max_iso`', '`max_iso`', 5, 23, -1, false, '`max_iso`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`res_nilai_kelembagaan`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("resnilaikelembagaanlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "resnilaikelembagaanview") {
            return $Language->phrase("View");
        } elseif ($pageName == "resnilaikelembagaanedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "resnilaikelembagaanadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ResNilaiKelembagaanView";
            case Config("API_ADD_ACTION"):
                return "ResNilaiKelembagaanAdd";
            case Config("API_EDIT_ACTION"):
                return "ResNilaiKelembagaanEdit";
            case Config("API_DELETE_ACTION"):
                return "ResNilaiKelembagaanDelete";
            case Config("API_LIST_ACTION"):
                return "ResNilaiKelembagaanList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("resnilaikelembagaanview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("resnilaikelembagaanview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "resnilaikelembagaanadd?" . $this->getUrlParm($parm);
        } else {
            $url = "resnilaikelembagaanadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("resnilaikelembagaanedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("resnilaikelembagaanadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("resnilaikelembagaandelete", $this->getUrlParm());
    }
