 ...
 * Page class
 */
class ChangePassword extends UmkmDatadiri
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->OldPassword = new DbField("umkm_datadiri", "umkm_datadiri", "opwd", "opwd", "opwd", "", 202, 255, 0, false, "", false, false, false);
        $this->OldPassword->EditAttrs->appendClass("form-control ew-control");
        $this->NewPassword = new DbField("umkm_datadiri", "umkm_datadiri", "npwd", "npwd", "npwd", "", 202, 255, 0, false, "", false, false, false);
        ...
        $this->ConfirmPassword = new DbField("umkm_datadiri", "umkm_datadiri", "cpwd", "cpwd", "cpwd", "", 202, 255, 0, false, "", false, false, false);
