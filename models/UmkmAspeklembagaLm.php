...
/**
 * Table class for umkm_aspeklembaga_lm
 */
class UmkmAspeklembagaLm extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'umkm_aspeklembaga_lm';
        $this->TableName = 'umkm_aspeklembaga_lm';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`umkm_aspeklembaga_lm`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // NIK
        $this->NIK = new DbField('umkm_aspeklembaga_lm', 'umkm_aspeklembaga_lm', 'x_NIK', 'NIK', '`NIK`', '`NIK`', 200, 16, -1, false, '`NIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LB_BADANHUKUM
        $this->LB_BADANHUKUM = new DbField('umkm_aspeklembaga_lm', 'umkm_aspeklembaga_lm', 'x_LB_BADANHUKUM', 'LB_BADANHUKUM', '`LB_BADANHUKUM`', '`LB_BADANHUKUM`', 200, 50, -1, false, '`LB_BADANHUKUM`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LB_IZINUSAHA
        $this->LB_IZINUSAHA = new DbField('umkm_aspeklembaga_lm', 'umkm_aspeklembaga_lm', 'x_LB_IZINUSAHA', 'LB_IZINUSAHA', '`LB_IZINUSAHA`', '`LB_IZINUSAHA`', 200, 50, -1, false, '`LB_IZINUSAHA`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LB_NPWP
        $this->LB_NPWP = new DbField('umkm_aspeklembaga_lm', 'umkm_aspeklembaga_lm', 'x_LB_NPWP', 'LB_NPWP', '`LB_NPWP`', '`LB_NPWP`', 200, 50, -1, false, '`LB_NPWP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LB_SO
        $this->LB_SO = new DbField('umkm_aspeklembaga_lm', 'umkm_aspeklembaga_lm', 'x_LB_SO', 'LB_SO', '`LB_SO`', '`LB_SO`', 200, 50, -1, false, '`LB_SO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LB_JD
        $this->LB_JD = new DbField('umkm_aspeklembaga_lm', 'umkm_aspeklembaga_lm', 'x_LB_JD', 'LB_JD', '`LB_JD`', '`LB_JD`', 200, 50, -1, false, '`LB_JD`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LB_ISO
        $this->LB_ISO = new DbField('umkm_aspeklembaga_lm', 'umkm_aspeklembaga_lm', 'x_LB_ISO', 'LB_ISO', '`LB_ISO`', '`LB_ISO`', 200, 50, -1, false, '`LB_ISO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`umkm_aspeklembaga_lm`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("umkmaspeklembagalmlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "umkmaspeklembagalmview") {
            return $Language->phrase("View");
        } elseif ($pageName == "umkmaspeklembagalmedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "umkmaspeklembagalmadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "UmkmAspeklembagaLmView";
            case Config("API_ADD_ACTION"):
                return "UmkmAspeklembagaLmAdd";
            case Config("API_EDIT_ACTION"):
                return "UmkmAspeklembagaLmEdit";
            case Config("API_DELETE_ACTION"):
                return "UmkmAspeklembagaLmDelete";
            case Config("API_LIST_ACTION"):
                return "UmkmAspeklembagaLmList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("umkmaspeklembagalmview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("umkmaspeklembagalmview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "umkmaspeklembagalmadd?" . $this->getUrlParm($parm);
        } else {
            $url = "umkmaspeklembagalmadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmaspeklembagalmedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmaspeklembagalmadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("umkmaspeklembagalmdelete", $this->getUrlParm());
    }
