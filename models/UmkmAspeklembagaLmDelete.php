 ...
 * Page class
 */
class UmkmAspeklembagaLmDelete extends UmkmAspeklembagaLm
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UmkmAspeklembagaLmDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("umkmaspeklembagalmlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("umkmaspeklembagalmlist"); // Return to list
                return;
            }
        }
