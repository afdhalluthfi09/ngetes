 ...
 * Page class
 */
class Login extends UmkmDatadiri
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->Username = new DbField("umkm_datadiri", "umkm_datadiri", "username", "username", "username", "", 202, 255, 0, false, "", false, false, false);
        $this->Username->EditAttrs->appendClass("form-control ew-control");
        $this->Password = new DbField("umkm_datadiri", "umkm_datadiri", "password", "password", "password", "", 202, 255, 0, false, "", false, false, false);
        $this->Password->EditAttrs->appendClass("form-control ew-control");
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->Password->Raw = true;
        }
        $this->LoginType = new DbField("umkm_datadiri", "umkm_datadiri", "type", "logintype", "logintype", "", 202, 255, 0, false, "", false, false, false);
