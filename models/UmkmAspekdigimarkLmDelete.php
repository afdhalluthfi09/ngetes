 ...
 * Page class
 */
class UmkmAspekdigimarkLmDelete extends UmkmAspekdigimarkLm
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UmkmAspekdigimarkLmDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("umkmaspekdigimarklmlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("umkmaspekdigimarklmlist"); // Return to list
                return;
            }
        }
