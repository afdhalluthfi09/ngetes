 ...
 * Page class
 */
class VUmkmDatadiriList extends VUmkmDatadiri
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VUmkmDatadiriList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fv_umkm_datadirilist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "vumkmdatadiriadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "vumkmdatadiridelete";
        $this->MultiUpdateUrl = "vumkmdatadiriupdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fv_umkm_datadirilistsrch";
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->IDSIDAKUI, $ctrl); // IDSIDAKUI
            $this->updateSort($this->NoKTP, $ctrl); // NoKTP
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fv_umkm_datadirilistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fv_umkm_datadirilistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fv_umkm_datadirilist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
