 ...
 * Page class
 */
class UmkmAspekkeuanganLmAdd extends UmkmAspekkeuanganLm
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UmkmAspekkeuanganLmAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("umkmaspekkeuanganlmlist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "umkmaspekkeuanganlmlist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "umkmaspekkeuanganlmview") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->KEU_USAHAUTAMA->EditValue = HtmlEncode($this->KEU_USAHAUTAMA->CurrentValue);
            ...
            $this->KEU_PENGELOLAAN->EditValue = HtmlEncode($this->KEU_PENGELOLAAN->CurrentValue);
            ...
            $this->KEU_NOTA->EditValue = HtmlEncode($this->KEU_NOTA->CurrentValue);
            ...
            $this->KEU_PENCATATAN->EditValue = HtmlEncode($this->KEU_PENCATATAN->CurrentValue);
            ...
            $this->KEU_LAPORAN->EditValue = HtmlEncode($this->KEU_LAPORAN->CurrentValue);
            ...
            $this->KEU_UTANGMODAL->EditValue = HtmlEncode($this->KEU_UTANGMODAL->CurrentValue);
            ...
            $this->KEU_CATATNASET->EditValue = HtmlEncode($this->KEU_CATATNASET->CurrentValue);
            ...
            $this->KEU_NONTUNAI->EditValue = HtmlEncode($this->KEU_NONTUNAI->CurrentValue);
