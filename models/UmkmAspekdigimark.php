...
/**
 * Table class for umkm_aspekdigimark
 */
class UmkmAspekdigimark extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'umkm_aspekdigimark';
        $this->TableName = 'umkm_aspekdigimark';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`umkm_aspekdigimark`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // NIK
        $this->NIK = new DbField('umkm_aspekdigimark', 'umkm_aspekdigimark', 'x_NIK', 'NIK', '`NIK`', '`NIK`', 200, 16, -1, false, '`NIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DM_CHATTING
        $this->DM_CHATTING = new DbField('umkm_aspekdigimark', 'umkm_aspekdigimark', 'x_DM_CHATTING', 'DM_CHATTING', '`DM_CHATTING`', '`DM_CHATTING`', 200, 50, -1, false, '`DM_CHATTING`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->DM_CHATTING->Sortable = true; // Allow sort
        $this->DM_CHATTING->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->DM_CHATTING->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->DM_CHATTING->Lookup = new Lookup('DM_CHATTING', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        ...
        // DM_MEDSOS
        $this->DM_MEDSOS = new DbField('umkm_aspekdigimark', 'umkm_aspekdigimark', 'x_DM_MEDSOS', 'DM_MEDSOS', '`DM_MEDSOS`', '`DM_MEDSOS`', 200, 50, -1, false, '`DM_MEDSOS`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->DM_MEDSOS->Sortable = true; // Allow sort
        $this->DM_MEDSOS->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->DM_MEDSOS->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->DM_MEDSOS->Lookup = new Lookup('DM_MEDSOS', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        ...
        // DM_MP
        $this->DM_MP = new DbField('umkm_aspekdigimark', 'umkm_aspekdigimark', 'x_DM_MP', 'DM_MP', '`DM_MP`', '`DM_MP`', 200, 50, -1, false, '`DM_MP`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->DM_MP->Sortable = true; // Allow sort
        $this->DM_MP->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->DM_MP->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->DM_MP->Lookup = new Lookup('DM_MP', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        $this->DM_MP->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DM_MP->Param, "CustomMsg");
        $this->Fields['DM_MP'] = &$this->DM_MP;

        // DM_GMB
        $this->DM_GMB = new DbField('umkm_aspekdigimark', 'umkm_aspekdigimark', 'x_DM_GMB', 'DM_GMB', '`DM_GMB`', '`DM_GMB`', 200, 50, -1, false, '`DM_GMB`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->DM_GMB->Sortable = true; // Allow sort
        $this->DM_GMB->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->DM_GMB->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->DM_GMB->Lookup = new Lookup('DM_GMB', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        $this->DM_GMB->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DM_GMB->Param, "CustomMsg");
        $this->Fields['DM_GMB'] = &$this->DM_GMB;

        // DM_WEB
        $this->DM_WEB = new DbField('umkm_aspekdigimark', 'umkm_aspekdigimark', 'x_DM_WEB', 'DM_WEB', '`DM_WEB`', '`DM_WEB`', 200, 50, -1, false, '`DM_WEB`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->DM_WEB->Sortable = true; // Allow sort
        $this->DM_WEB->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->DM_WEB->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->DM_WEB->Lookup = new Lookup('DM_WEB', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        $this->DM_WEB->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DM_WEB->Param, "CustomMsg");
        $this->Fields['DM_WEB'] = &$this->DM_WEB;

        // DM_UPDATEMEDSOS
        $this->DM_UPDATEMEDSOS = new DbField('umkm_aspekdigimark', 'umkm_aspekdigimark', 'x_DM_UPDATEMEDSOS', 'DM_UPDATEMEDSOS', '`DM_UPDATEMEDSOS`', '`DM_UPDATEMEDSOS`', 200, 50, -1, false, '`DM_UPDATEMEDSOS`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->DM_UPDATEMEDSOS->Sortable = true; // Allow sort
        $this->DM_UPDATEMEDSOS->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->DM_UPDATEMEDSOS->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->DM_UPDATEMEDSOS->Lookup = new Lookup('DM_UPDATEMEDSOS', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        ...
        // DM_UPDATEWEBSITE
        $this->DM_UPDATEWEBSITE = new DbField('umkm_aspekdigimark', 'umkm_aspekdigimark', 'x_DM_UPDATEWEBSITE', 'DM_UPDATEWEBSITE', '`DM_UPDATEWEBSITE`', '`DM_UPDATEWEBSITE`', 200, 50, -1, false, '`DM_UPDATEWEBSITE`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->DM_UPDATEWEBSITE->Sortable = true; // Allow sort
        $this->DM_UPDATEWEBSITE->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->DM_UPDATEWEBSITE->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->DM_UPDATEWEBSITE->Lookup = new Lookup('DM_UPDATEWEBSITE', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        ...
        // DM_GOOGLEINDEX
        $this->DM_GOOGLEINDEX = new DbField('umkm_aspekdigimark', 'umkm_aspekdigimark', 'x_DM_GOOGLEINDEX', 'DM_GOOGLEINDEX', '`DM_GOOGLEINDEX`', '`DM_GOOGLEINDEX`', 200, 50, -1, false, '`DM_GOOGLEINDEX`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->DM_GOOGLEINDEX->Sortable = true; // Allow sort
        $this->DM_GOOGLEINDEX->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->DM_GOOGLEINDEX->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->DM_GOOGLEINDEX->Lookup = new Lookup('DM_GOOGLEINDEX', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        ...
        // DM_IKLANBERBAYAR
        $this->DM_IKLANBERBAYAR = new DbField('umkm_aspekdigimark', 'umkm_aspekdigimark', 'x_DM_IKLANBERBAYAR', 'DM_IKLANBERBAYAR', '`DM_IKLANBERBAYAR`', '`DM_IKLANBERBAYAR`', 200, 50, -1, false, '`DM_IKLANBERBAYAR`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->DM_IKLANBERBAYAR->Sortable = true; // Allow sort
        $this->DM_IKLANBERBAYAR->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->DM_IKLANBERBAYAR->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->DM_IKLANBERBAYAR->Lookup = new Lookup('DM_IKLANBERBAYAR', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`umkm_aspekdigimark`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("umkmaspekdigimarklist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "umkmaspekdigimarkedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "umkmaspekdigimarkadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "UmkmAspekdigimarkView";
            case Config("API_ADD_ACTION"):
                return "UmkmAspekdigimarkAdd";
            case Config("API_EDIT_ACTION"):
                return "UmkmAspekdigimarkEdit";
            case Config("API_DELETE_ACTION"):
                return "UmkmAspekdigimarkDelete";
            case Config("API_LIST_ACTION"):
                return "UmkmAspekdigimarkList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("umkmaspekdigimarkview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("umkmaspekdigimarkview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "umkmaspekdigimarkadd?" . $this->getUrlParm($parm);
        } else {
            $url = "umkmaspekdigimarkadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmaspekdigimarkedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmaspekdigimarkadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("umkmaspekdigimarkdelete", $this->getUrlParm());
    }
