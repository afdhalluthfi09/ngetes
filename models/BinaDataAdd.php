 ...
 * Page class
 */
class BinaDataAdd extends BinaData
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BinaDataAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "binadataview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->idperiode->CurrentValue = 1;
        $this->idkelompok->CurrentValue = null;
        $this->idkelompok->OldValue = $this->idkelompok->CurrentValue;
        ...
        $this->tglakhir->CurrentValue = null;
        $this->tglakhir->OldValue = $this->tglakhir->CurrentValue;
        $this->narasumber->CurrentValue = null;
        $this->narasumber->OldValue = $this->narasumber->CurrentValue;
        $this->kontak_nama->CurrentValue = null;
        $this->kontak_nama->OldValue = $this->kontak_nama->CurrentValue;
        $this->kontak_hp->CurrentValue = null;
        $this->kontak_hp->OldValue = $this->kontak_hp->CurrentValue;
        $this->poster->CurrentValue = null;
        $this->poster->OldValue = $this->poster->CurrentValue;
        $this->postertipe->CurrentValue = null;
        $this->postertipe->OldValue = $this->postertipe->CurrentValue;
        $this->posterukuran->CurrentValue = null;
        $this->posterukuran->OldValue = $this->posterukuran->CurrentValue;
        $this->posterlebar->CurrentValue = null;
        $this->posterlebar->OldValue = $this->posterlebar->CurrentValue;
        $this->postertinggi->CurrentValue = null;
        $this->postertinggi->OldValue = $this->postertinggi->CurrentValue;
        $this->linkinfo->CurrentValue = null;
        $this->linkinfo->OldValue = $this->linkinfo->CurrentValue;
        $this->peserta_kelas->CurrentValue = null;
        $this->peserta_kelas->OldValue = $this->peserta_kelas->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['idperiode'] = $this->idperiode->CurrentValue;
        $row['idkelompok'] = $this->idkelompok->CurrentValue;
        $row['namakegiatan'] = $this->namakegiatan->CurrentValue;
        $row['uraian'] = $this->uraian->CurrentValue;
        $row['tglmulai'] = $this->tglmulai->CurrentValue;
        $row['tglakhir'] = $this->tglakhir->CurrentValue;
        $row['narasumber'] = $this->narasumber->CurrentValue;
        $row['kontak_nama'] = $this->kontak_nama->CurrentValue;
        $row['kontak_hp'] = $this->kontak_hp->CurrentValue;
        $row['poster'] = $this->poster->CurrentValue;
        $row['postertipe'] = $this->postertipe->CurrentValue;
        $row['posterukuran'] = $this->posterukuran->CurrentValue;
        $row['posterlebar'] = $this->posterlebar->CurrentValue;
        $row['postertinggi'] = $this->postertinggi->CurrentValue;
        $row['linkinfo'] = $this->linkinfo->CurrentValue;
        $row['peserta_kelas'] = $this->peserta_kelas->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // idperiode
        $this->idperiode->setDbValueDef($rsnew, $this->idperiode->CurrentValue, 0, strval($this->idperiode->CurrentValue) == "");

        // idkelompok
        $this->idkelompok->setDbValueDef($rsnew, $this->idkelompok->CurrentValue, null, false);
        ...
        // tglmulai
        $this->tglmulai->setDbValueDef($rsnew, UnFormatDateTime($this->tglmulai->CurrentValue, 0), null, false);

        // tglakhir
        $this->tglakhir->setDbValueDef($rsnew, UnFormatDateTime($this->tglakhir->CurrentValue, 0), null, false);

        // narasumber
        $this->narasumber->setDbValueDef($rsnew, $this->narasumber->CurrentValue, null, false);

        // kontak_nama
        $this->kontak_nama->setDbValueDef($rsnew, $this->kontak_nama->CurrentValue, null, false);

        // kontak_hp
        $this->kontak_hp->setDbValueDef($rsnew, $this->kontak_hp->CurrentValue, null, false);

        // poster
        $this->poster->setDbValueDef($rsnew, $this->poster->CurrentValue, null, false);

        // postertipe
        $this->postertipe->setDbValueDef($rsnew, $this->postertipe->CurrentValue, null, false);

        // posterukuran
        $this->posterukuran->setDbValueDef($rsnew, $this->posterukuran->CurrentValue, null, false);

        // posterlebar
        $this->posterlebar->setDbValueDef($rsnew, $this->posterlebar->CurrentValue, null, false);

        // postertinggi
        $this->postertinggi->setDbValueDef($rsnew, $this->postertinggi->CurrentValue, null, false);

        // linkinfo
        $this->linkinfo->setDbValueDef($rsnew, $this->linkinfo->CurrentValue, null, false);

        // peserta_kelas
        $this->peserta_kelas->setDbValueDef($rsnew, $this->peserta_kelas->CurrentValue, null, false);

        // waktu
        $this->waktu->setDbValueDef($rsnew, UnFormatDateTime($this->waktu->CurrentValue, 0), null, false);
