 ...
 * Page class
 */
class UmkmAspekkeuanganLmDelete extends UmkmAspekkeuanganLm
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UmkmAspekkeuanganLmDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("umkmaspekkeuanganlmlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("umkmaspekkeuanganlmlist"); // Return to list
                return;
            }
        }
