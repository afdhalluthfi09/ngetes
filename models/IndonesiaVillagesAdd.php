 ...
 * Page class
 */
class IndonesiaVillagesAdd extends IndonesiaVillages
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IndonesiaVillagesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("indonesiavillageslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "indonesiavillageslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "indonesiavillagesview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->meta->CurrentValue = null;
        $this->meta->OldValue = $this->meta->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['meta'] = $this->meta->CurrentValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->district_id->EditValue = HtmlEncode($this->district_id->CurrentValue);
            ...
            $this->meta->EditValue = HtmlEncode($this->meta->CurrentValue);
    ...
    protected function addRow($rsold = null)
    {
        ...
        // district_id
        $this->district_id->setDbValueDef($rsnew, $this->district_id->CurrentValue, "", false);

        // name
        $this->name->setDbValueDef($rsnew, $this->name->CurrentValue, "", false);

        // meta
        $this->meta->setDbValueDef($rsnew, $this->meta->CurrentValue, null, false);
