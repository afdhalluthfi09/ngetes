...
/**
 * Table class for v_umkm_datadiri
 */
class VUmkmDatadiri extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_umkm_datadiri';
        $this->TableName = 'v_umkm_datadiri';
        $this->TableType = 'CUSTOMVIEW';

        // Update Table
        $this->UpdateTable = "umkm_datadiri a";
        $this->Dbid = 'DB';
        ...
        // NIK
        $this->NIK = new DbField('v_umkm_datadiri', 'v_umkm_datadiri', 'x_NIK', 'NIK', '`NIK`', '`NIK`', 200, 16, -1, false, '`NIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IDSIDAKUI
        $this->IDSIDAKUI = new DbField('v_umkm_datadiri', 'v_umkm_datadiri', 'x_IDSIDAKUI', 'IDSIDAKUI', 'a.NIK', 'a.NIK', 200, 16, -1, false, 'a.NIK', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->IDSIDAKUI->Nullable = false; // NOT NULL field
        $this->IDSIDAKUI->Required = true; // Required field
        $this->IDSIDAKUI->Sortable = true; // Allow sort
        $this->IDSIDAKUI->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->IDSIDAKUI->Param, "CustomMsg");
        $this->Fields['IDSIDAKUI'] = &$this->IDSIDAKUI;

        // NoKTP
        $this->NoKTP = new DbField('v_umkm_datadiri', 'v_umkm_datadiri', 'x_NoKTP', 'NoKTP', 'a.NIK', 'a.NIK', 200, 16, -1, false, 'a.NIK', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->NoKTP->Nullable = false; // NOT NULL field
        $this->NoKTP->Required = true; // Required field
        $this->NoKTP->Sortable = true; // Allow sort
        $this->NoKTP->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NoKTP->Param, "CustomMsg");
        $this->Fields['NoKTP'] = &$this->NoKTP;

        // NAMA_PEMILIK
        $this->NAMA_PEMILIK = new DbField('v_umkm_datadiri', 'v_umkm_datadiri', 'x_NAMA_PEMILIK', 'NAMA_PEMILIK', '`NAMA_PEMILIK`', '`NAMA_PEMILIK`', 200, 100, -1, false, '`NAMA_PEMILIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // JENIS_KELAMIN
        $this->JENIS_KELAMIN = new DbField('v_umkm_datadiri', 'v_umkm_datadiri', 'x_JENIS_KELAMIN', 'JENIS_KELAMIN', '`JENIS_KELAMIN`', '`JENIS_KELAMIN`', 200, 10, -1, false, '`JENIS_KELAMIN`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->JENIS_KELAMIN->Sortable = true; // Allow sort
        $this->JENIS_KELAMIN->Lookup = new Lookup('JENIS_KELAMIN', 'v_umkm_datadiri', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // KAPANEWON
        $this->KAPANEWON = new DbField('v_umkm_datadiri', 'v_umkm_datadiri', 'x_KAPANEWON', 'KAPANEWON', '`KAPANEWON`', '`KAPANEWON`', 200, 50, -1, false, '`KAPANEWON`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // KALURAHAN
        $this->KALURAHAN = new DbField('v_umkm_datadiri', 'v_umkm_datadiri', 'x_KALURAHAN', 'KALURAHAN', '`KALURAHAN`', '`KALURAHAN`', 200, 50, -1, false, '`KALURAHAN`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // DUSUN
        $this->DUSUN = new DbField('v_umkm_datadiri', 'v_umkm_datadiri', 'x_DUSUN', 'DUSUN', '`DUSUN`', '`DUSUN`', 200, 50, -1, false, '`DUSUN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ALAMAT
        $this->ALAMAT = new DbField('v_umkm_datadiri', 'v_umkm_datadiri', 'x_ALAMAT', 'ALAMAT', '`ALAMAT`', '`ALAMAT`', 201, 65535, -1, false, '`ALAMAT`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->ALAMAT->Sortable = true; // Allow sort
        $this->ALAMAT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ALAMAT->Param, "CustomMsg");
        $this->Fields['ALAMAT'] = &$this->ALAMAT;

        // EMAIL
        $this->_EMAIL = new DbField('v_umkm_datadiri', 'v_umkm_datadiri', 'x__EMAIL', 'EMAIL', '`EMAIL`', '`EMAIL`', 200, 100, -1, false, '`EMAIL`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PASSWORD
        $this->_PASSWORD = new DbField('v_umkm_datadiri', 'v_umkm_datadiri', 'x__PASSWORD', 'PASSWORD', '`PASSWORD`', '`PASSWORD`', 200, 255, -1, false, '`PASSWORD`', false, false, false, 'FORMATTED TEXT', 'PASSWORD');
        ...
        // AKTIVASI
        $this->AKTIVASI = new DbField('v_umkm_datadiri', 'v_umkm_datadiri', 'x_AKTIVASI', 'AKTIVASI', '`AKTIVASI`', '`AKTIVASI`', 200, 100, -1, false, '`AKTIVASI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PROFIL
        $this->PROFIL = new DbField('v_umkm_datadiri', 'v_umkm_datadiri', 'x_PROFIL', 'PROFIL', '`PROFIL`', '`PROFIL`', 201, 65535, -1, false, '`PROFIL`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // NO_HP
        $this->NO_HP = new DbField('v_umkm_datadiri', 'v_umkm_datadiri', 'x_NO_HP', 'NO_HP', '`NO_HP`', '`NO_HP`', 200, 20, -1, false, '`NO_HP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "umkm_datadiri a";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("a.NIK AS IDSIDAKUI,a.NIK AS NoKTP, a.*");
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->IDSIDAKUI->DbValue = $row['IDSIDAKUI'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("vumkmdatadirilist");
    }
    ...
    {
        global $Language;
        if ($pageName == "vumkmdatadiriview") {
            return $Language->phrase("View");
        } elseif ($pageName == "vumkmdatadiriedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "vumkmdatadiriadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VUmkmDatadiriView";
            case Config("API_ADD_ACTION"):
                return "VUmkmDatadiriAdd";
            case Config("API_EDIT_ACTION"):
                return "VUmkmDatadiriEdit";
            case Config("API_DELETE_ACTION"):
                return "VUmkmDatadiriDelete";
            case Config("API_LIST_ACTION"):
                return "VUmkmDatadiriList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("vumkmdatadiriview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("vumkmdatadiriview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "vumkmdatadiriadd?" . $this->getUrlParm($parm);
        } else {
            $url = "vumkmdatadiriadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vumkmdatadiriedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vumkmdatadiriadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("vumkmdatadiridelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->IDSIDAKUI->setDbValue($row['IDSIDAKUI']);
    ...
    public function renderListRow()
    {
        ...
        // IDSIDAKUI
        $this->IDSIDAKUI->ViewValue = $this->IDSIDAKUI->CurrentValue;
        $this->IDSIDAKUI->ViewCustomAttributes = "";
        ...
        $this->NIK->HrefValue = "";
        $this->NIK->ExportHrefValue = Barcode()->getHrefValue($this->NIK->CurrentValue, 'QRCODE', 200);
        $this->NIK->TooltipValue = "";

        // IDSIDAKUI
        $this->IDSIDAKUI->LinkCustomAttributes = "";
        $this->IDSIDAKUI->HrefValue = "";
        $this->IDSIDAKUI->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // IDSIDAKUI
        $this->IDSIDAKUI->EditAttrs["class"] = "form-control";
        $this->IDSIDAKUI->EditCustomAttributes = "";
        if (!$this->IDSIDAKUI->Raw) {
            $this->IDSIDAKUI->CurrentValue = HtmlDecode($this->IDSIDAKUI->CurrentValue);
        }
        $this->IDSIDAKUI->EditValue = $this->IDSIDAKUI->CurrentValue;
        $this->IDSIDAKUI->PlaceHolder = RemoveHtml($this->IDSIDAKUI->caption());
        ...
        $this->NO_HP->EditCustomAttributes = "placeholder='+628xx-xxx-xxx'";
        if (!$this->NO_HP->Raw) {
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->IDSIDAKUI);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->IDSIDAKUI);
