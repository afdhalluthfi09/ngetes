 ...
 * Page class
 */
class UmkmDatadiriDelete extends UmkmDatadiri
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UmkmDatadiriDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("umkmdatadirilist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("umkmdatadirilist"); // Return to list
                return;
            }
        }
