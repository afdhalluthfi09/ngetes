...
/**
 * Table class for res_nilai_pemasaran
 */
class ResNilaiPemasaran extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'res_nilai_pemasaran';
        $this->TableName = 'res_nilai_pemasaran';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`res_nilai_pemasaran`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // nik
        $this->nik = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_nik', 'nik', '`nik`', '`nik`', 200, 16, -1, false, '`nik`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_unggul
        $this->skor_unggul = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_skor_unggul', 'skor_unggul', '`skor_unggul`', '`skor_unggul`', 5, 23, -1, false, '`skor_unggul`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_unggul
        $this->max_unggul = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_max_unggul', 'max_unggul', '`max_unggul`', '`max_unggul`', 5, 23, -1, false, '`max_unggul`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_target
        $this->skor_target = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_skor_target', 'skor_target', '`skor_target`', '`skor_target`', 5, 23, -1, false, '`skor_target`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_target
        $this->max_target = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_max_target', 'max_target', '`max_target`', '`max_target`', 5, 23, -1, false, '`max_target`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_available
        $this->skor_available = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_skor_available', 'skor_available', '`skor_available`', '`skor_available`', 5, 23, -1, false, '`skor_available`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_available
        $this->max_available = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_max_available', 'max_available', '`max_available`', '`max_available`', 5, 23, -1, false, '`max_available`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_merk
        $this->skor_merk = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_skor_merk', 'skor_merk', '`skor_merk`', '`skor_merk`', 5, 23, -1, false, '`skor_merk`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_merk
        $this->max_merk = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_max_merk', 'max_merk', '`max_merk`', '`max_merk`', 5, 23, -1, false, '`max_merk`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_merkhaki
        $this->skor_merkhaki = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_skor_merkhaki', 'skor_merkhaki', '`skor_merkhaki`', '`skor_merkhaki`', 5, 23, -1, false, '`skor_merkhaki`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_merkhaki
        $this->max_merkhaki = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_max_merkhaki', 'max_merkhaki', '`max_merkhaki`', '`max_merkhaki`', 5, 23, -1, false, '`max_merkhaki`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_merkkonsep
        $this->skor_merkkonsep = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_skor_merkkonsep', 'skor_merkkonsep', '`skor_merkkonsep`', '`skor_merkkonsep`', 5, 23, -1, false, '`skor_merkkonsep`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_merkkonsep
        $this->max_merkkonsep = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_max_merkkonsep', 'max_merkkonsep', '`max_merkkonsep`', '`max_merkkonsep`', 5, 23, -1, false, '`max_merkkonsep`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_merklisensi
        $this->skor_merklisensi = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_skor_merklisensi', 'skor_merklisensi', '`skor_merklisensi`', '`skor_merklisensi`', 5, 23, -1, false, '`skor_merklisensi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_merklisensi
        $this->max_merklisensi = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_max_merklisensi', 'max_merklisensi', '`max_merklisensi`', '`max_merklisensi`', 5, 23, -1, false, '`max_merklisensi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_mitra
        $this->skor_mitra = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_skor_mitra', 'skor_mitra', '`skor_mitra`', '`skor_mitra`', 5, 23, -1, false, '`skor_mitra`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_mitra
        $this->max_mitra = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_max_mitra', 'max_mitra', '`max_mitra`', '`max_mitra`', 5, 23, -1, false, '`max_mitra`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_market
        $this->skor_market = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_skor_market', 'skor_market', '`skor_market`', '`skor_market`', 5, 23, -1, false, '`skor_market`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_market
        $this->max_market = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_max_market', 'max_market', '`max_market`', '`max_market`', 5, 23, -1, false, '`max_market`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_pelangganloyal
        $this->skor_pelangganloyal = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_skor_pelangganloyal', 'skor_pelangganloyal', '`skor_pelangganloyal`', '`skor_pelangganloyal`', 5, 23, -1, false, '`skor_pelangganloyal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_pelangganloyal
        $this->max_pelangganloyal = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_max_pelangganloyal', 'max_pelangganloyal', '`max_pelangganloyal`', '`max_pelangganloyal`', 5, 23, -1, false, '`max_pelangganloyal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_pameranmandiri
        $this->skor_pameranmandiri = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_skor_pameranmandiri', 'skor_pameranmandiri', '`skor_pameranmandiri`', '`skor_pameranmandiri`', 5, 23, -1, false, '`skor_pameranmandiri`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_pameranmandiri
        $this->max_pameranmandiri = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_max_pameranmandiri', 'max_pameranmandiri', '`max_pameranmandiri`', '`max_pameranmandiri`', 5, 23, -1, false, '`max_pameranmandiri`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_mediaoffline
        $this->skor_mediaoffline = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_skor_mediaoffline', 'skor_mediaoffline', '`skor_mediaoffline`', '`skor_mediaoffline`', 5, 23, -1, false, '`skor_mediaoffline`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_mediaoffline
        $this->max_mediaoffline = new DbField('res_nilai_pemasaran', 'res_nilai_pemasaran', 'x_max_mediaoffline', 'max_mediaoffline', '`max_mediaoffline`', '`max_mediaoffline`', 5, 23, -1, false, '`max_mediaoffline`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`res_nilai_pemasaran`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("resnilaipemasaranlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "resnilaipemasaranview") {
            return $Language->phrase("View");
        } elseif ($pageName == "resnilaipemasaranedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "resnilaipemasaranadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ResNilaiPemasaranView";
            case Config("API_ADD_ACTION"):
                return "ResNilaiPemasaranAdd";
            case Config("API_EDIT_ACTION"):
                return "ResNilaiPemasaranEdit";
            case Config("API_DELETE_ACTION"):
                return "ResNilaiPemasaranDelete";
            case Config("API_LIST_ACTION"):
                return "ResNilaiPemasaranList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("resnilaipemasaranview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("resnilaipemasaranview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "resnilaipemasaranadd?" . $this->getUrlParm($parm);
        } else {
            $url = "resnilaipemasaranadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("resnilaipemasaranedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("resnilaipemasaranadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("resnilaipemasarandelete", $this->getUrlParm());
    }
