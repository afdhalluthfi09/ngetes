 ...
 * Page class
 */
class TempSkorKelasList extends TempSkorKelas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TempSkorKelasList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "ftemp_skor_kelaslist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "tempskorkelasadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "tempskorkelasdelete";
        $this->MultiUpdateUrl = "tempskorkelasupdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option ftemp_skor_kelaslistsrch";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "ftemp_skor_kelaslistsrch");
        }
        $filterList = Concat($filterList, $this->NIK->AdvancedSearch->toJson(), ","); // Field NIK
        $filterList = Concat($filterList, $this->NAMA_PEMILIK->AdvancedSearch->toJson(), ","); // Field NAMA_PEMILIK
        ...
        $filterList = Concat($filterList, $this->KAPANEWON->AdvancedSearch->toJson(), ","); // Field KAPANEWON
        ...
        $filterList = Concat($filterList, $this->skor_pemasaranonline->AdvancedSearch->toJson(), ","); // Field skor_pemasaranonline
        $filterList = Concat($filterList, $this->maxskor_pemasaranonline->AdvancedSearch->toJson(), ","); // Field maxskor_pemasaranonline
        $filterList = Concat($filterList, $this->bobot_pemasaranonline->AdvancedSearch->toJson(), ","); // Field bobot_pemasaranonline
        $filterList = Concat($filterList, $this->skor_kelembagaan->AdvancedSearch->toJson(), ","); // Field skor_kelembagaan
        $filterList = Concat($filterList, $this->maxskor_kelembagaan->AdvancedSearch->toJson(), ","); // Field maxskor_kelembagaan
        $filterList = Concat($filterList, $this->bobot_kelembagaan->AdvancedSearch->toJson(), ","); // Field bobot_kelembagaan
        ...
        $filterList = Concat($filterList, $this->skor_sdm->AdvancedSearch->toJson(), ","); // Field skor_sdm
        $filterList = Concat($filterList, $this->maxskor_sdm->AdvancedSearch->toJson(), ","); // Field maxskor_sdm
        $filterList = Concat($filterList, $this->bobot_sdm->AdvancedSearch->toJson(), ","); // Field bobot_sdm
        $filterList = Concat($filterList, $this->skor_kelas->AdvancedSearch->toJson(), ","); // Field skor_kelas
        $filterList = Concat($filterList, $this->maxskor_kelas->AdvancedSearch->toJson(), ","); // Field maxskor_kelas
        $filterList = Concat($filterList, $this->kelas_umkm->AdvancedSearch->toJson(), ","); // Field kelas_umkm
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "ftemp_skor_kelaslistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field NAMA_PEMILIK
        $this->NAMA_PEMILIK->AdvancedSearch->SearchValue = @$filter["x_NAMA_PEMILIK"];
        $this->NAMA_PEMILIK->AdvancedSearch->SearchOperator = @$filter["z_NAMA_PEMILIK"];
        $this->NAMA_PEMILIK->AdvancedSearch->SearchCondition = @$filter["v_NAMA_PEMILIK"];
        $this->NAMA_PEMILIK->AdvancedSearch->SearchValue2 = @$filter["y_NAMA_PEMILIK"];
        $this->NAMA_PEMILIK->AdvancedSearch->SearchOperator2 = @$filter["w_NAMA_PEMILIK"];
        $this->NAMA_PEMILIK->AdvancedSearch->save();
        ...
        // Field KAPANEWON
        $this->KAPANEWON->AdvancedSearch->SearchValue = @$filter["x_KAPANEWON"];
        $this->KAPANEWON->AdvancedSearch->SearchOperator = @$filter["z_KAPANEWON"];
        $this->KAPANEWON->AdvancedSearch->SearchCondition = @$filter["v_KAPANEWON"];
        $this->KAPANEWON->AdvancedSearch->SearchValue2 = @$filter["y_KAPANEWON"];
        $this->KAPANEWON->AdvancedSearch->SearchOperator2 = @$filter["w_KAPANEWON"];
        $this->KAPANEWON->AdvancedSearch->save();
        ...
        // Field skor_pemasaranonline
        $this->skor_pemasaranonline->AdvancedSearch->SearchValue = @$filter["x_skor_pemasaranonline"];
        $this->skor_pemasaranonline->AdvancedSearch->SearchOperator = @$filter["z_skor_pemasaranonline"];
        $this->skor_pemasaranonline->AdvancedSearch->SearchCondition = @$filter["v_skor_pemasaranonline"];
        $this->skor_pemasaranonline->AdvancedSearch->SearchValue2 = @$filter["y_skor_pemasaranonline"];
        $this->skor_pemasaranonline->AdvancedSearch->SearchOperator2 = @$filter["w_skor_pemasaranonline"];
        $this->skor_pemasaranonline->AdvancedSearch->save();

        // Field maxskor_pemasaranonline
        $this->maxskor_pemasaranonline->AdvancedSearch->SearchValue = @$filter["x_maxskor_pemasaranonline"];
        $this->maxskor_pemasaranonline->AdvancedSearch->SearchOperator = @$filter["z_maxskor_pemasaranonline"];
        $this->maxskor_pemasaranonline->AdvancedSearch->SearchCondition = @$filter["v_maxskor_pemasaranonline"];
        $this->maxskor_pemasaranonline->AdvancedSearch->SearchValue2 = @$filter["y_maxskor_pemasaranonline"];
        $this->maxskor_pemasaranonline->AdvancedSearch->SearchOperator2 = @$filter["w_maxskor_pemasaranonline"];
        $this->maxskor_pemasaranonline->AdvancedSearch->save();

        // Field bobot_pemasaranonline
        $this->bobot_pemasaranonline->AdvancedSearch->SearchValue = @$filter["x_bobot_pemasaranonline"];
        $this->bobot_pemasaranonline->AdvancedSearch->SearchOperator = @$filter["z_bobot_pemasaranonline"];
        $this->bobot_pemasaranonline->AdvancedSearch->SearchCondition = @$filter["v_bobot_pemasaranonline"];
        $this->bobot_pemasaranonline->AdvancedSearch->SearchValue2 = @$filter["y_bobot_pemasaranonline"];
        $this->bobot_pemasaranonline->AdvancedSearch->SearchOperator2 = @$filter["w_bobot_pemasaranonline"];
        $this->bobot_pemasaranonline->AdvancedSearch->save();

        // Field skor_kelembagaan
        $this->skor_kelembagaan->AdvancedSearch->SearchValue = @$filter["x_skor_kelembagaan"];
        $this->skor_kelembagaan->AdvancedSearch->SearchOperator = @$filter["z_skor_kelembagaan"];
        $this->skor_kelembagaan->AdvancedSearch->SearchCondition = @$filter["v_skor_kelembagaan"];
        $this->skor_kelembagaan->AdvancedSearch->SearchValue2 = @$filter["y_skor_kelembagaan"];
        $this->skor_kelembagaan->AdvancedSearch->SearchOperator2 = @$filter["w_skor_kelembagaan"];
        $this->skor_kelembagaan->AdvancedSearch->save();

        // Field maxskor_kelembagaan
        $this->maxskor_kelembagaan->AdvancedSearch->SearchValue = @$filter["x_maxskor_kelembagaan"];
        $this->maxskor_kelembagaan->AdvancedSearch->SearchOperator = @$filter["z_maxskor_kelembagaan"];
        $this->maxskor_kelembagaan->AdvancedSearch->SearchCondition = @$filter["v_maxskor_kelembagaan"];
        $this->maxskor_kelembagaan->AdvancedSearch->SearchValue2 = @$filter["y_maxskor_kelembagaan"];
        $this->maxskor_kelembagaan->AdvancedSearch->SearchOperator2 = @$filter["w_maxskor_kelembagaan"];
        $this->maxskor_kelembagaan->AdvancedSearch->save();

        // Field bobot_kelembagaan
        $this->bobot_kelembagaan->AdvancedSearch->SearchValue = @$filter["x_bobot_kelembagaan"];
        $this->bobot_kelembagaan->AdvancedSearch->SearchOperator = @$filter["z_bobot_kelembagaan"];
        $this->bobot_kelembagaan->AdvancedSearch->SearchCondition = @$filter["v_bobot_kelembagaan"];
        $this->bobot_kelembagaan->AdvancedSearch->SearchValue2 = @$filter["y_bobot_kelembagaan"];
        $this->bobot_kelembagaan->AdvancedSearch->SearchOperator2 = @$filter["w_bobot_kelembagaan"];
        $this->bobot_kelembagaan->AdvancedSearch->save();
        ...
        // Field skor_sdm
        $this->skor_sdm->AdvancedSearch->SearchValue = @$filter["x_skor_sdm"];
        $this->skor_sdm->AdvancedSearch->SearchOperator = @$filter["z_skor_sdm"];
        $this->skor_sdm->AdvancedSearch->SearchCondition = @$filter["v_skor_sdm"];
        $this->skor_sdm->AdvancedSearch->SearchValue2 = @$filter["y_skor_sdm"];
        $this->skor_sdm->AdvancedSearch->SearchOperator2 = @$filter["w_skor_sdm"];
        $this->skor_sdm->AdvancedSearch->save();

        // Field maxskor_sdm
        $this->maxskor_sdm->AdvancedSearch->SearchValue = @$filter["x_maxskor_sdm"];
        $this->maxskor_sdm->AdvancedSearch->SearchOperator = @$filter["z_maxskor_sdm"];
        $this->maxskor_sdm->AdvancedSearch->SearchCondition = @$filter["v_maxskor_sdm"];
        $this->maxskor_sdm->AdvancedSearch->SearchValue2 = @$filter["y_maxskor_sdm"];
        $this->maxskor_sdm->AdvancedSearch->SearchOperator2 = @$filter["w_maxskor_sdm"];
        $this->maxskor_sdm->AdvancedSearch->save();

        // Field bobot_sdm
        $this->bobot_sdm->AdvancedSearch->SearchValue = @$filter["x_bobot_sdm"];
        $this->bobot_sdm->AdvancedSearch->SearchOperator = @$filter["z_bobot_sdm"];
        $this->bobot_sdm->AdvancedSearch->SearchCondition = @$filter["v_bobot_sdm"];
        $this->bobot_sdm->AdvancedSearch->SearchValue2 = @$filter["y_bobot_sdm"];
        $this->bobot_sdm->AdvancedSearch->SearchOperator2 = @$filter["w_bobot_sdm"];
        $this->bobot_sdm->AdvancedSearch->save();

        // Field skor_kelas
        $this->skor_kelas->AdvancedSearch->SearchValue = @$filter["x_skor_kelas"];
        $this->skor_kelas->AdvancedSearch->SearchOperator = @$filter["z_skor_kelas"];
        $this->skor_kelas->AdvancedSearch->SearchCondition = @$filter["v_skor_kelas"];
        $this->skor_kelas->AdvancedSearch->SearchValue2 = @$filter["y_skor_kelas"];
        $this->skor_kelas->AdvancedSearch->SearchOperator2 = @$filter["w_skor_kelas"];
        $this->skor_kelas->AdvancedSearch->save();

        // Field maxskor_kelas
        $this->maxskor_kelas->AdvancedSearch->SearchValue = @$filter["x_maxskor_kelas"];
        $this->maxskor_kelas->AdvancedSearch->SearchOperator = @$filter["z_maxskor_kelas"];
        $this->maxskor_kelas->AdvancedSearch->SearchCondition = @$filter["v_maxskor_kelas"];
        $this->maxskor_kelas->AdvancedSearch->SearchValue2 = @$filter["y_maxskor_kelas"];
        $this->maxskor_kelas->AdvancedSearch->SearchOperator2 = @$filter["w_maxskor_kelas"];
        $this->maxskor_kelas->AdvancedSearch->save();

        // Field kelas_umkm
        $this->kelas_umkm->AdvancedSearch->SearchValue = @$filter["x_kelas_umkm"];
        $this->kelas_umkm->AdvancedSearch->SearchOperator = @$filter["z_kelas_umkm"];
        $this->kelas_umkm->AdvancedSearch->SearchCondition = @$filter["v_kelas_umkm"];
        $this->kelas_umkm->AdvancedSearch->SearchValue2 = @$filter["y_kelas_umkm"];
        $this->kelas_umkm->AdvancedSearch->SearchOperator2 = @$filter["w_kelas_umkm"];
        $this->kelas_umkm->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->NAMA_PEMILIK, $arKeywords, $type);
        ...
        $this->buildBasicSearchSql($where, $this->KAPANEWON, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->kelas_umkm, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->KAPANEWON); // KAPANEWON
            ...
            $this->updateSort($this->skor_pemasaranonline); // skor_pemasaranonline
            $this->updateSort($this->maxskor_pemasaranonline); // maxskor_pemasaranonline
            $this->updateSort($this->bobot_pemasaranonline); // bobot_pemasaranonline
            $this->updateSort($this->skor_kelembagaan); // skor_kelembagaan
            $this->updateSort($this->maxskor_kelembagaan); // maxskor_kelembagaan
            $this->updateSort($this->bobot_kelembagaan); // bobot_kelembagaan
            ...
            $this->updateSort($this->skor_sdm); // skor_sdm
            $this->updateSort($this->maxskor_sdm); // maxskor_sdm
            $this->updateSort($this->bobot_sdm); // bobot_sdm
            $this->updateSort($this->skor_kelas); // skor_kelas
            $this->updateSort($this->maxskor_kelas); // maxskor_kelas
            $this->updateSort($this->kelas_umkm); // kelas_umkm
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->skor_pemasaranonline->setSort("");
                $this->maxskor_pemasaranonline->setSort("");
                $this->bobot_pemasaranonline->setSort("");
                $this->skor_kelembagaan->setSort("");
                $this->maxskor_kelembagaan->setSort("");
                $this->bobot_kelembagaan->setSort("");
                $this->skor_keuangan->setSort("");
                $this->maxskor_keuangan->setSort("");
                $this->bobot_keuangan->setSort("");
                $this->skor_sdm->setSort("");
                $this->maxskor_sdm->setSort("");
                $this->bobot_sdm->setSort("");
                $this->skor_kelas->setSort("");
                $this->maxskor_kelas->setSort("");
                $this->kelas_umkm->setSort("");
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"ftemp_skor_kelaslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"ftemp_skor_kelaslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.ftemp_skor_kelaslist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.ftemp_skor_kelaslist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.ftemp_skor_kelaslist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.ftemp_skor_kelaslist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
    ...
    protected function setupSearchSortOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ftemp_skor_kelaslistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
