 ...
 * Page class
 */
class UmkmVariabelDelete extends UmkmVariabel
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UmkmVariabelDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("umkmvariabellist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("umkmvariabellist"); // Return to list
                return;
            }
        }
