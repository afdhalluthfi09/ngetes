...
/**
 * Table class for kop_keragaan_bybentuk_keanggotaan
 */
class KopKeragaanBybentukKeanggotaan extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'kop_keragaan_bybentuk_keanggotaan';
        $this->TableName = 'kop_keragaan_bybentuk_keanggotaan';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`kop_keragaan_bybentuk_keanggotaan`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Tahun_Periode
        $this->Tahun_Periode = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Tahun_Periode', 'Tahun_Periode', '`Tahun_Periode`', '`Tahun_Periode`', 3, 4, -1, false, '`Tahun_Periode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Periode
        $this->Periode = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Periode', 'Periode', '`Periode`', '`Periode`', 3, 1, -1, false, '`Periode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Bentuk_Anggota
        $this->Bentuk_Anggota = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Bentuk_Anggota', 'Bentuk_Anggota', '`Bentuk_Anggota`', '`Bentuk_Anggota`', 200, 200, -1, false, '`Bentuk_Anggota`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Bentuk_Anggota->Sortable = true; // Allow sort
        $this->Bentuk_Anggota->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Bentuk_Anggota->Param, "CustomMsg");
        $this->Fields['Bentuk_Anggota'] = &$this->Bentuk_Anggota;

        // Jumlah_Koperasi
        $this->Jumlah_Koperasi = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Jumlah_Koperasi', 'Jumlah_Koperasi', '`Jumlah_Koperasi`', '`Jumlah_Koperasi`', 5, 23, -1, false, '`Jumlah_Koperasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Aktif
        $this->Aktif = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Aktif', 'Aktif', '`Aktif`', '`Aktif`', 5, 23, -1, false, '`Aktif`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pasif
        $this->Pasif = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Pasif', 'Pasif', '`Pasif`', '`Pasif`', 5, 23, -1, false, '`Pasif`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Jumlah_Anggota
        $this->Jumlah_Anggota = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Jumlah_Anggota', 'Jumlah_Anggota', '`Jumlah_Anggota`', '`Jumlah_Anggota`', 131, 32, -1, false, '`Jumlah_Anggota`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Anggota_Laki-laki
        $this->Anggota_Lakilaki = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Anggota_Lakilaki', 'Anggota_Laki-laki', '`Anggota_Laki-laki`', '`Anggota_Laki-laki`', 131, 32, -1, false, '`Anggota_Laki-laki`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Anggota_Perempuan
        $this->Anggota_Perempuan = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Anggota_Perempuan', 'Anggota_Perempuan', '`Anggota_Perempuan`', '`Anggota_Perempuan`', 131, 32, -1, false, '`Anggota_Perempuan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Jumlah_Manajer
        $this->Jumlah_Manajer = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Jumlah_Manajer', 'Jumlah_Manajer', '`Jumlah_Manajer`', '`Jumlah_Manajer`', 131, 32, -1, false, '`Jumlah_Manajer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Manajer_Laki-laki
        $this->Manajer_Lakilaki = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Manajer_Lakilaki', 'Manajer_Laki-laki', '`Manajer_Laki-laki`', '`Manajer_Laki-laki`', 131, 32, -1, false, '`Manajer_Laki-laki`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Manajer_Perempuan
        $this->Manajer_Perempuan = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Manajer_Perempuan', 'Manajer_Perempuan', '`Manajer_Perempuan`', '`Manajer_Perempuan`', 131, 32, -1, false, '`Manajer_Perempuan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Jumlah_Karyawan
        $this->Jumlah_Karyawan = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Jumlah_Karyawan', 'Jumlah_Karyawan', '`Jumlah_Karyawan`', '`Jumlah_Karyawan`', 131, 32, -1, false, '`Jumlah_Karyawan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Karyawan_Laki-laki
        $this->Karyawan_Lakilaki = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Karyawan_Lakilaki', 'Karyawan_Laki-laki', '`Karyawan_Laki-laki`', '`Karyawan_Laki-laki`', 131, 32, -1, false, '`Karyawan_Laki-laki`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Karyawan_Perempuan
        $this->Karyawan_Perempuan = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Karyawan_Perempuan', 'Karyawan_Perempuan', '`Karyawan_Perempuan`', '`Karyawan_Perempuan`', 131, 32, -1, false, '`Karyawan_Perempuan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RAT
        $this->RAT = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_RAT', 'RAT', '`RAT`', '`RAT`', 131, 22, -1, false, '`RAT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->Jumlah_Modal_Sendiri = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Jumlah_Modal_Sendiri', 'Jumlah_Modal_Sendiri', '`Jumlah_Modal_Sendiri`', '`Jumlah_Modal_Sendiri`', 5, 23, -1, false, '`Jumlah_Modal_Sendiri`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Jumlah_Modal_Luar
        $this->Jumlah_Modal_Luar = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Jumlah_Modal_Luar', 'Jumlah_Modal_Luar', '`Jumlah_Modal_Luar`', '`Jumlah_Modal_Luar`', 5, 23, -1, false, '`Jumlah_Modal_Luar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Jumlah_Volume_Usaha
        $this->Jumlah_Volume_Usaha = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Jumlah_Volume_Usaha', 'Jumlah_Volume_Usaha', '`Jumlah_Volume_Usaha`', '`Jumlah_Volume_Usaha`', 5, 23, -1, false, '`Jumlah_Volume_Usaha`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SHU
        $this->SHU = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_SHU', 'SHU', '`SHU`', '`SHU`', 5, 23, -1, false, '`SHU`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Aset
        $this->Aset = new DbField('kop_keragaan_bybentuk_keanggotaan', 'kop_keragaan_bybentuk_keanggotaan', 'x_Aset', 'Aset', '`Aset`', '`Aset`', 5, 23, -1, false, '`Aset`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`kop_keragaan_bybentuk_keanggotaan`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("kopkeragaanbybentukkeanggotaanlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "kopkeragaanbybentukkeanggotaanview") {
            return $Language->phrase("View");
        } elseif ($pageName == "kopkeragaanbybentukkeanggotaanedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "kopkeragaanbybentukkeanggotaanadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "KopKeragaanBybentukKeanggotaanView";
            case Config("API_ADD_ACTION"):
                return "KopKeragaanBybentukKeanggotaanAdd";
            case Config("API_EDIT_ACTION"):
                return "KopKeragaanBybentukKeanggotaanEdit";
            case Config("API_DELETE_ACTION"):
                return "KopKeragaanBybentukKeanggotaanDelete";
            case Config("API_LIST_ACTION"):
                return "KopKeragaanBybentukKeanggotaanList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("kopkeragaanbybentukkeanggotaanview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("kopkeragaanbybentukkeanggotaanview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "kopkeragaanbybentukkeanggotaanadd?" . $this->getUrlParm($parm);
        } else {
            $url = "kopkeragaanbybentukkeanggotaanadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kopkeragaanbybentukkeanggotaanedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kopkeragaanbybentukkeanggotaanadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("kopkeragaanbybentukkeanggotaandelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->Bentuk_Anggota->setDbValue($row['Bentuk_Anggota']);
    ...
    public function renderListRow()
    {
        ...
        // Bentuk_Anggota
        $this->Bentuk_Anggota->ViewValue = $this->Bentuk_Anggota->CurrentValue;
        $this->Bentuk_Anggota->ViewCustomAttributes = "";
        ...
        // Bentuk_Anggota
        $this->Bentuk_Anggota->LinkCustomAttributes = "";
        $this->Bentuk_Anggota->HrefValue = "";
        $this->Bentuk_Anggota->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // Bentuk_Anggota
        $this->Bentuk_Anggota->EditAttrs["class"] = "form-control";
        $this->Bentuk_Anggota->EditCustomAttributes = "";
        if (!$this->Bentuk_Anggota->Raw) {
            $this->Bentuk_Anggota->CurrentValue = HtmlDecode($this->Bentuk_Anggota->CurrentValue);
        }
        $this->Bentuk_Anggota->EditValue = $this->Bentuk_Anggota->CurrentValue;
        $this->Bentuk_Anggota->PlaceHolder = RemoveHtml($this->Bentuk_Anggota->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->Bentuk_Anggota);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->Bentuk_Anggota);
