 ...
 * Page class
 */
class TempSkorKeuanganAdd extends TempSkorKeuangan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TempSkorKeuanganAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "tempskorkeuanganview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->skor_income->CurrentValue = null;
        $this->skor_income->OldValue = $this->skor_income->CurrentValue;
        $this->max_income->CurrentValue = null;
        $this->max_income->OldValue = $this->max_income->CurrentValue;
        $this->skor_pengelolaan->CurrentValue = null;
        $this->skor_pengelolaan->OldValue = $this->skor_pengelolaan->CurrentValue;
        $this->max_pengelolaan->CurrentValue = null;
        $this->max_pengelolaan->OldValue = $this->max_pengelolaan->CurrentValue;
        $this->skor_nota->CurrentValue = null;
        $this->skor_nota->OldValue = $this->skor_nota->CurrentValue;
        $this->max_nota->CurrentValue = null;
        $this->max_nota->OldValue = $this->max_nota->CurrentValue;
        $this->skor_jurnal->CurrentValue = null;
        $this->skor_jurnal->OldValue = $this->skor_jurnal->CurrentValue;
        $this->max_jurnal->CurrentValue = null;
        $this->max_jurnal->OldValue = $this->max_jurnal->CurrentValue;
        $this->skor_akutansi->CurrentValue = null;
        $this->skor_akutansi->OldValue = $this->skor_akutansi->CurrentValue;
        $this->max_akutansi->CurrentValue = null;
        $this->max_akutansi->OldValue = $this->max_akutansi->CurrentValue;
        $this->skor_utangbank->CurrentValue = null;
        $this->skor_utangbank->OldValue = $this->skor_utangbank->CurrentValue;
        $this->max_utangbank->CurrentValue = null;
        $this->max_utangbank->OldValue = $this->max_utangbank->CurrentValue;
        $this->skor_dokumentasi->CurrentValue = null;
        $this->skor_dokumentasi->OldValue = $this->skor_dokumentasi->CurrentValue;
        $this->max_dokumentasi->CurrentValue = null;
        $this->max_dokumentasi->OldValue = $this->max_dokumentasi->CurrentValue;
        $this->skor_nontunai->CurrentValue = null;
        $this->skor_nontunai->OldValue = $this->skor_nontunai->CurrentValue;
        $this->max_nontunai->CurrentValue = null;
        $this->max_nontunai->OldValue = $this->max_nontunai->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['skor_income'] = $this->skor_income->CurrentValue;
        $row['max_income'] = $this->max_income->CurrentValue;
        $row['skor_pengelolaan'] = $this->skor_pengelolaan->CurrentValue;
        $row['max_pengelolaan'] = $this->max_pengelolaan->CurrentValue;
        $row['skor_nota'] = $this->skor_nota->CurrentValue;
        $row['max_nota'] = $this->max_nota->CurrentValue;
        $row['skor_jurnal'] = $this->skor_jurnal->CurrentValue;
        $row['max_jurnal'] = $this->max_jurnal->CurrentValue;
        $row['skor_akutansi'] = $this->skor_akutansi->CurrentValue;
        $row['max_akutansi'] = $this->max_akutansi->CurrentValue;
        $row['skor_utangbank'] = $this->skor_utangbank->CurrentValue;
        $row['max_utangbank'] = $this->max_utangbank->CurrentValue;
        $row['skor_dokumentasi'] = $this->skor_dokumentasi->CurrentValue;
        $row['max_dokumentasi'] = $this->max_dokumentasi->CurrentValue;
        $row['skor_nontunai'] = $this->skor_nontunai->CurrentValue;
        $row['max_nontunai'] = $this->max_nontunai->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // skor_income
        $this->skor_income->setDbValueDef($rsnew, $this->skor_income->CurrentValue, null, false);

        // max_income
        $this->max_income->setDbValueDef($rsnew, $this->max_income->CurrentValue, null, false);

        // skor_pengelolaan
        $this->skor_pengelolaan->setDbValueDef($rsnew, $this->skor_pengelolaan->CurrentValue, null, false);

        // max_pengelolaan
        $this->max_pengelolaan->setDbValueDef($rsnew, $this->max_pengelolaan->CurrentValue, null, false);

        // skor_nota
        $this->skor_nota->setDbValueDef($rsnew, $this->skor_nota->CurrentValue, null, false);

        // max_nota
        $this->max_nota->setDbValueDef($rsnew, $this->max_nota->CurrentValue, null, false);

        // skor_jurnal
        $this->skor_jurnal->setDbValueDef($rsnew, $this->skor_jurnal->CurrentValue, null, false);

        // max_jurnal
        $this->max_jurnal->setDbValueDef($rsnew, $this->max_jurnal->CurrentValue, null, false);

        // skor_akutansi
        $this->skor_akutansi->setDbValueDef($rsnew, $this->skor_akutansi->CurrentValue, null, false);

        // max_akutansi
        $this->max_akutansi->setDbValueDef($rsnew, $this->max_akutansi->CurrentValue, null, false);

        // skor_utangbank
        $this->skor_utangbank->setDbValueDef($rsnew, $this->skor_utangbank->CurrentValue, null, false);

        // max_utangbank
        $this->max_utangbank->setDbValueDef($rsnew, $this->max_utangbank->CurrentValue, null, false);

        // skor_dokumentasi
        $this->skor_dokumentasi->setDbValueDef($rsnew, $this->skor_dokumentasi->CurrentValue, null, false);

        // max_dokumentasi
        $this->max_dokumentasi->setDbValueDef($rsnew, $this->max_dokumentasi->CurrentValue, null, false);

        // skor_nontunai
        $this->skor_nontunai->setDbValueDef($rsnew, $this->skor_nontunai->CurrentValue, null, false);

        // max_nontunai
        $this->max_nontunai->setDbValueDef($rsnew, $this->max_nontunai->CurrentValue, null, false);
