...
/**
 * Table class for report_data_usaha_bantul
 */
class ReportDataUsahaBantul extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'report_data_usaha_bantul';
        $this->TableName = 'report_data_usaha_bantul';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`report_data_usaha_bantul`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Kapanewon
        $this->Kapanewon = new DbField('report_data_usaha_bantul', 'report_data_usaha_bantul', 'x_Kapanewon', 'Kapanewon', '`Kapanewon`', '`Kapanewon`', 200, 255, -1, false, '`Kapanewon`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jumlah Usaha
        $this->jumlah_Usaha = new DbField('report_data_usaha_bantul', 'report_data_usaha_bantul', 'x_jumlah_Usaha', 'jumlah Usaha', '`jumlah Usaha`', '`jumlah Usaha`', 20, 21, -1, false, '`jumlah Usaha`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->tenaga_kerja_lakilaki = new DbField('report_data_usaha_bantul', 'report_data_usaha_bantul', 'x_tenaga_kerja_lakilaki', 'tenaga kerja laki-laki', '`tenaga kerja laki-laki`', '`tenaga kerja laki-laki`', 131, 25, -1, false, '`tenaga kerja laki-laki`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->Tenaga_Kerja_Perempuan = new DbField('report_data_usaha_bantul', 'report_data_usaha_bantul', 'x_Tenaga_Kerja_Perempuan', 'Tenaga Kerja Perempuan', '`Tenaga Kerja Perempuan`', '`Tenaga Kerja Perempuan`', 131, 25, -1, false, '`Tenaga Kerja Perempuan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // omset pertahun
        $this->omset_pertahun = new DbField('report_data_usaha_bantul', 'report_data_usaha_bantul', 'x_omset_pertahun', 'omset pertahun', '`omset pertahun`', '`omset pertahun`', 5, 23, -1, false, '`omset pertahun`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`report_data_usaha_bantul`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("reportdatausahabantullist");
    }
    ...
    {
        global $Language;
        if ($pageName == "reportdatausahabantulview") {
            return $Language->phrase("View");
        } elseif ($pageName == "reportdatausahabantuledit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "reportdatausahabantuladd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ReportDataUsahaBantulView";
            case Config("API_ADD_ACTION"):
                return "ReportDataUsahaBantulAdd";
            case Config("API_EDIT_ACTION"):
                return "ReportDataUsahaBantulEdit";
            case Config("API_DELETE_ACTION"):
                return "ReportDataUsahaBantulDelete";
            case Config("API_LIST_ACTION"):
                return "ReportDataUsahaBantulList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("reportdatausahabantulview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("reportdatausahabantulview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "reportdatausahabantuladd?" . $this->getUrlParm($parm);
        } else {
            $url = "reportdatausahabantuladd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("reportdatausahabantuledit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("reportdatausahabantuladd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("reportdatausahabantuldelete", $this->getUrlParm());
    }
