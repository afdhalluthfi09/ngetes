 ...
 * Page class
 */
class UmkmAspekproduksiLmDelete extends UmkmAspekproduksiLm
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UmkmAspekproduksiLmDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("umkmaspekproduksilmlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("umkmaspekproduksilmlist"); // Return to list
                return;
            }
        }
