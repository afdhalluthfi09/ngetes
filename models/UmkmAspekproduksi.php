...
/**
 * Table class for umkm_aspekproduksi
 */
class UmkmAspekproduksi extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'umkm_aspekproduksi';
        $this->TableName = 'umkm_aspekproduksi';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`umkm_aspekproduksi`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // NIK
        $this->NIK = new DbField('umkm_aspekproduksi', 'umkm_aspekproduksi', 'x_NIK', 'NIK', '`NIK`', '`NIK`', 200, 16, -1, false, '`NIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->PROD_FREKUENSIPRODUKSI = new DbField('umkm_aspekproduksi', 'umkm_aspekproduksi', 'x_PROD_FREKUENSIPRODUKSI', 'PROD_FREKUENSIPRODUKSI', '`PROD_FREKUENSIPRODUKSI`', '`PROD_FREKUENSIPRODUKSI`', 200, 50, -1, false, '`PROD_FREKUENSIPRODUKSI`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->PROD_FREKUENSIPRODUKSI->Sortable = true; // Allow sort
        $this->PROD_FREKUENSIPRODUKSI->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->PROD_FREKUENSIPRODUKSI->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->PROD_FREKUENSIPRODUKSI->Lookup = new Lookup('PROD_FREKUENSIPRODUKSI', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        ...
        // PROD_KAPASITAS
        $this->PROD_KAPASITAS = new DbField('umkm_aspekproduksi', 'umkm_aspekproduksi', 'x_PROD_KAPASITAS', 'PROD_KAPASITAS', '`PROD_KAPASITAS`', '`PROD_KAPASITAS`', 200, 50, -1, false, '`PROD_KAPASITAS`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->PROD_KAPASITAS->Sortable = true; // Allow sort
        $this->PROD_KAPASITAS->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->PROD_KAPASITAS->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->PROD_KAPASITAS->Lookup = new Lookup('PROD_KAPASITAS', 'umkm_variabel', false, 'variabel', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        ...
        // PROD_KEAMANANPANGAN
        $this->PROD_KEAMANANPANGAN = new DbField('umkm_aspekproduksi', 'umkm_aspekproduksi', 'x_PROD_KEAMANANPANGAN', 'PROD_KEAMANANPANGAN', '`PROD_KEAMANANPANGAN`', '`PROD_KEAMANANPANGAN`', 200, 50, -1, false, '`PROD_KEAMANANPANGAN`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->PROD_KEAMANANPANGAN->Sortable = true; // Allow sort
        $this->PROD_KEAMANANPANGAN->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->PROD_KEAMANANPANGAN->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->PROD_KEAMANANPANGAN->Lookup = new Lookup('PROD_KEAMANANPANGAN', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        ...
        // PROD_SNI
        $this->PROD_SNI = new DbField('umkm_aspekproduksi', 'umkm_aspekproduksi', 'x_PROD_SNI', 'PROD_SNI', '`PROD_SNI`', '`PROD_SNI`', 200, 50, -1, false, '`PROD_SNI`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->PROD_SNI->Sortable = true; // Allow sort
        $this->PROD_SNI->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->PROD_SNI->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->PROD_SNI->Lookup = new Lookup('PROD_SNI', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        ...
        // PROD_KEMASAN
        $this->PROD_KEMASAN = new DbField('umkm_aspekproduksi', 'umkm_aspekproduksi', 'x_PROD_KEMASAN', 'PROD_KEMASAN', '`PROD_KEMASAN`', '`PROD_KEMASAN`', 200, 50, -1, false, '`PROD_KEMASAN`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->PROD_KEMASAN->Sortable = true; // Allow sort
        $this->PROD_KEMASAN->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->PROD_KEMASAN->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->PROD_KEMASAN->Lookup = new Lookup('PROD_KEMASAN', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        ...
        $this->PROD_KETERSEDIAANBAHANBAKU = new DbField('umkm_aspekproduksi', 'umkm_aspekproduksi', 'x_PROD_KETERSEDIAANBAHANBAKU', 'PROD_KETERSEDIAANBAHANBAKU', '`PROD_KETERSEDIAANBAHANBAKU`', '`PROD_KETERSEDIAANBAHANBAKU`', 200, 50, -1, false, '`PROD_KETERSEDIAANBAHANBAKU`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->PROD_KETERSEDIAANBAHANBAKU->Sortable = true; // Allow sort
        $this->PROD_KETERSEDIAANBAHANBAKU->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->PROD_KETERSEDIAANBAHANBAKU->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->PROD_KETERSEDIAANBAHANBAKU->Lookup = new Lookup('PROD_KETERSEDIAANBAHANBAKU', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        ...
        // PROD_ALATPRODUKSI
        $this->PROD_ALATPRODUKSI = new DbField('umkm_aspekproduksi', 'umkm_aspekproduksi', 'x_PROD_ALATPRODUKSI', 'PROD_ALATPRODUKSI', '`PROD_ALATPRODUKSI`', '`PROD_ALATPRODUKSI`', 200, 50, -1, false, '`PROD_ALATPRODUKSI`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->PROD_ALATPRODUKSI->Sortable = true; // Allow sort
        $this->PROD_ALATPRODUKSI->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->PROD_ALATPRODUKSI->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->PROD_ALATPRODUKSI->Lookup = new Lookup('PROD_ALATPRODUKSI', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        ...
        $this->PROD_GUDANGPENYIMPAN = new DbField('umkm_aspekproduksi', 'umkm_aspekproduksi', 'x_PROD_GUDANGPENYIMPAN', 'PROD_GUDANGPENYIMPAN', '`PROD_GUDANGPENYIMPAN`', '`PROD_GUDANGPENYIMPAN`', 200, 50, -1, false, '`PROD_GUDANGPENYIMPAN`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->PROD_GUDANGPENYIMPAN->Sortable = true; // Allow sort
        $this->PROD_GUDANGPENYIMPAN->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->PROD_GUDANGPENYIMPAN->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->PROD_GUDANGPENYIMPAN->Lookup = new Lookup('PROD_GUDANGPENYIMPAN', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        ...
        // PROD_LAYOUTPRODUKSI
        $this->PROD_LAYOUTPRODUKSI = new DbField('umkm_aspekproduksi', 'umkm_aspekproduksi', 'x_PROD_LAYOUTPRODUKSI', 'PROD_LAYOUTPRODUKSI', '`PROD_LAYOUTPRODUKSI`', '`PROD_LAYOUTPRODUKSI`', 200, 50, -1, false, '`PROD_LAYOUTPRODUKSI`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->PROD_LAYOUTPRODUKSI->Sortable = true; // Allow sort
        $this->PROD_LAYOUTPRODUKSI->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->PROD_LAYOUTPRODUKSI->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->PROD_LAYOUTPRODUKSI->Lookup = new Lookup('PROD_LAYOUTPRODUKSI', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
        ...
        // PROD_SOP
        $this->PROD_SOP = new DbField('umkm_aspekproduksi', 'umkm_aspekproduksi', 'x_PROD_SOP', 'PROD_SOP', '`PROD_SOP`', '`PROD_SOP`', 200, 50, -1, false, '`PROD_SOP`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->PROD_SOP->Sortable = true; // Allow sort
        $this->PROD_SOP->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->PROD_SOP->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->PROD_SOP->Lookup = new Lookup('PROD_SOP', 'umkm_variabel', false, 'id', ["variabel","","",""], [], [], [], [], [], [], '`id` ASC', '');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`umkm_aspekproduksi`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("umkmaspekproduksilist");
    }
    ...
    {
        global $Language;
        if ($pageName == "umkmaspekproduksiview") {
            return $Language->phrase("View");
        } elseif ($pageName == "umkmaspekproduksiedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "umkmaspekproduksiadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "UmkmAspekproduksiView";
            case Config("API_ADD_ACTION"):
                return "UmkmAspekproduksiAdd";
            case Config("API_EDIT_ACTION"):
                return "UmkmAspekproduksiEdit";
            case Config("API_DELETE_ACTION"):
                return "UmkmAspekproduksiDelete";
            case Config("API_LIST_ACTION"):
                return "UmkmAspekproduksiList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("umkmaspekproduksiview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("umkmaspekproduksiview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "umkmaspekproduksiadd?" . $this->getUrlParm($parm);
        } else {
            $url = "umkmaspekproduksiadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmaspekproduksiedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmaspekproduksiadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("umkmaspekproduksidelete", $this->getUrlParm());
    }
