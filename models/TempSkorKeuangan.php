...
/**
 * Table class for temp_skor_keuangan
 */
class TempSkorKeuangan extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'temp_skor_keuangan';
        $this->TableName = 'temp_skor_keuangan';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`temp_skor_keuangan`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // nik
        $this->nik = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_nik', 'nik', '`nik`', '`nik`', 200, 16, -1, false, '`nik`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_income
        $this->skor_income = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_skor_income', 'skor_income', '`skor_income`', '`skor_income`', 5, 23, -1, false, '`skor_income`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_income
        $this->max_income = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_max_income', 'max_income', '`max_income`', '`max_income`', 5, 23, -1, false, '`max_income`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_pengelolaan
        $this->skor_pengelolaan = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_skor_pengelolaan', 'skor_pengelolaan', '`skor_pengelolaan`', '`skor_pengelolaan`', 5, 23, -1, false, '`skor_pengelolaan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_pengelolaan
        $this->max_pengelolaan = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_max_pengelolaan', 'max_pengelolaan', '`max_pengelolaan`', '`max_pengelolaan`', 5, 23, -1, false, '`max_pengelolaan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_nota
        $this->skor_nota = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_skor_nota', 'skor_nota', '`skor_nota`', '`skor_nota`', 5, 23, -1, false, '`skor_nota`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_nota
        $this->max_nota = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_max_nota', 'max_nota', '`max_nota`', '`max_nota`', 5, 23, -1, false, '`max_nota`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_jurnal
        $this->skor_jurnal = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_skor_jurnal', 'skor_jurnal', '`skor_jurnal`', '`skor_jurnal`', 5, 23, -1, false, '`skor_jurnal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_jurnal
        $this->max_jurnal = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_max_jurnal', 'max_jurnal', '`max_jurnal`', '`max_jurnal`', 5, 23, -1, false, '`max_jurnal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_akutansi
        $this->skor_akutansi = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_skor_akutansi', 'skor_akutansi', '`skor_akutansi`', '`skor_akutansi`', 5, 23, -1, false, '`skor_akutansi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_akutansi
        $this->max_akutansi = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_max_akutansi', 'max_akutansi', '`max_akutansi`', '`max_akutansi`', 5, 23, -1, false, '`max_akutansi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_utangbank
        $this->skor_utangbank = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_skor_utangbank', 'skor_utangbank', '`skor_utangbank`', '`skor_utangbank`', 5, 23, -1, false, '`skor_utangbank`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_utangbank
        $this->max_utangbank = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_max_utangbank', 'max_utangbank', '`max_utangbank`', '`max_utangbank`', 5, 23, -1, false, '`max_utangbank`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_dokumentasi
        $this->skor_dokumentasi = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_skor_dokumentasi', 'skor_dokumentasi', '`skor_dokumentasi`', '`skor_dokumentasi`', 5, 23, -1, false, '`skor_dokumentasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_dokumentasi
        $this->max_dokumentasi = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_max_dokumentasi', 'max_dokumentasi', '`max_dokumentasi`', '`max_dokumentasi`', 5, 23, -1, false, '`max_dokumentasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_nontunai
        $this->skor_nontunai = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_skor_nontunai', 'skor_nontunai', '`skor_nontunai`', '`skor_nontunai`', 5, 23, -1, false, '`skor_nontunai`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_nontunai
        $this->max_nontunai = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_max_nontunai', 'max_nontunai', '`max_nontunai`', '`max_nontunai`', 5, 23, -1, false, '`max_nontunai`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_keuangan
        $this->skor_keuangan = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_skor_keuangan', 'skor_keuangan', '`skor_keuangan`', '`skor_keuangan`', 5, 23, -1, false, '`skor_keuangan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // maxskor_keuangan
        $this->maxskor_keuangan = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_maxskor_keuangan', 'maxskor_keuangan', '`maxskor_keuangan`', '`maxskor_keuangan`', 5, 23, -1, false, '`maxskor_keuangan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // bobot_keuangan
        $this->bobot_keuangan = new DbField('temp_skor_keuangan', 'temp_skor_keuangan', 'x_bobot_keuangan', 'bobot_keuangan', '`bobot_keuangan`', '`bobot_keuangan`', 3, 2, -1, false, '`bobot_keuangan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`temp_skor_keuangan`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("tempskorkeuanganlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "tempskorkeuanganedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "tempskorkeuanganadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TempSkorKeuanganView";
            case Config("API_ADD_ACTION"):
                return "TempSkorKeuanganAdd";
            case Config("API_EDIT_ACTION"):
                return "TempSkorKeuanganEdit";
            case Config("API_DELETE_ACTION"):
                return "TempSkorKeuanganDelete";
            case Config("API_LIST_ACTION"):
                return "TempSkorKeuanganList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("tempskorkeuanganview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("tempskorkeuanganview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "tempskorkeuanganadd?" . $this->getUrlParm($parm);
        } else {
            $url = "tempskorkeuanganadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("tempskorkeuanganedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("tempskorkeuanganadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("tempskorkeuangandelete", $this->getUrlParm());
    }
