...
/**
 * Table class for temp_skor_produksi
 */
class TempSkorProduksi extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'temp_skor_produksi';
        $this->TableName = 'temp_skor_produksi';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`temp_skor_produksi`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // nik
        $this->nik = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_nik', 'nik', '`nik`', '`nik`', 200, 16, -1, false, '`nik`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_aktifitas
        $this->skor_aktifitas = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_skor_aktifitas', 'skor_aktifitas', '`skor_aktifitas`', '`skor_aktifitas`', 5, 23, -1, false, '`skor_aktifitas`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_aktifitas
        $this->max_aktifitas = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_max_aktifitas', 'max_aktifitas', '`max_aktifitas`', '`max_aktifitas`', 5, 23, -1, false, '`max_aktifitas`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_kapasitas
        $this->skor_kapasitas = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_skor_kapasitas', 'skor_kapasitas', '`skor_kapasitas`', '`skor_kapasitas`', 5, 23, -1, false, '`skor_kapasitas`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_kapasitas
        $this->max_kapasitas = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_max_kapasitas', 'max_kapasitas', '`max_kapasitas`', '`max_kapasitas`', 5, 23, -1, false, '`max_kapasitas`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_pangan
        $this->skor_pangan = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_skor_pangan', 'skor_pangan', '`skor_pangan`', '`skor_pangan`', 5, 23, -1, false, '`skor_pangan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_pangan
        $this->max_pangan = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_max_pangan', 'max_pangan', '`max_pangan`', '`max_pangan`', 5, 23, -1, false, '`max_pangan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_sni
        $this->skor_sni = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_skor_sni', 'skor_sni', '`skor_sni`', '`skor_sni`', 5, 23, -1, false, '`skor_sni`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_sni
        $this->max_sni = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_max_sni', 'max_sni', '`max_sni`', '`max_sni`', 5, 23, -1, false, '`max_sni`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_kemasan
        $this->skor_kemasan = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_skor_kemasan', 'skor_kemasan', '`skor_kemasan`', '`skor_kemasan`', 5, 23, -1, false, '`skor_kemasan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_kemasan
        $this->max_kemasan = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_max_kemasan', 'max_kemasan', '`max_kemasan`', '`max_kemasan`', 5, 23, -1, false, '`max_kemasan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_bahanbaku
        $this->skor_bahanbaku = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_skor_bahanbaku', 'skor_bahanbaku', '`skor_bahanbaku`', '`skor_bahanbaku`', 5, 23, -1, false, '`skor_bahanbaku`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_bahanbaku
        $this->max_bahanbaku = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_max_bahanbaku', 'max_bahanbaku', '`max_bahanbaku`', '`max_bahanbaku`', 5, 23, -1, false, '`max_bahanbaku`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_alat
        $this->skor_alat = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_skor_alat', 'skor_alat', '`skor_alat`', '`skor_alat`', 5, 23, -1, false, '`skor_alat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_alat
        $this->max_alat = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_max_alat', 'max_alat', '`max_alat`', '`max_alat`', 5, 23, -1, false, '`max_alat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_gudang
        $this->skor_gudang = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_skor_gudang', 'skor_gudang', '`skor_gudang`', '`skor_gudang`', 5, 23, -1, false, '`skor_gudang`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_gudang
        $this->max_gudang = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_max_gudang', 'max_gudang', '`max_gudang`', '`max_gudang`', 5, 23, -1, false, '`max_gudang`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_layout
        $this->skor_layout = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_skor_layout', 'skor_layout', '`skor_layout`', '`skor_layout`', 5, 23, -1, false, '`skor_layout`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_layout
        $this->max_layout = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_max_layout', 'max_layout', '`max_layout`', '`max_layout`', 5, 23, -1, false, '`max_layout`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_sop
        $this->skor_sop = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_skor_sop', 'skor_sop', '`skor_sop`', '`skor_sop`', 5, 23, -1, false, '`skor_sop`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // max_sop
        $this->max_sop = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_max_sop', 'max_sop', '`max_sop`', '`max_sop`', 5, 23, -1, false, '`max_sop`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // skor_produksi
        $this->skor_produksi = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_skor_produksi', 'skor_produksi', '`skor_produksi`', '`skor_produksi`', 5, 23, -1, false, '`skor_produksi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // maxskor_produksi
        $this->maxskor_produksi = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_maxskor_produksi', 'maxskor_produksi', '`maxskor_produksi`', '`maxskor_produksi`', 5, 23, -1, false, '`maxskor_produksi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // bobot_produksi
        $this->bobot_produksi = new DbField('temp_skor_produksi', 'temp_skor_produksi', 'x_bobot_produksi', 'bobot_produksi', '`bobot_produksi`', '`bobot_produksi`', 3, 2, -1, false, '`bobot_produksi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`temp_skor_produksi`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("tempskorproduksilist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "tempskorproduksiedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "tempskorproduksiadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TempSkorProduksiView";
            case Config("API_ADD_ACTION"):
                return "TempSkorProduksiAdd";
            case Config("API_EDIT_ACTION"):
                return "TempSkorProduksiEdit";
            case Config("API_DELETE_ACTION"):
                return "TempSkorProduksiDelete";
            case Config("API_LIST_ACTION"):
                return "TempSkorProduksiList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("tempskorproduksiview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("tempskorproduksiview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "tempskorproduksiadd?" . $this->getUrlParm($parm);
        } else {
            $url = "tempskorproduksiadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("tempskorproduksiedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("tempskorproduksiadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("tempskorproduksidelete", $this->getUrlParm());
    }
