...
/**
 * Table class for Produk Tidak Lolos Kurasi
 */
class ProdukTidakLolosKurasi extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'Produk_Tidak_Lolos_Kurasi';
        $this->TableName = 'Produk Tidak Lolos Kurasi';
        ...
        // id
        $this->id = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_id', 'id', 'a.id', 'a.id', 3, 11, -1, false, 'a.id', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // produk_foto
        $this->produk_foto = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_produk_foto', 'produk_foto', 'a.produk_foto', 'a.produk_foto', 200, 50, -1, false, 'a.produk_foto', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nik_ukm
        $this->nik_ukm = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_nik_ukm', 'nik_ukm', 'a.nik_ukm', 'a.nik_ukm', 200, 16, -1, false, 'a.nik_ukm', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_nama
        $this->produk_nama = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_produk_nama', 'produk_nama', 'a.produk_nama', 'a.produk_nama', 200, 50, -1, false, 'a.produk_nama', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_jenis
        $this->produk_jenis = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_produk_jenis', 'produk_jenis', 'a.produk_jenis', 'a.produk_jenis', 200, 50, -1, false, 'a.produk_jenis', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_desc
        $this->produk_desc = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_produk_desc', 'produk_desc', 'a.produk_desc', 'a.produk_desc', 201, 65535, -1, false, 'a.produk_desc', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // produk_harga
        $this->produk_harga = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_produk_harga', 'produk_harga', 'a.produk_harga', 'a.produk_harga', 5, 22, -1, false, 'a.produk_harga', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kurator
        $this->kurator = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_kurator', 'kurator', 'a.kurator', 'a.kurator', 200, 50, -1, false, 'a.kurator', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_legal
        $this->produk_legal = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_produk_legal', 'produk_legal', 'a.produk_legal', 'a.produk_legal', 2, 1, -1, false, 'a.produk_legal', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->produk_legal->Sortable = false; // Allow sort
        $this->produk_legal->Lookup = new Lookup('produk_legal', 'Produk_Tidak_Lolos_Kurasi', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // judul_sesuai
        $this->judul_sesuai = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_judul_sesuai', 'judul_sesuai', 'a.judul_sesuai', 'a.judul_sesuai', 2, 1, -1, false, 'a.judul_sesuai', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->judul_sesuai->Sortable = false; // Allow sort
        $this->judul_sesuai->Lookup = new Lookup('judul_sesuai', 'Produk_Tidak_Lolos_Kurasi', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // foto_bagus
        $this->foto_bagus = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_foto_bagus', 'foto_bagus', 'a.foto_bagus', 'a.foto_bagus', 2, 1, -1, false, 'a.foto_bagus', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->foto_bagus->Sortable = false; // Allow sort
        $this->foto_bagus->Lookup = new Lookup('foto_bagus', 'Produk_Tidak_Lolos_Kurasi', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // deskripsi_jelas
        $this->deskripsi_jelas = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_deskripsi_jelas', 'deskripsi_jelas', 'a.deskripsi_jelas', 'a.deskripsi_jelas', 2, 1, -1, false, 'a.deskripsi_jelas', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->deskripsi_jelas->Sortable = false; // Allow sort
        $this->deskripsi_jelas->Lookup = new Lookup('deskripsi_jelas', 'Produk_Tidak_Lolos_Kurasi', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // harga_tidak_kosong
        $this->harga_tidak_kosong = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_harga_tidak_kosong', 'harga_tidak_kosong', 'a.harga_tidak_kosong', 'a.harga_tidak_kosong', 2, 1, -1, false, 'a.harga_tidak_kosong', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->harga_tidak_kosong->Sortable = false; // Allow sort
        $this->harga_tidak_kosong->Lookup = new Lookup('harga_tidak_kosong', 'Produk_Tidak_Lolos_Kurasi', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // berat_tidak_kosong
        $this->berat_tidak_kosong = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_berat_tidak_kosong', 'berat_tidak_kosong', 'a.berat_tidak_kosong', 'a.berat_tidak_kosong', 2, 1, -1, false, 'a.berat_tidak_kosong', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->berat_tidak_kosong->Sortable = false; // Allow sort
        $this->berat_tidak_kosong->Lookup = new Lookup('berat_tidak_kosong', 'Produk_Tidak_Lolos_Kurasi', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // produk_foto_1
        $this->produk_foto_1 = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_produk_foto_1', 'produk_foto_1', 'a.produk_foto_1', 'a.produk_foto_1', 200, 50, -1, true, 'a.produk_foto_1', false, false, false, 'IMAGE', 'FILE');
        ...
        // produk_foto_2
        $this->produk_foto_2 = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_produk_foto_2', 'produk_foto_2', 'a.produk_foto_2', 'a.produk_foto_2', 200, 50, -1, true, 'a.produk_foto_2', false, false, false, 'IMAGE', 'FILE');
        ...
        // produk_foto_3
        $this->produk_foto_3 = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_produk_foto_3', 'produk_foto_3', 'a.produk_foto_3', 'a.produk_foto_3', 200, 50, -1, true, 'a.produk_foto_3', false, false, false, 'IMAGE', 'FILE');
        ...
        // produk_berat
        $this->produk_berat = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_produk_berat', 'produk_berat', 'a.produk_berat', 'a.produk_berat', 4, 12, -1, false, 'a.produk_berat', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_panjang
        $this->produk_panjang = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_produk_panjang', 'produk_panjang', 'a.produk_panjang', 'a.produk_panjang', 4, 12, -1, false, 'a.produk_panjang', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_lebar
        $this->produk_lebar = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_produk_lebar', 'produk_lebar', 'a.produk_lebar', 'a.produk_lebar', 4, 12, -1, false, 'a.produk_lebar', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // produk_tinggi
        $this->produk_tinggi = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_produk_tinggi', 'produk_tinggi', 'a.produk_tinggi', 'a.produk_tinggi', 4, 12, -1, false, 'a.produk_tinggi', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // waktu_kurasi
        $this->waktu_kurasi = new DbField('Produk_Tidak_Lolos_Kurasi', 'Produk Tidak Lolos Kurasi', 'x_waktu_kurasi', 'waktu_kurasi', 'a.waktu_kurasi', CastDateFieldForLike("a.waktu_kurasi", 0, "DB"), 135, 19, 0, false, 'a.waktu_kurasi', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("a.id, a.produk_foto, a.nik_ukm, a.produk_nama, a.produk_jenis, a.produk_desc, a.produk_harga, a.kurator, a.produk_legal, a.judul_sesuai, a.foto_bagus, a.deskripsi_jelas, a.harga_tidak_kosong, a.berat_tidak_kosong, a.produk_foto_1, a.produk_foto_2, a.produk_foto_3, a.produk_berat, a.produk_panjang, a.produk_lebar, a.produk_tinggi, a.waktu_kurasi");
    }
    ...
    {
        $where = ($this->SqlWhere != "") ? $this->SqlWhere : "a.kurasi = 'P'";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("produktidakloloskurasilist");
    }
    ...
    {
        global $Language;
        if ($pageName == "produktidakloloskurasiview") {
            return $Language->phrase("View");
        } elseif ($pageName == "produktidakloloskurasiedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "produktidakloloskurasiadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ProdukTidakLolosKurasiView";
            case Config("API_ADD_ACTION"):
                return "ProdukTidakLolosKurasiAdd";
            case Config("API_EDIT_ACTION"):
                return "ProdukTidakLolosKurasiEdit";
            case Config("API_DELETE_ACTION"):
                return "ProdukTidakLolosKurasiDelete";
            case Config("API_LIST_ACTION"):
                return "ProdukTidakLolosKurasiList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("produktidakloloskurasiview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("produktidakloloskurasiview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "produktidakloloskurasiadd?" . $this->getUrlParm($parm);
        } else {
            $url = "produktidakloloskurasiadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("produktidakloloskurasiedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("produktidakloloskurasiadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("produktidakloloskurasidelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        if ($this->produk_foto_1->UseColorbox) {
            ...
            $this->produk_foto_1->LinkAttrs["data-rel"] = "Produk_Tidak_Lolos_Kurasi_x_produk_foto_1";
        ...
        if ($this->produk_foto_2->UseColorbox) {
            ...
            $this->produk_foto_2->LinkAttrs["data-rel"] = "Produk_Tidak_Lolos_Kurasi_x_produk_foto_2";
        ...
        if ($this->produk_foto_3->UseColorbox) {
            ...
            $this->produk_foto_3->LinkAttrs["data-rel"] = "Produk_Tidak_Lolos_Kurasi_x_produk_foto_3";
