 ...
 * Page class
 */
class PeriodeDataDelete extends PeriodeData
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeriodeDataDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("periodedatalist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("periodedatalist"); // Return to list
                return;
            }
        }
