...
/**
 * Table class for kop_keragaan_bykelompok
 */
class KopKeragaanBykelompok extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'kop_keragaan_bykelompok';
        $this->TableName = 'kop_keragaan_bykelompok';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`kop_keragaan_bykelompok`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Tahun_Periode
        $this->Tahun_Periode = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Tahun_Periode', 'Tahun_Periode', '`Tahun_Periode`', '`Tahun_Periode`', 3, 4, -1, false, '`Tahun_Periode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Periode
        $this->Periode = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Periode', 'Periode', '`Periode`', '`Periode`', 3, 1, -1, false, '`Periode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Kelompok_Koperasi
        $this->Kelompok_Koperasi = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Kelompok_Koperasi', 'Kelompok_Koperasi', '`Kelompok_Koperasi`', '`Kelompok_Koperasi`', 200, 200, -1, false, '`Kelompok_Koperasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Jumlah_Koperasi
        $this->Jumlah_Koperasi = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Jumlah_Koperasi', 'Jumlah_Koperasi', '`Jumlah_Koperasi`', '`Jumlah_Koperasi`', 5, 23, -1, false, '`Jumlah_Koperasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Aktif
        $this->Aktif = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Aktif', 'Aktif', '`Aktif`', '`Aktif`', 5, 23, -1, false, '`Aktif`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pasif
        $this->Pasif = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Pasif', 'Pasif', '`Pasif`', '`Pasif`', 5, 23, -1, false, '`Pasif`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Jumlah_Anggota
        $this->Jumlah_Anggota = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Jumlah_Anggota', 'Jumlah_Anggota', '`Jumlah_Anggota`', '`Jumlah_Anggota`', 131, 32, -1, false, '`Jumlah_Anggota`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Anggota_Laki-laki
        $this->Anggota_Lakilaki = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Anggota_Lakilaki', 'Anggota_Laki-laki', '`Anggota_Laki-laki`', '`Anggota_Laki-laki`', 131, 32, -1, false, '`Anggota_Laki-laki`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Anggota_Perempuan
        $this->Anggota_Perempuan = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Anggota_Perempuan', 'Anggota_Perempuan', '`Anggota_Perempuan`', '`Anggota_Perempuan`', 131, 32, -1, false, '`Anggota_Perempuan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Jumlah_Manajer
        $this->Jumlah_Manajer = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Jumlah_Manajer', 'Jumlah_Manajer', '`Jumlah_Manajer`', '`Jumlah_Manajer`', 131, 32, -1, false, '`Jumlah_Manajer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Manajer_Laki-laki
        $this->Manajer_Lakilaki = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Manajer_Lakilaki', 'Manajer_Laki-laki', '`Manajer_Laki-laki`', '`Manajer_Laki-laki`', 131, 32, -1, false, '`Manajer_Laki-laki`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Manajer_Perempuan
        $this->Manajer_Perempuan = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Manajer_Perempuan', 'Manajer_Perempuan', '`Manajer_Perempuan`', '`Manajer_Perempuan`', 131, 32, -1, false, '`Manajer_Perempuan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Jumlah_Karyawan
        $this->Jumlah_Karyawan = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Jumlah_Karyawan', 'Jumlah_Karyawan', '`Jumlah_Karyawan`', '`Jumlah_Karyawan`', 131, 32, -1, false, '`Jumlah_Karyawan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Karyawan_Laki-laki
        $this->Karyawan_Lakilaki = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Karyawan_Lakilaki', 'Karyawan_Laki-laki', '`Karyawan_Laki-laki`', '`Karyawan_Laki-laki`', 131, 32, -1, false, '`Karyawan_Laki-laki`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Karyawan_Perempuan
        $this->Karyawan_Perempuan = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Karyawan_Perempuan', 'Karyawan_Perempuan', '`Karyawan_Perempuan`', '`Karyawan_Perempuan`', 131, 32, -1, false, '`Karyawan_Perempuan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RAT
        $this->RAT = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_RAT', 'RAT', '`RAT`', '`RAT`', 131, 22, -1, false, '`RAT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->Jumlah_Modal_Sendiri = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Jumlah_Modal_Sendiri', 'Jumlah_Modal_Sendiri', '`Jumlah_Modal_Sendiri`', '`Jumlah_Modal_Sendiri`', 5, 23, -1, false, '`Jumlah_Modal_Sendiri`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Jumlah_Modal_Luar
        $this->Jumlah_Modal_Luar = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Jumlah_Modal_Luar', 'Jumlah_Modal_Luar', '`Jumlah_Modal_Luar`', '`Jumlah_Modal_Luar`', 5, 23, -1, false, '`Jumlah_Modal_Luar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Jumlah_Volume_Usaha
        $this->Jumlah_Volume_Usaha = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Jumlah_Volume_Usaha', 'Jumlah_Volume_Usaha', '`Jumlah_Volume_Usaha`', '`Jumlah_Volume_Usaha`', 5, 23, -1, false, '`Jumlah_Volume_Usaha`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SHU
        $this->SHU = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_SHU', 'SHU', '`SHU`', '`SHU`', 5, 23, -1, false, '`SHU`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Aset
        $this->Aset = new DbField('kop_keragaan_bykelompok', 'kop_keragaan_bykelompok', 'x_Aset', 'Aset', '`Aset`', '`Aset`', 5, 23, -1, false, '`Aset`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`kop_keragaan_bykelompok`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("kopkeragaanbykelompoklist");
    }
    ...
    {
        global $Language;
        if ($pageName == "kopkeragaanbykelompokview") {
            return $Language->phrase("View");
        } elseif ($pageName == "kopkeragaanbykelompokedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "kopkeragaanbykelompokadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "KopKeragaanBykelompokView";
            case Config("API_ADD_ACTION"):
                return "KopKeragaanBykelompokAdd";
            case Config("API_EDIT_ACTION"):
                return "KopKeragaanBykelompokEdit";
            case Config("API_DELETE_ACTION"):
                return "KopKeragaanBykelompokDelete";
            case Config("API_LIST_ACTION"):
                return "KopKeragaanBykelompokList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("kopkeragaanbykelompokview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("kopkeragaanbykelompokview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "kopkeragaanbykelompokadd?" . $this->getUrlParm($parm);
        } else {
            $url = "kopkeragaanbykelompokadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kopkeragaanbykelompokedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("kopkeragaanbykelompokadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("kopkeragaanbykelompokdelete", $this->getUrlParm());
    }
