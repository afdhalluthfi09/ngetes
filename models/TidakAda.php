...
/**
 * Table class for tidak ada
 */
class TidakAda extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'tidak_ada';
        $this->TableName = 'tidak ada';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`tidak ada`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // NIK
        $this->NIK = new DbField('tidak_ada', 'tidak ada', 'x_NIK', 'NIK', '`NIK`', '`NIK`', 200, 16, -1, false, '`NIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA_PEMILIK
        $this->NAMA_PEMILIK = new DbField('tidak_ada', 'tidak ada', 'x_NAMA_PEMILIK', 'NAMA_PEMILIK', '`NAMA_PEMILIK`', '`NAMA_PEMILIK`', 200, 100, -1, false, '`NAMA_PEMILIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // JENIS_KELAMIN
        $this->JENIS_KELAMIN = new DbField('tidak_ada', 'tidak ada', 'x_JENIS_KELAMIN', 'JENIS_KELAMIN', '`JENIS_KELAMIN`', '`JENIS_KELAMIN`', 200, 10, -1, false, '`JENIS_KELAMIN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ALAMAT
        $this->ALAMAT = new DbField('tidak_ada', 'tidak ada', 'x_ALAMAT', 'ALAMAT', '`ALAMAT`', '`ALAMAT`', 201, 65535, -1, false, '`ALAMAT`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->ALAMAT->Sortable = true; // Allow sort
        $this->ALAMAT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ALAMAT->Param, "CustomMsg");
        $this->Fields['ALAMAT'] = &$this->ALAMAT;

        // DUSUN
        $this->DUSUN = new DbField('tidak_ada', 'tidak ada', 'x_DUSUN', 'DUSUN', '`DUSUN`', '`DUSUN`', 200, 50, -1, false, '`DUSUN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KALURAHAN
        $this->KALURAHAN = new DbField('tidak_ada', 'tidak ada', 'x_KALURAHAN', 'KALURAHAN', '`KALURAHAN`', '`KALURAHAN`', 200, 50, -1, false, '`KALURAHAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KAPANEWON
        $this->KAPANEWON = new DbField('tidak_ada', 'tidak ada', 'x_KAPANEWON', 'KAPANEWON', '`KAPANEWON`', '`KAPANEWON`', 200, 50, -1, false, '`KAPANEWON`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMAIL
        $this->_EMAIL = new DbField('tidak_ada', 'tidak ada', 'x__EMAIL', 'EMAIL', '`EMAIL`', '`EMAIL`', 200, 100, -1, false, '`EMAIL`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->_EMAIL->Sortable = true; // Allow sort
        $this->_EMAIL->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->_EMAIL->Param, "CustomMsg");
        $this->Fields['EMAIL'] = &$this->_EMAIL;

        // PASSWORD
        $this->_PASSWORD = new DbField('tidak_ada', 'tidak ada', 'x__PASSWORD', 'PASSWORD', '`PASSWORD`', '`PASSWORD`', 200, 255, -1, false, '`PASSWORD`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AKTIVASI
        $this->AKTIVASI = new DbField('tidak_ada', 'tidak ada', 'x_AKTIVASI', 'AKTIVASI', '`AKTIVASI`', '`AKTIVASI`', 200, 100, -1, false, '`AKTIVASI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->AKTIVASI->Sortable = true; // Allow sort
        ...
        // PROFIL
        $this->PROFIL = new DbField('tidak_ada', 'tidak ada', 'x_PROFIL', 'PROFIL', '`PROFIL`', '`PROFIL`', 201, 65535, -1, false, '`PROFIL`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->PROFIL->Sortable = true; // Allow sort
        $this->PROFIL->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PROFIL->Param, "CustomMsg");
        $this->Fields['PROFIL'] = &$this->PROFIL;

        // NO_HP
        $this->NO_HP = new DbField('tidak_ada', 'tidak ada', 'x_NO_HP', 'NO_HP', '`NO_HP`', '`NO_HP`', 200, 20, -1, false, '`NO_HP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`tidak ada`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("tidakadalist");
    }
    ...
    {
        global $Language;
        if ($pageName == "tidakadaview") {
            return $Language->phrase("View");
        } elseif ($pageName == "tidakadaedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "tidakadaadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("tidakadaview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("tidakadaview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "tidakadaadd?" . $this->getUrlParm($parm);
        } else {
            $url = "tidakadaadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("tidakadaedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("tidakadaadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("tidakadadelete", $this->getUrlParm());
    }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->AKTIVASI);
                    $doc->exportCaption($this->PROFIL);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->AKTIVASI);
                        $doc->exportField($this->PROFIL);
