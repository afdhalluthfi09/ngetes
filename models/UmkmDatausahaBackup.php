...
/**
 * Table class for umkm_datausaha_backup
 */
class UmkmDatausahaBackup extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'umkm_datausaha_backup';
        $this->TableName = 'umkm_datausaha_backup';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`umkm_datausaha_backup`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // NIK
        $this->NIK = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_NIK', 'NIK', '`NIK`', '`NIK`', 200, 16, -1, false, '`NIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA_USAHA
        $this->NAMA_USAHA = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_NAMA_USAHA', 'NAMA_USAHA', '`NAMA_USAHA`', '`NAMA_USAHA`', 200, 100, -1, false, '`NAMA_USAHA`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAHUN_MULAI_USAHA
        $this->TAHUN_MULAI_USAHA = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_TAHUN_MULAI_USAHA', 'TAHUN_MULAI_USAHA', '`TAHUN_MULAI_USAHA`', '`TAHUN_MULAI_USAHA`', 200, 10, -1, false, '`TAHUN_MULAI_USAHA`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ALAMAT
        $this->ALAMAT = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_ALAMAT', 'ALAMAT', '`ALAMAT`', '`ALAMAT`', 200, 255, -1, false, '`ALAMAT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ALAMAT->Sortable = true; // Allow sort
        $this->ALAMAT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ALAMAT->Param, "CustomMsg");
        $this->Fields['ALAMAT'] = &$this->ALAMAT;

        // DUSUN
        $this->DUSUN = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_DUSUN', 'DUSUN', '`DUSUN`', '`DUSUN`', 200, 50, -1, false, '`DUSUN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KALURAHAN
        $this->KALURAHAN = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_KALURAHAN', 'KALURAHAN', '`KALURAHAN`', '`KALURAHAN`', 200, 50, -1, false, '`KALURAHAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KAPANEWON
        $this->KAPANEWON = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_KAPANEWON', 'KAPANEWON', '`KAPANEWON`', '`KAPANEWON`', 200, 50, -1, false, '`KAPANEWON`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_USAHA
        $this->STATUS_USAHA = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_STATUS_USAHA', 'STATUS_USAHA', '`STATUS_USAHA`', '`STATUS_USAHA`', 200, 50, -1, false, '`STATUS_USAHA`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_IZIN_USAHA
        $this->NO_IZIN_USAHA = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_NO_IZIN_USAHA', 'NO_IZIN_USAHA', '`NO_IZIN_USAHA`', '`NO_IZIN_USAHA`', 200, 100, -1, false, '`NO_IZIN_USAHA`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SEKTOR_EKRAF
        $this->SEKTOR_EKRAF = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_SEKTOR_EKRAF', 'SEKTOR_EKRAF', '`SEKTOR_EKRAF`', '`SEKTOR_EKRAF`', 2, 6, -1, false, '`SEKTOR_EKRAF`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SEKTOR_KBLI
        $this->SEKTOR_KBLI = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_SEKTOR_KBLI', 'SEKTOR_KBLI', '`SEKTOR_KBLI`', '`SEKTOR_KBLI`', 2, 6, -1, false, '`SEKTOR_KBLI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SEKTOR_PERGUB
        $this->SEKTOR_PERGUB = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_SEKTOR_PERGUB', 'SEKTOR_PERGUB', '`SEKTOR_PERGUB`', '`SEKTOR_PERGUB`', 2, 6, -1, false, '`SEKTOR_PERGUB`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SEKTOR
        $this->SEKTOR = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_SEKTOR', 'SEKTOR', '`SEKTOR`', '`SEKTOR`', 200, 50, -1, false, '`SEKTOR`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODAL_KERJA
        $this->MODAL_KERJA = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_MODAL_KERJA', 'MODAL_KERJA', '`MODAL_KERJA`', '`MODAL_KERJA`', 5, 22, -1, false, '`MODAL_KERJA`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->TENAGA_KERJA_LAKILAKI = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_TENAGA_KERJA_LAKILAKI', 'TENAGA_KERJA_LAKI-LAKI', '`TENAGA_KERJA_LAKI-LAKI`', '`TENAGA_KERJA_LAKI-LAKI`', 16, 4, -1, false, '`TENAGA_KERJA_LAKI-LAKI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->TENAGA_KERJA_PEREMPUAN = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_TENAGA_KERJA_PEREMPUAN', 'TENAGA_KERJA_PEREMPUAN', '`TENAGA_KERJA_PEREMPUAN`', '`TENAGA_KERJA_PEREMPUAN`', 16, 4, -1, false, '`TENAGA_KERJA_PEREMPUAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->OMZET_RATARATA_PERTAHUN = new DbField('umkm_datausaha_backup', 'umkm_datausaha_backup', 'x_OMZET_RATARATA_PERTAHUN', 'OMZET_RATA-RATA_PERTAHUN', '`OMZET_RATA-RATA_PERTAHUN`', '`OMZET_RATA-RATA_PERTAHUN`', 5, 22, -1, false, '`OMZET_RATA-RATA_PERTAHUN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`umkm_datausaha_backup`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("umkmdatausahabackuplist");
    }
    ...
    {
        global $Language;
        if ($pageName == "umkmdatausahabackupview") {
            return $Language->phrase("View");
        } elseif ($pageName == "umkmdatausahabackupedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "umkmdatausahabackupadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "UmkmDatausahaBackupView";
            case Config("API_ADD_ACTION"):
                return "UmkmDatausahaBackupAdd";
            case Config("API_EDIT_ACTION"):
                return "UmkmDatausahaBackupEdit";
            case Config("API_DELETE_ACTION"):
                return "UmkmDatausahaBackupDelete";
            case Config("API_LIST_ACTION"):
                return "UmkmDatausahaBackupList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("umkmdatausahabackupview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("umkmdatausahabackupview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "umkmdatausahabackupadd?" . $this->getUrlParm($parm);
        } else {
            $url = "umkmdatausahabackupadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmdatausahabackupedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmdatausahabackupadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("umkmdatausahabackupdelete", $this->getUrlParm());
    }
