 ...
 * Page class
 */
class UmkmAspekdigimarkLmEdit extends UmkmAspekdigimarkLm
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UmkmAspekdigimarkLmEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("umkmaspekdigimarklmlist"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "umkmaspekdigimarklmlist") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->DM_CHATTING->EditValue = HtmlEncode($this->DM_CHATTING->CurrentValue);
            ...
            $this->DM_MEDSOS->EditValue = HtmlEncode($this->DM_MEDSOS->CurrentValue);
            ...
            $this->DM_MP->EditValue = HtmlEncode($this->DM_MP->CurrentValue);
            ...
            $this->DM_GMB->EditValue = HtmlEncode($this->DM_GMB->CurrentValue);
            ...
            $this->DM_WEB->EditValue = HtmlEncode($this->DM_WEB->CurrentValue);
            ...
            $this->DM_UPDATEMEDSOS->EditValue = HtmlEncode($this->DM_UPDATEMEDSOS->CurrentValue);
            ...
            $this->DM_UPDATEWEBSITE->EditValue = HtmlEncode($this->DM_UPDATEWEBSITE->CurrentValue);
            ...
            $this->DM_GOOGLEINDEX->EditValue = HtmlEncode($this->DM_GOOGLEINDEX->CurrentValue);
            ...
            $this->DM_IKLANBERBAYAR->EditValue = HtmlEncode($this->DM_IKLANBERBAYAR->CurrentValue);
