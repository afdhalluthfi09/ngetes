...
/**
 * Table class for bina_umkm_peserta_copy
 */
class BinaUmkmPesertaCopy extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'bina_umkm_peserta_copy';
        $this->TableName = 'bina_umkm_peserta_copy';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`bina_umkm_peserta_copy`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('bina_umkm_peserta_copy', 'bina_umkm_peserta_copy', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // id_binadata
        $this->id_binadata = new DbField('bina_umkm_peserta_copy', 'bina_umkm_peserta_copy', 'x_id_binadata', 'id_binadata', '`id_binadata`', '`id_binadata`', 3, 11, -1, false, '`id_binadata`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nik
        $this->nik = new DbField('bina_umkm_peserta_copy', 'bina_umkm_peserta_copy', 'x_nik', 'nik', '`nik`', '`nik`', 200, 16, -1, false, '`nik`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('bina_umkm_peserta_copy', 'bina_umkm_peserta_copy', 'x_status', 'status', '`status`', '`status`', 200, 255, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->status->Sortable = true; // Allow sort
        $this->status->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->status->Param, "CustomMsg");
        $this->Fields['status'] = &$this->status;

        // catatan
        $this->catatan = new DbField('bina_umkm_peserta_copy', 'bina_umkm_peserta_copy', 'x_catatan', 'catatan', '`catatan`', '`catatan`', 200, 255, -1, false, '`catatan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`bina_umkm_peserta_copy`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("binaumkmpesertacopylist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "binaumkmpesertacopyedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "binaumkmpesertacopyadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "BinaUmkmPesertaCopyView";
            case Config("API_ADD_ACTION"):
                return "BinaUmkmPesertaCopyAdd";
            case Config("API_EDIT_ACTION"):
                return "BinaUmkmPesertaCopyEdit";
            case Config("API_DELETE_ACTION"):
                return "BinaUmkmPesertaCopyDelete";
            case Config("API_LIST_ACTION"):
                return "BinaUmkmPesertaCopyList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("binaumkmpesertacopyview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("binaumkmpesertacopyview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "binaumkmpesertacopyadd?" . $this->getUrlParm($parm);
        } else {
            $url = "binaumkmpesertacopyadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("binaumkmpesertacopyedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("binaumkmpesertacopyadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("binaumkmpesertacopydelete", $this->getUrlParm());
    }
