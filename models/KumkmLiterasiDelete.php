 ...
 * Page class
 */
class KumkmLiterasiDelete extends KumkmLiterasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KumkmLiterasiDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("kumkmliterasilist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("kumkmliterasilist"); // Return to list
                return;
            }
        }
