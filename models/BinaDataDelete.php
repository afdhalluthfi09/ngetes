 ...
 * Page class
 */
class BinaDataDelete extends BinaData
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BinaDataDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("binadatalist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("binadatalist"); // Return to list
                return;
            }
        }
