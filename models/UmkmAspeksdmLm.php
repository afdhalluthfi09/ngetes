...
/**
 * Table class for umkm_aspeksdm_lm
 */
class UmkmAspeksdmLm extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'umkm_aspeksdm_lm';
        $this->TableName = 'umkm_aspeksdm_lm';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`umkm_aspeksdm_lm`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // NIK
        $this->NIK = new DbField('umkm_aspeksdm_lm', 'umkm_aspeksdm_lm', 'x_NIK', 'NIK', '`NIK`', '`NIK`', 200, 16, -1, false, '`NIK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SDM_OMS
        $this->SDM_OMS = new DbField('umkm_aspeksdm_lm', 'umkm_aspeksdm_lm', 'x_SDM_OMS', 'SDM_OMS', '`SDM_OMS`', '`SDM_OMS`', 200, 50, -1, false, '`SDM_OMS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SDM_FOKUS
        $this->SDM_FOKUS = new DbField('umkm_aspeksdm_lm', 'umkm_aspeksdm_lm', 'x_SDM_FOKUS', 'SDM_FOKUS', '`SDM_FOKUS`', '`SDM_FOKUS`', 200, 50, -1, false, '`SDM_FOKUS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SDM_TARGET
        $this->SDM_TARGET = new DbField('umkm_aspeksdm_lm', 'umkm_aspeksdm_lm', 'x_SDM_TARGET', 'SDM_TARGET', '`SDM_TARGET`', '`SDM_TARGET`', 200, 50, -1, false, '`SDM_TARGET`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SDM_KARYAWANTETAP
        $this->SDM_KARYAWANTETAP = new DbField('umkm_aspeksdm_lm', 'umkm_aspeksdm_lm', 'x_SDM_KARYAWANTETAP', 'SDM_KARYAWANTETAP', '`SDM_KARYAWANTETAP`', '`SDM_KARYAWANTETAP`', 200, 50, -1, false, '`SDM_KARYAWANTETAP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SDM_KARYAWANSUBKON
        $this->SDM_KARYAWANSUBKON = new DbField('umkm_aspeksdm_lm', 'umkm_aspeksdm_lm', 'x_SDM_KARYAWANSUBKON', 'SDM_KARYAWANSUBKON', '`SDM_KARYAWANSUBKON`', '`SDM_KARYAWANSUBKON`', 200, 50, -1, false, '`SDM_KARYAWANSUBKON`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SDM_GAJI
        $this->SDM_GAJI = new DbField('umkm_aspeksdm_lm', 'umkm_aspeksdm_lm', 'x_SDM_GAJI', 'SDM_GAJI', '`SDM_GAJI`', '`SDM_GAJI`', 200, 50, -1, false, '`SDM_GAJI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SDM_ASURANSI
        $this->SDM_ASURANSI = new DbField('umkm_aspeksdm_lm', 'umkm_aspeksdm_lm', 'x_SDM_ASURANSI', 'SDM_ASURANSI', '`SDM_ASURANSI`', '`SDM_ASURANSI`', 200, 50, -1, false, '`SDM_ASURANSI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SDM_TUNJANGAN
        $this->SDM_TUNJANGAN = new DbField('umkm_aspeksdm_lm', 'umkm_aspeksdm_lm', 'x_SDM_TUNJANGAN', 'SDM_TUNJANGAN', '`SDM_TUNJANGAN`', '`SDM_TUNJANGAN`', 200, 50, -1, false, '`SDM_TUNJANGAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SDM_PELATIHAN
        $this->SDM_PELATIHAN = new DbField('umkm_aspeksdm_lm', 'umkm_aspeksdm_lm', 'x_SDM_PELATIHAN', 'SDM_PELATIHAN', '`SDM_PELATIHAN`', '`SDM_PELATIHAN`', 200, 50, -1, false, '`SDM_PELATIHAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`umkm_aspeksdm_lm`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("umkmaspeksdmlmlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "umkmaspeksdmlmedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "umkmaspeksdmlmadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "UmkmAspeksdmLmView";
            case Config("API_ADD_ACTION"):
                return "UmkmAspeksdmLmAdd";
            case Config("API_EDIT_ACTION"):
                return "UmkmAspeksdmLmEdit";
            case Config("API_DELETE_ACTION"):
                return "UmkmAspeksdmLmDelete";
            case Config("API_LIST_ACTION"):
                return "UmkmAspeksdmLmList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("umkmaspeksdmlmview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("umkmaspeksdmlmview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "umkmaspeksdmlmadd?" . $this->getUrlParm($parm);
        } else {
            $url = "umkmaspeksdmlmadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmaspeksdmlmedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("umkmaspeksdmlmadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("umkmaspeksdmlmdelete", $this->getUrlParm());
    }
