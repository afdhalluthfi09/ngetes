 ...
 * Page class
 */
class IndonesiaVillagesEdit extends IndonesiaVillages
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IndonesiaVillagesEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // district_id
            $this->district_id->setDbValueDef($rsnew, $this->district_id->CurrentValue, "", $this->district_id->ReadOnly);

            // name
            $this->name->setDbValueDef($rsnew, $this->name->CurrentValue, "", $this->name->ReadOnly);

            // meta
            $this->meta->setDbValueDef($rsnew, $this->meta->CurrentValue, null, $this->meta->ReadOnly);
