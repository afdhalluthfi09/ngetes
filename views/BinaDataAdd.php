...
loadjs.ready("head", function () {
    ...
    fbina_dataadd = currentForm = new ew.Form("fbina_dataadd", "add");
    ...
    // Validate form
    fbina_dataadd.validate = function () {
    ...
    // Form_CustomValidate
    fbina_dataadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fbina_dataadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fbina_dataadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fbina_dataadd" id="fbina_dataadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fbina_dataadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fbina_dataadd", "x_tglmulai", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fbina_dataadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fbina_dataadd", "x_tglakhir", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fbina_dataadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fbina_dataadd", "x_waktu", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
