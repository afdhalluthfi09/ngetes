...
// Page object
$IndonesiaVillagesEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var findonesia_villagesedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    findonesia_villagesedit = currentForm = new ew.Form("findonesia_villagesedit", "edit");
    ...
    findonesia_villagesedit.addFields([
    ...
    // Validate form
    findonesia_villagesedit.validate = function () {
    ...
    // Form_CustomValidate
    findonesia_villagesedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    findonesia_villagesedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("findonesia_villagesedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="findonesia_villagesedit" id="findonesia_villagesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="indonesia_villages" data-field="x_id" data-hidden="1" name="o_id" id="o_id" value="<?= HtmlEncode($Page->id->OldValue ?? $Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["findonesia_villagesedit", "datetimepicker"], function() {
    ew.createDateTimePicker("findonesia_villagesedit", "x_created_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["findonesia_villagesedit", "datetimepicker"], function() {
    ew.createDateTimePicker("findonesia_villagesedit", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
