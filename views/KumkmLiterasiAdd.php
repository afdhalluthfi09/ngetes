...
// Page object
$KumkmLiterasiAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fkumkm_literasiadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fkumkm_literasiadd = currentForm = new ew.Form("fkumkm_literasiadd", "add");
    ...
    // Validate form
    fkumkm_literasiadd.validate = function () {
    ...
    // Form_CustomValidate
    fkumkm_literasiadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fkumkm_literasiadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fkumkm_literasiadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fkumkm_literasiadd" id="fkumkm_literasiadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fkumkm_literasiadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fkumkm_literasiadd", "x_tgl", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
