...
// Page object
$TempSkorPemasaranonlineEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var ftemp_skor_pemasaranonlineedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    ftemp_skor_pemasaranonlineedit = currentForm = new ew.Form("ftemp_skor_pemasaranonlineedit", "edit");
    ...
    ftemp_skor_pemasaranonlineedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = ftemp_skor_pemasaranonlineedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    ftemp_skor_pemasaranonlineedit.validate = function () {
    ...
    // Form_CustomValidate
    ftemp_skor_pemasaranonlineedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftemp_skor_pemasaranonlineedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("ftemp_skor_pemasaranonlineedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="ftemp_skor_pemasaranonlineedit" id="ftemp_skor_pemasaranonlineedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="temp_skor_pemasaranonline" data-field="x_nik" data-hidden="1" name="o_nik" id="o_nik" value="<?= HtmlEncode($Page->nik->OldValue ?? $Page->nik->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
