...
// Page object
$UmkmAspekpemasaranLmEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fumkm_aspekpemasaran_lmedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fumkm_aspekpemasaran_lmedit = currentForm = new ew.Form("fumkm_aspekpemasaran_lmedit", "edit");
    ...
    fumkm_aspekpemasaran_lmedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fumkm_aspekpemasaran_lmedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fumkm_aspekpemasaran_lmedit.validate = function () {
    ...
    // Form_CustomValidate
    fumkm_aspekpemasaran_lmedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fumkm_aspekpemasaran_lmedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fumkm_aspekpemasaran_lmedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fumkm_aspekpemasaran_lmedit" id="fumkm_aspekpemasaran_lmedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="umkm_aspekpemasaran_lm" data-field="x_NIK" data-hidden="1" name="o_NIK" id="o_NIK" value="<?= HtmlEncode($Page->NIK->OldValue ?? $Page->NIK->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
