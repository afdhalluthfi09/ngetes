...
// Page object
$ProdukLolosKurasiAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fProduk_Lolos_Kurasiadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fProduk_Lolos_Kurasiadd = currentForm = new ew.Form("fProduk_Lolos_Kurasiadd", "add");

    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "Produk_Lolos_Kurasi")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.Produk_Lolos_Kurasi)
        ew.vars.tables.Produk_Lolos_Kurasi = currentTable;
    fProduk_Lolos_Kurasiadd.addFields([
    ...
    // Validate form
    fProduk_Lolos_Kurasiadd.validate = function () {
    ...
    // Form_CustomValidate
    fProduk_Lolos_Kurasiadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fProduk_Lolos_Kurasiadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fProduk_Lolos_Kurasiadd.lists.judul_sesuai = <?= $Page->judul_sesuai->toClientList($Page) ?>;
    fProduk_Lolos_Kurasiadd.lists.foto_bagus = <?= $Page->foto_bagus->toClientList($Page) ?>;
    fProduk_Lolos_Kurasiadd.lists.deskripsi_jelas = <?= $Page->deskripsi_jelas->toClientList($Page) ?>;
    fProduk_Lolos_Kurasiadd.lists.harga_tidak_kosong = <?= $Page->harga_tidak_kosong->toClientList($Page) ?>;
    fProduk_Lolos_Kurasiadd.lists.berat_tidak_kosong = <?= $Page->berat_tidak_kosong->toClientList($Page) ?>;
    loadjs.done("fProduk_Lolos_Kurasiadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fProduk_Lolos_Kurasiadd" id="fProduk_Lolos_Kurasiadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
<?php if (Config("CHECK_TOKEN")) { ?>
<input type="hidden" name="<?= $TokenNameKey ?>" value="<?= $TokenName ?>"><!-- CSRF token name -->
<input type="hidden" name="<?= $TokenValueKey ?>" value="<?= $TokenValue ?>"><!-- CSRF token value -->
<?php } ?>
<input type="hidden" name="t" value="Produk_Lolos_Kurasi">
...
<?php if ($Page->produk_foto->Visible) { // produk_foto ?>
    <div id="r_produk_foto" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_produk_foto" for="x_produk_foto" class="<?= $Page->LeftColumnClass ?>"><?= $Page->produk_foto->caption() ?><?= $Page->produk_foto->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->produk_foto->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_produk_foto">
<input type="<?= $Page->produk_foto->getInputTextType() ?>" data-table="Produk_Lolos_Kurasi" data-field="x_produk_foto" name="x_produk_foto" id="x_produk_foto" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->produk_foto->getPlaceHolder()) ?>" value="<?= $Page->produk_foto->EditValue ?>"<?= $Page->produk_foto->editAttributes() ?> aria-describedby="x_produk_foto_help">
...
<?php if ($Page->produk_nama->Visible) { // produk_nama ?>
    <div id="r_produk_nama" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_produk_nama" for="x_produk_nama" class="<?= $Page->LeftColumnClass ?>"><?= $Page->produk_nama->caption() ?><?= $Page->produk_nama->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->produk_nama->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_produk_nama">
<input type="<?= $Page->produk_nama->getInputTextType() ?>" data-table="Produk_Lolos_Kurasi" data-field="x_produk_nama" name="x_produk_nama" id="x_produk_nama" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->produk_nama->getPlaceHolder()) ?>" value="<?= $Page->produk_nama->EditValue ?>"<?= $Page->produk_nama->editAttributes() ?> aria-describedby="x_produk_nama_help">
...
<?php if ($Page->produk_jenis->Visible) { // produk_jenis ?>
    <div id="r_produk_jenis" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_produk_jenis" for="x_produk_jenis" class="<?= $Page->LeftColumnClass ?>"><?= $Page->produk_jenis->caption() ?><?= $Page->produk_jenis->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->produk_jenis->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_produk_jenis">
<input type="<?= $Page->produk_jenis->getInputTextType() ?>" data-table="Produk_Lolos_Kurasi" data-field="x_produk_jenis" name="x_produk_jenis" id="x_produk_jenis" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->produk_jenis->getPlaceHolder()) ?>" value="<?= $Page->produk_jenis->EditValue ?>"<?= $Page->produk_jenis->editAttributes() ?> aria-describedby="x_produk_jenis_help">
...
<?php if ($Page->produk_desc->Visible) { // produk_desc ?>
    <div id="r_produk_desc" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_produk_desc" for="x_produk_desc" class="<?= $Page->LeftColumnClass ?>"><?= $Page->produk_desc->caption() ?><?= $Page->produk_desc->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->produk_desc->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_produk_desc">
<textarea data-table="Produk_Lolos_Kurasi" data-field="x_produk_desc" name="x_produk_desc" id="x_produk_desc" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->produk_desc->getPlaceHolder()) ?>"<?= $Page->produk_desc->editAttributes() ?> aria-describedby="x_produk_desc_help"><?= $Page->produk_desc->EditValue ?></textarea>
...
<?php if ($Page->produk_harga->Visible) { // produk_harga ?>
    <div id="r_produk_harga" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_produk_harga" for="x_produk_harga" class="<?= $Page->LeftColumnClass ?>"><?= $Page->produk_harga->caption() ?><?= $Page->produk_harga->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->produk_harga->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_produk_harga">
<input type="<?= $Page->produk_harga->getInputTextType() ?>" data-table="Produk_Lolos_Kurasi" data-field="x_produk_harga" name="x_produk_harga" id="x_produk_harga" size="30" maxlength="22" placeholder="<?= HtmlEncode($Page->produk_harga->getPlaceHolder()) ?>" value="<?= $Page->produk_harga->EditValue ?>"<?= $Page->produk_harga->editAttributes() ?> aria-describedby="x_produk_harga_help">
...
<?php if ($Page->produk_berat->Visible) { // produk_berat ?>
    <div id="r_produk_berat" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_produk_berat" for="x_produk_berat" class="<?= $Page->LeftColumnClass ?>"><?= $Page->produk_berat->caption() ?><?= $Page->produk_berat->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->produk_berat->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_produk_berat">
<input type="<?= $Page->produk_berat->getInputTextType() ?>" data-table="Produk_Lolos_Kurasi" data-field="x_produk_berat" name="x_produk_berat" id="x_produk_berat" size="30" maxlength="12" placeholder="<?= HtmlEncode($Page->produk_berat->getPlaceHolder()) ?>" value="<?= $Page->produk_berat->EditValue ?>"<?= $Page->produk_berat->editAttributes() ?> aria-describedby="x_produk_berat_help">
...
<?php if ($Page->kurator->Visible) { // kurator ?>
    <div id="r_kurator" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_kurator" for="x_kurator" class="<?= $Page->LeftColumnClass ?>"><?= $Page->kurator->caption() ?><?= $Page->kurator->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->kurator->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_kurator">
<input type="<?= $Page->kurator->getInputTextType() ?>" data-table="Produk_Lolos_Kurasi" data-field="x_kurator" name="x_kurator" id="x_kurator" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->kurator->getPlaceHolder()) ?>" value="<?= $Page->kurator->EditValue ?>"<?= $Page->kurator->editAttributes() ?> aria-describedby="x_kurator_help">
...
<?php if ($Page->judul_sesuai->Visible) { // judul_sesuai ?>
    <div id="r_judul_sesuai" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_judul_sesuai" class="<?= $Page->LeftColumnClass ?>"><?= $Page->judul_sesuai->caption() ?><?= $Page->judul_sesuai->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->judul_sesuai->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_judul_sesuai">
<template id="tp_x_judul_sesuai">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="Produk_Lolos_Kurasi" data-field="x_judul_sesuai" name="x_judul_sesuai" id="x_judul_sesuai"<?= $Page->judul_sesuai->editAttributes() ?>>
...
<input type="hidden"
    ...
    data-table="Produk_Lolos_Kurasi"
...
<?php if ($Page->foto_bagus->Visible) { // foto_bagus ?>
    <div id="r_foto_bagus" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_foto_bagus" class="<?= $Page->LeftColumnClass ?>"><?= $Page->foto_bagus->caption() ?><?= $Page->foto_bagus->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->foto_bagus->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_foto_bagus">
<template id="tp_x_foto_bagus">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="Produk_Lolos_Kurasi" data-field="x_foto_bagus" name="x_foto_bagus" id="x_foto_bagus"<?= $Page->foto_bagus->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->deskripsi_jelas->Visible) { // deskripsi_jelas ?>
    <div id="r_deskripsi_jelas" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_deskripsi_jelas" class="<?= $Page->LeftColumnClass ?>"><?= $Page->deskripsi_jelas->caption() ?><?= $Page->deskripsi_jelas->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->deskripsi_jelas->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_deskripsi_jelas">
<template id="tp_x_deskripsi_jelas">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="Produk_Lolos_Kurasi" data-field="x_deskripsi_jelas" name="x_deskripsi_jelas" id="x_deskripsi_jelas"<?= $Page->deskripsi_jelas->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->harga_tidak_kosong->Visible) { // harga_tidak_kosong ?>
    <div id="r_harga_tidak_kosong" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_harga_tidak_kosong" class="<?= $Page->LeftColumnClass ?>"><?= $Page->harga_tidak_kosong->caption() ?><?= $Page->harga_tidak_kosong->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->harga_tidak_kosong->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_harga_tidak_kosong">
<template id="tp_x_harga_tidak_kosong">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="Produk_Lolos_Kurasi" data-field="x_harga_tidak_kosong" name="x_harga_tidak_kosong" id="x_harga_tidak_kosong"<?= $Page->harga_tidak_kosong->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->berat_tidak_kosong->Visible) { // berat_tidak_kosong ?>
    <div id="r_berat_tidak_kosong" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_berat_tidak_kosong" class="<?= $Page->LeftColumnClass ?>"><?= $Page->berat_tidak_kosong->caption() ?><?= $Page->berat_tidak_kosong->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->berat_tidak_kosong->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_berat_tidak_kosong">
<template id="tp_x_berat_tidak_kosong">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="Produk_Lolos_Kurasi" data-field="x_berat_tidak_kosong" name="x_berat_tidak_kosong" id="x_berat_tidak_kosong"<?= $Page->berat_tidak_kosong->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->produk_foto_1->Visible) { // produk_foto_1 ?>
    <div id="r_produk_foto_1" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_produk_foto_1" class="<?= $Page->LeftColumnClass ?>"><?= $Page->produk_foto_1->caption() ?><?= $Page->produk_foto_1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->produk_foto_1->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_produk_foto_1">
<div id="fd_x_produk_foto_1">
<div class="input-group">
    <div class="custom-file">
        <input type="file" class="custom-file-input" title="<?= $Page->produk_foto_1->title() ?>" data-table="Produk_Lolos_Kurasi" data-field="x_produk_foto_1" name="x_produk_foto_1" id="x_produk_foto_1" lang="<?= CurrentLanguageID() ?>"<?= $Page->produk_foto_1->editAttributes() ?><?= ($Page->produk_foto_1->ReadOnly || $Page->produk_foto_1->Disabled) ? " disabled" : "" ?> aria-describedby="x_produk_foto_1_help">
...
<?php if ($Page->produk_foto_2->Visible) { // produk_foto_2 ?>
    <div id="r_produk_foto_2" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_produk_foto_2" class="<?= $Page->LeftColumnClass ?>"><?= $Page->produk_foto_2->caption() ?><?= $Page->produk_foto_2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->produk_foto_2->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_produk_foto_2">
<div id="fd_x_produk_foto_2">
<div class="input-group">
    <div class="custom-file">
        <input type="file" class="custom-file-input" title="<?= $Page->produk_foto_2->title() ?>" data-table="Produk_Lolos_Kurasi" data-field="x_produk_foto_2" name="x_produk_foto_2" id="x_produk_foto_2" lang="<?= CurrentLanguageID() ?>"<?= $Page->produk_foto_2->editAttributes() ?><?= ($Page->produk_foto_2->ReadOnly || $Page->produk_foto_2->Disabled) ? " disabled" : "" ?> aria-describedby="x_produk_foto_2_help">
...
<?php if ($Page->produk_foto_3->Visible) { // produk_foto_3 ?>
    <div id="r_produk_foto_3" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_produk_foto_3" class="<?= $Page->LeftColumnClass ?>"><?= $Page->produk_foto_3->caption() ?><?= $Page->produk_foto_3->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->produk_foto_3->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_produk_foto_3">
<div id="fd_x_produk_foto_3">
<div class="input-group">
    <div class="custom-file">
        <input type="file" class="custom-file-input" title="<?= $Page->produk_foto_3->title() ?>" data-table="Produk_Lolos_Kurasi" data-field="x_produk_foto_3" name="x_produk_foto_3" id="x_produk_foto_3" lang="<?= CurrentLanguageID() ?>"<?= $Page->produk_foto_3->editAttributes() ?><?= ($Page->produk_foto_3->ReadOnly || $Page->produk_foto_3->Disabled) ? " disabled" : "" ?> aria-describedby="x_produk_foto_3_help">
...
<?php if ($Page->produk_panjang->Visible) { // produk_panjang ?>
    <div id="r_produk_panjang" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_produk_panjang" for="x_produk_panjang" class="<?= $Page->LeftColumnClass ?>"><?= $Page->produk_panjang->caption() ?><?= $Page->produk_panjang->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->produk_panjang->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_produk_panjang">
<input type="<?= $Page->produk_panjang->getInputTextType() ?>" data-table="Produk_Lolos_Kurasi" data-field="x_produk_panjang" name="x_produk_panjang" id="x_produk_panjang" size="30" maxlength="12" placeholder="<?= HtmlEncode($Page->produk_panjang->getPlaceHolder()) ?>" value="<?= $Page->produk_panjang->EditValue ?>"<?= $Page->produk_panjang->editAttributes() ?> aria-describedby="x_produk_panjang_help">
...
<?php if ($Page->produk_lebar->Visible) { // produk_lebar ?>
    <div id="r_produk_lebar" class="form-group row">
        <label id="elh_Produk_Lolos_Kurasi_produk_lebar" for="x_produk_lebar" class="<?= $Page->LeftColumnClass ?>"><?= $Page->produk_lebar->caption() ?><?= $Page->produk_lebar->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->produk_lebar->cellAttributes() ?>>
<span id="el_Produk_Lolos_Kurasi_produk_lebar">
<input type="<?= $Page->produk_lebar->getInputTextType() ?>" data-table="Produk_Lolos_Kurasi" data-field="x_produk_lebar" name="x_produk_lebar" id="x_produk_lebar" size="30" maxlength="12" placeholder="<?= HtmlEncode($Page->produk_lebar->getPlaceHolder()) ?>" value="<?= $Page->produk_lebar->EditValue ?>"<?= $Page->produk_lebar->editAttributes() ?> aria-describedby="x_produk_lebar_help">
...
loadjs.ready("head", function() {
    ew.addEventHandlers("Produk_Lolos_Kurasi");
});
</script>
<script>
