...
var fkumkm_marketadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fkumkm_marketadd = currentForm = new ew.Form("fkumkm_marketadd", "add");
    ...
    // Validate form
    fkumkm_marketadd.validate = function () {
    ...
    // Form_CustomValidate
    fkumkm_marketadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fkumkm_marketadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fkumkm_marketadd.lists.kurasi = <?= $Page->kurasi->toClientList($Page) ?>;
    fkumkm_marketadd.lists.judul_sesuai = <?= $Page->judul_sesuai->toClientList($Page) ?>;
    fkumkm_marketadd.lists.foto_bagus = <?= $Page->foto_bagus->toClientList($Page) ?>;
    fkumkm_marketadd.lists.deskripsi_jelas = <?= $Page->deskripsi_jelas->toClientList($Page) ?>;
    fkumkm_marketadd.lists.harga_tidak_kosong = <?= $Page->harga_tidak_kosong->toClientList($Page) ?>;
    fkumkm_marketadd.lists.berat_tidak_kosong = <?= $Page->berat_tidak_kosong->toClientList($Page) ?>;
    loadjs.done("fkumkm_marketadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fkumkm_marketadd" id="fkumkm_marketadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" name="fa_x_produk_foto" id= "fa_x_produk_foto" value="0">
...
<?php if ($Page->judul_sesuai->Visible) { // judul_sesuai ?>
    <div id="r_judul_sesuai" class="form-group row">
        <label id="elh_kumkm_market_judul_sesuai" class="<?= $Page->LeftColumnClass ?>"><?= $Page->judul_sesuai->caption() ?><?= $Page->judul_sesuai->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<template id="tp_x_judul_sesuai">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="kumkm_market" data-field="x_judul_sesuai" name="x_judul_sesuai" id="x_judul_sesuai"<?= $Page->judul_sesuai->editAttributes() ?>>
...
<?php if ($Page->foto_bagus->Visible) { // foto_bagus ?>
    <div id="r_foto_bagus" class="form-group row">
        <label id="elh_kumkm_market_foto_bagus" class="<?= $Page->LeftColumnClass ?>"><?= $Page->foto_bagus->caption() ?><?= $Page->foto_bagus->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<template id="tp_x_foto_bagus">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="kumkm_market" data-field="x_foto_bagus" name="x_foto_bagus" id="x_foto_bagus"<?= $Page->foto_bagus->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->deskripsi_jelas->Visible) { // deskripsi_jelas ?>
    <div id="r_deskripsi_jelas" class="form-group row">
        <label id="elh_kumkm_market_deskripsi_jelas" class="<?= $Page->LeftColumnClass ?>"><?= $Page->deskripsi_jelas->caption() ?><?= $Page->deskripsi_jelas->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<template id="tp_x_deskripsi_jelas">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="kumkm_market" data-field="x_deskripsi_jelas" name="x_deskripsi_jelas" id="x_deskripsi_jelas"<?= $Page->deskripsi_jelas->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->harga_tidak_kosong->Visible) { // harga_tidak_kosong ?>
    <div id="r_harga_tidak_kosong" class="form-group row">
        <label id="elh_kumkm_market_harga_tidak_kosong" class="<?= $Page->LeftColumnClass ?>"><?= $Page->harga_tidak_kosong->caption() ?><?= $Page->harga_tidak_kosong->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<template id="tp_x_harga_tidak_kosong">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="kumkm_market" data-field="x_harga_tidak_kosong" name="x_harga_tidak_kosong" id="x_harga_tidak_kosong"<?= $Page->harga_tidak_kosong->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->berat_tidak_kosong->Visible) { // berat_tidak_kosong ?>
    <div id="r_berat_tidak_kosong" class="form-group row">
        <label id="elh_kumkm_market_berat_tidak_kosong" class="<?= $Page->LeftColumnClass ?>"><?= $Page->berat_tidak_kosong->caption() ?><?= $Page->berat_tidak_kosong->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<template id="tp_x_berat_tidak_kosong">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="kumkm_market" data-field="x_berat_tidak_kosong" name="x_berat_tidak_kosong" id="x_berat_tidak_kosong"<?= $Page->berat_tidak_kosong->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
