...
// Page object
$UmkmAspekkeuanganLmEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fumkm_aspekkeuangan_lmedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fumkm_aspekkeuangan_lmedit = currentForm = new ew.Form("fumkm_aspekkeuangan_lmedit", "edit");
    ...
    fumkm_aspekkeuangan_lmedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fumkm_aspekkeuangan_lmedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fumkm_aspekkeuangan_lmedit.validate = function () {
    ...
    // Form_CustomValidate
    fumkm_aspekkeuangan_lmedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fumkm_aspekkeuangan_lmedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fumkm_aspekkeuangan_lmedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fumkm_aspekkeuangan_lmedit" id="fumkm_aspekkeuangan_lmedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="umkm_aspekkeuangan_lm" data-field="x_NIK" data-hidden="1" name="o_NIK" id="o_NIK" value="<?= HtmlEncode($Page->NIK->OldValue ?? $Page->NIK->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
