...
loadjs.ready("head", function() {
    ...
    <?php } ?>
        ["npwd", [ew.Validators.required(ew.language.phrase("NewPassword")), ew.Validators.password(<?= $Page->NewPassword->Raw ? "true" : "false" ?>), ew.Validators.passwordStrength]],
...
<?php } ?>
    <div class="form-group row">
        <div class="input-group">
            <input type="password" name="<?= $Page->NewPassword->FieldVar ?>" id="<?= $Page->NewPassword->FieldVar ?>" autocomplete="new-password" placeholder="<?= HtmlEncode($Language->phrase("NewPassword")) ?>" data-password-strength="pst_npwd"<?= $Page->NewPassword->editAttributes() ?>>
            <div class="input-group-append">
                ...
                <button type="button" class="btn btn-default ew-password-generator rounded-right" title="<?= HtmlTitle($Language->phrase("GeneratePassword")) ?>" data-password-field="<?= $Page->NewPassword->FieldVar ?>" data-password-confirm="<?= $Page->ConfirmPassword->FieldVar ?>" data-password-strength="pst_npwd"><?= $Language->phrase("GeneratePassword") ?></button>
            </div>
        </div>
