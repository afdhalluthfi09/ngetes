...
// Page object
$TempSkorKelembagaanAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var ftemp_skor_kelembagaanadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    ftemp_skor_kelembagaanadd = currentForm = new ew.Form("ftemp_skor_kelembagaanadd", "add");
    ...
    ftemp_skor_kelembagaanadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = ftemp_skor_kelembagaanadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    ftemp_skor_kelembagaanadd.validate = function () {
    ...
    // Form_CustomValidate
    ftemp_skor_kelembagaanadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftemp_skor_kelembagaanadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("ftemp_skor_kelembagaanadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="ftemp_skor_kelembagaanadd" id="ftemp_skor_kelembagaanadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
