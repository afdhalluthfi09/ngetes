...
// Page object
$TempSkorPemasaranAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var ftemp_skor_pemasaranadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    ftemp_skor_pemasaranadd = currentForm = new ew.Form("ftemp_skor_pemasaranadd", "add");
    ...
    ftemp_skor_pemasaranadd.addFields([
    ...
    // Validate form
    ftemp_skor_pemasaranadd.validate = function () {
    ...
    // Form_CustomValidate
    ftemp_skor_pemasaranadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftemp_skor_pemasaranadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("ftemp_skor_pemasaranadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="ftemp_skor_pemasaranadd" id="ftemp_skor_pemasaranadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
