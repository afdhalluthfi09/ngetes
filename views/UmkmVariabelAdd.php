...
// Page object
$UmkmVariabelAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fumkm_variabeladd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fumkm_variabeladd = currentForm = new ew.Form("fumkm_variabeladd", "add");
    ...
    // Validate form
    fumkm_variabeladd.validate = function () {
    ...
    // Form_CustomValidate
    fumkm_variabeladd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fumkm_variabeladd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fumkm_variabeladd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fumkm_variabeladd" id="fumkm_variabeladd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
