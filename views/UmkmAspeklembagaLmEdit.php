...
// Page object
$UmkmAspeklembagaLmEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fumkm_aspeklembaga_lmedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fumkm_aspeklembaga_lmedit = currentForm = new ew.Form("fumkm_aspeklembaga_lmedit", "edit");
    ...
    fumkm_aspeklembaga_lmedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fumkm_aspeklembaga_lmedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fumkm_aspeklembaga_lmedit.validate = function () {
    ...
    // Form_CustomValidate
    fumkm_aspeklembaga_lmedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fumkm_aspeklembaga_lmedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fumkm_aspeklembaga_lmedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fumkm_aspeklembaga_lmedit" id="fumkm_aspeklembaga_lmedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="umkm_aspeklembaga_lm" data-field="x_NIK" data-hidden="1" name="o_NIK" id="o_NIK" value="<?= HtmlEncode($Page->NIK->OldValue ?? $Page->NIK->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
