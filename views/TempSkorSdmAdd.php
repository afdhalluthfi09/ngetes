...
var ftemp_skor_sdmadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    ftemp_skor_sdmadd = currentForm = new ew.Form("ftemp_skor_sdmadd", "add");
    ...
    // Validate form
    ftemp_skor_sdmadd.validate = function () {
    ...
    // Form_CustomValidate
    ftemp_skor_sdmadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftemp_skor_sdmadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("ftemp_skor_sdmadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="ftemp_skor_sdmadd" id="ftemp_skor_sdmadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
