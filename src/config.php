...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'hUdLg168fY8a6HOj', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/umkm_sidakui.css", // Project stylesheet file name
    ...
    "NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-dark bg-success border-bottom-0",
    ...
    // Email
    "SENDER_EMAIL" => "sidakuikabbantul@gmail.com", // Sender email address
